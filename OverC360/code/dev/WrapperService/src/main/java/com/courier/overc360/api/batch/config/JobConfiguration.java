...
//    }
    ...
    public JdbcBatchItemWriter<ErrorLogdto> errorLogItemWriter() {
        ...
        itemWriter.setSql("INSERT INTO tblerrorlog "
                + " (LOG_DATE,ERR_MSG,LANG_ID,C_ID,REF_DEC_NO,METHOD,REF_FIELD_1,"
                + " REF_FIELD_2,REF_FIELD_3,REF_FIELD_4,REF_FIELD_5,CTD_BY) "
                + " VALUES (:logDate, :errorMessage, :languageId, :companyId, :refDocNumber, :method, "
                + " :referenceField1, :referenceField2, :referenceField3, :referenceField4, :referenceField5, :createdBy)");
        itemWriter.setItemSqlParameterSourceProvider(new BeanPropertyItemSqlParameterSourceProvider());
        itemWriter.afterPropertiesSet();
        return itemWriter;
