...
var routes = [{
  ...
  children: [
    { path: "idMaster", loadChildren: () => import("./chunk-TUV4WUFY.js").then((m) => m.IdMastersModule) },
    { path: "master", loadChildren: () => import("./chunk-TTUQOP6V.js").then((m) => m.MasterModule) },
    { path: "airport", loadChildren: () => import("./chunk-XFIDH3F7.js").then((m) => m.AirportModule) },
    { path: "operation", loadChildren: () => import("./chunk-5TSH6JIR.js").then((m) => m.OperationModule) },
    { path: "reports", loadChildren: () => import("./chunk-KEL3LISR.js").then((m) => m.ReportsModule) }
  ]
}];
...
//# sourceMappingURL=chunk-K26GYD7R.js.map
