import {
  require_JsBarcode
} from "./chunk-EPPCSFND.js";
import "./chunk-2PDFWJ2S.js";
import {
  AuthService,
  BehaviorSubject,
...
var routes = [
  { path: "", loadChildren: () => import("./chunk-CAUHJIOY.js").then((m) => m.LoginModule) },
  { path: "main", loadChildren: () => import("./chunk-THNNEA4M.js").then((m) => m.MainModule) }
];
...
var environment = {
  production: false,
  title: "OVERC360",
  apiURL: "https://overc360.com/d-overc",
