import {
  ProductService
} from "./chunk-2NLXMKRH.js";
import {
  ConsignmentLabelComponent,
  ConsignmentService,
  ConsignmentUpdatebulkComponent
} from "./chunk-DPMVECF4.js";
import "./chunk-EPPCSFND.js";
import {
  ConsignorService,
  CustomerService
} from "./chunk-U6RTTIR2.js";
import {
  CommonAPIService
} from "./chunk-PADUMMUI.js";
import {
  CustomTableComponent,
  DeleteComponent
} from "./chunk-2PDFWJ2S.js";
import {
  PathNameService
} from "./chunk-XZF3TEFX.js";
import {
  ActivatedRoute,
  AuthService,
  ButtonDirective,
...
function ConsignmentNewComponent_div_104_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 177)(1, "p", 17);
    \u0275\u0275text(2, "COD Collection Mode");
    \u0275\u0275elementEnd();
    \u0275\u0275element(3, "p-dropdown", 178);
    \u0275\u0275template(4, ConsignmentNewComponent_div_104_mat_error_4_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_5_0;
    ...
    \u0275\u0275property("options", ctx_r1.codCollectionMode)("ngClass", ((tmp_5_0 = ctx_r1.shipmentInfo.get("codCollectionMode")) == null ? null : tmp_5_0.invalid) && ctx_r1.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(7, _c04));
    \u0275\u0275advance();
...
function ConsignmentNewComponent_div_105_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 179)(1, "p", 17);
    \u0275\u0275text(2, "COD Amount");
    \u0275\u0275elementEnd();
    \u0275\u0275element(3, "input", 180);
    \u0275\u0275template(4, ConsignmentNewComponent_div_105_mat_error_4_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_3_0;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275property("ngClass", ((tmp_3_0 = ctx_r1.shipmentInfo.get("codAmount")) == null ? null : tmp_3_0.invalid) && ctx_r1.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
...
function ConsignmentNewComponent_div_106_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 181)(1, "p", 17);
    \u0275\u0275text(2, "COD Favor Of");
    \u0275\u0275elementEnd();
    \u0275\u0275element(3, "input", 182);
    \u0275\u0275template(4, ConsignmentNewComponent_div_106_mat_error_4_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_3_0;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275property("ngClass", ((tmp_3_0 = ctx_r1.shipmentInfo.get("codFavorOf")) == null ? null : tmp_3_0.invalid) && ctx_r1.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
...
function ConsignmentNewComponent_ng_template_116_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(2, "input", 184);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "td");
    \u0275\u0275element(4, "input", 185);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "td");
    \u0275\u0275element(6, "input", 186);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "td");
    \u0275\u0275element(8, "input", 187);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "td");
    \u0275\u0275element(10, "p-dropdown", 188);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "td", 189)(12, "img", 190);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "p-overlayPanel", null, 2)(15, "div", 191)(16, "button", 192);
    ...
    \u0275\u0275element(17, "img", 193);
    \u0275\u0275text(18, "Dimension");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "button", 192);
    ...
    \u0275\u0275element(20, "img", 194);
    \u0275\u0275text(21, "Item");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "button", 192);
    ...
    \u0275\u0275element(23, "img", 195);
    \u0275\u0275text(24, "Delete");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "button", 192);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("options", ctx_r1.currencyDropdown)("panelStyle", \u0275\u0275pureFunction0(8, _c04));
    \u0275\u0275advance(3);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(9, _c22));
  }
}
...
function ConsignmentNewComponent_mat_error_426_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 176)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function ConsignmentNewComponent_mat_error_431_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 176)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function ConsignmentNewComponent_mat_error_436_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 176)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function ConsignmentNewComponent_mat_error_441_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 176)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function ConsignmentNewComponent_ng_template_450_th_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", col_r10.header, " ");
  }
}
function ConsignmentNewComponent_ng_template_450_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "th", 197);
    \u0275\u0275element(2, "p-tableHeaderCheckbox", 198);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, ConsignmentNewComponent_ng_template_450_th_3_Template, 2, 1, "th", 199);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ConsignmentNewComponent_ng_template_451_td_3_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
...
function ConsignmentNewComponent_ng_template_451_td_3_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
    \u0275\u0275pipe(1, "date");
  }
...
function ConsignmentNewComponent_ng_template_451_td_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td");
    \u0275\u0275template(1, ConsignmentNewComponent_ng_template_451_td_3_ng_container_1_Template, 2, 1, "ng-container", 203)(2, ConsignmentNewComponent_ng_template_451_td_3_ng_template_2_Template, 2, 4, "ng-template", null, 3, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ConsignmentNewComponent_ng_template_451_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td", 200);
    \u0275\u0275element(2, "p-tableCheckbox", 201);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, ConsignmentNewComponent_ng_template_451_td_3_Template, 4, 4, "td", 202);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", true)("value", rowData_r13);
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", columns_r15);
  }
}
function ConsignmentNewComponent_ng_template_452_ng_container_2_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "td");
    \u0275\u0275text(2);
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.calculateFooterTotal(col_r16.field), " ");
  }
}
function ConsignmentNewComponent_ng_template_452_ng_container_2_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275element(1, "td");
    \u0275\u0275elementContainerEnd();
...
function ConsignmentNewComponent_ng_template_452_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, ConsignmentNewComponent_ng_template_452_ng_container_2_ng_container_1_Template, 3, 1, "ng-container", 204)(2, ConsignmentNewComponent_ng_template_452_ng_container_2_ng_container_2_Template, 2, 0, "ng-container", 204);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const col_r16 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", col_r16.showFooter);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !col_r16.showFooter);
  }
}
function ConsignmentNewComponent_ng_template_452_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr");
    \u0275\u0275element(1, "td");
    \u0275\u0275template(2, ConsignmentNewComponent_ng_template_452_ng_container_2_Template, 3, 2, "ng-container", 199);
    \u0275\u0275element(3, "td");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ConsignmentNewComponent_ng_template_453_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "p", 205);
    \u0275\u0275text(3, "No records found");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
_ConsignmentNewComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConsignmentNewComponent, selectors: [["app-consignment-new"]], decls: 459, vars: 299, consts: [["fileInput", ""], ["consignmentTag", ""], ["op", ""], ["dateTemplate", ""], [1, "componentBody"], [1, "d-flex", "justify-content-between", "align-items-center"], [1, "componentHeader", "f600", "mb-0"], ["type", "button", "routerLink", "/main/operation/consignment", "src", "./assets/common2x/close1.png", "alt", "", "srcset", "", 2, "margin", "0 17px", "height", "1.5rem"], ["type", "button", "src", "./assets/common2x/tick.png", "alt", "", "srcset", "", 2, "margin", "0 17px", "height", "1.5rem", 3, "click"], ["type", "button", 1, "btn", "ml-2", "addNewbuttom", "bgBlack", "text-white", 3, "click", "disabled"], [1, "bi", "bi-plus-square", "pr-2"], [1, "mt-4", "mx-auto"], [3, "activeIndexChange", "activeIndex"], ["header", "Shipment Info"], [3, "formGroup"], [1, "row", "scrollNew22"], [1, "col-3", "marginFieldNew", "borderRadius12"], [1, "formControlLabel", "f600", "textBlack", "mb-0"], ["placeholder", "Select", "filter", "true", "formControlName", "companyId", "appendTo", "body", 3, "options", "panelStyle"], ["class", "text-danger", 4, "ngIf"], ["id", "productId", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "productId", "appendTo", "body", 3, "onChange", "options", "ngClass", "panelStyle"], ["id", "serviceTypeId", 1, "col-3", "marginFieldNew", "borderRadius12"], [1, "formControlLabel", "f600", "textBlack", "mb-0", "required"], ["placeholder", "Select", "filter", "true", "formControlName", "serviceTypeId", "appendTo", "body", 3, "options", "ngClass", "panelStyle"], ["id", "partnerType", 1, "col-3", "marginFieldNew", "borderRadius12"], ["formControlName", "partnerType", "appendTo", "body", "placeholder", "Select", 3, "onChange", "options", "ngClass", "panelStyle"], ["id", "partnerId", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "partnerId", "appendTo", "body", 3, "options", "ngClass", "panelStyle"], ["id", "consignmentType", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "serviceTypeId", "appendTo", "body", 3, "options", "panelStyle"], ["id", "loadTypeId", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "loadTypeId", "appendTo", "body", 3, "options", "ngClass", "panelStyle"], ["id", "customerReferenceNumber", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "customerReferenceNumber", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "noOfPieceHawb", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "noOfPieceHawb", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "countryOfOrigin", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "countryOfOrigin", "appendTo", "body", 3, "options", "panelStyle"], ["id", "countryOfDestination", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "countryOfDestination", "appendTo", "body", 3, "options", "panelStyle"], ["id", "invoiceNumber", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "pKeyFilter", "num", "formControlName", "invoiceNumber", "pInputText", "", "placeholder", "Enter", 3, "ngClass"], ["type", "button", "pButton", "", 1, "bgBlack", "border-0", 3, "click"], [1, "bi", "bi-upload"], ["type", "file", 2, "display", "none", 3, "change"], ["id", "invoiceAmount", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "pKeyFilter", "num", "formControlName", "invoiceAmount", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "invoiceUrl", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "pKeyFilter", "num", "formControlName", "invoiceUrl", "pInputText", "", "placeholder", "Enter", 3, "ngClass"], [1, "bi", "bi-download"], ["id", "incoTerms", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "incoTerms", "appendTo", "body", 3, "options", "ngClass", "panelStyle"], ["id", "paymentType", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "paymentType", "appendTo", "body", 3, "onChange", "options", "ngClass", "panelStyle"], ["class", "col-3 marginFieldNew borderRadius12", "id", "codCollectionMode", 4, "ngIf"], ["class", "col-3 marginFieldNew borderRadius12", "id", "codAmount", 4, "ngIf"], ["class", "col-3 marginFieldNew borderRadius12", "id", "codFavorOf", 4, "ngIf"], [1, "d-flex", "mt-1", "justify-content-end", 2, "position", "absolute", "right", "3.5%", "bottom", "7%"], ["routerLink", "/main/operation/consignment", 1, "buttom1", "textBlack", "mx-1"], [1, "buttom1", "bgBlack", "text-white", "mx-1", 3, "click"], ["header", "Package Details", 3, "disabled"], [1, "mt-1", 3, "formGroup"], ["scrollHeight", "calc(100vh - 24.8rem)", 1, "paddingZero", 3, "scrollable", "value"], ["pTemplate", "header"], ["pTemplate", "body"], [1, "buttom1", "textBlack", "mx-1", 3, "click"], ["header", "Consignment", 3, "disabled"], ["id", "partnerMasterAirwayBill", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "partnerMasterAirwayBill", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "partnerHouseAirwayBill", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "partnerHouseAirwayBill", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "airportOriginCode", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "airportOriginCode", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "flightNo", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "flightNo", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "flightArrivalTime", 1, "col-3", "marginFieldNew", "borderRadius12"], ["formControlName", "flightArrivalTime", "appendTo", "body", "placeholder", "Filter by Date", 1, "w-100", "small-calendar", 3, "ngClass", "iconDisplay", "showIcon"], ["id", "noOfPackages", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "noOfPackages", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "flightName", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "flightName", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "length", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "pKeyFilter", "num", "formControlName", "length", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "change", "ngClass"], ["id", "width", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "pKeyFilter", "num", "formControlName", "width", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "change", "ngClass"], ["id", "height", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "pKeyFilter", "num", "formControlName", "height", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "change", "ngClass"], ["id", "dimensionUnit", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "dimensionUnit", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "weight", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "pKeyFilter", "num", "formControlName", "weight", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "weightUnit", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "weightUnit", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "volume", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "volume", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "volumeUnit", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "volumeUnit", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "netWeight", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "netWeight", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "grossWeight", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "grossWeight", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "invoiceDateFE", 1, "col-3", "marginFieldNew", "borderRadius12"], ["formControlName", "invoiceDateFE", "appendTo", "body", "placeholder", "Filter by Date", 1, "w-100", "small-calendar", 3, "ngClass", "iconDisplay", "showIcon"], ["id", "goodsDescription", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "500", "formControlName", "goodsDescription", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "consignmentValue", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "500", "formControlName", "consignmentValue", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "consignmentCurrency", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "consignmentCurrency", "appendTo", "body", 3, "options", "ngClass", "panelStyle"], ["header", "Origin", 3, "disabled"], ["id", "name", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "name", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "companyName", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "companyName", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "addressLine1", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "addressLine1", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "addressLine2", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "addressLine2", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "country", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "country", "appendTo", "body", 3, "options", "ngClass", "panelStyle"], ["id", "state", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "state", "appendTo", "body", 3, "options", "ngClass", "panelStyle"], ["id", "district", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "district", "appendTo", "body", 3, "options", "ngClass", "panelStyle"], ["id", "city", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "city", "appendTo", "body", 3, "options", "ngClass", "panelStyle"], ["id", "pinCode", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "pinCode", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "latitude", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "latitude", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "longitude", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "longitude", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "phone", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "phone", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "alternatePhone", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "alternatePhone", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "email", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "email", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "addressHubCode", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "addressHubCode", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "accountId", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "accountId", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["header", "Destination", 3, "disabled"], ["id", "name", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "addressLine1", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "addressLine2", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "country", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "state", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "district", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "city", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "pinCode", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "latitude", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "longitude", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "phone", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "alternatePhone", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "email", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "companyName", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "addressHubCode", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "accountId", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["header", "Billing", 3, "disabled"], [1, "row"], [1, "col-3", "marginFieldNew", "borderRadius12", 3, "formGroup"], ["maxlength", "500", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "value", "disabled"], ["id", "customsInsurance", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "customsInsurance", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "duty", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "duty", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "dduCharge", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "dduCharge", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "specialApprovalCharge", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "specialApprovalCharge", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["header", "Duty Charges", 3, "disabled"], ["selectionMode", "multiple", "scrollHeight", "calc(100vh - 22.8rem)", "sortField", "consignmentId", "styleClass", "p-datatable-sm", 1, "custom-table", 3, "selectionChange", "columns", "value", "scrollable", "selection", "sortOrder", "tableStyle"], ["pTemplate", "footer"], ["pTemplate", "emptymessage"], [1, "text-danger"], ["id", "codCollectionMode", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "codCollectionMode", "appendTo", "body", 3, "options", "ngClass", "panelStyle"], ["id", "codAmount", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "codAmount", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "codFavorOf", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "codFavorOf", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], [2, "min-width", "9rem", "justify-content", "center"], ["placeholder", "Enter", "formControlName", "packReferenceNumber", 1, "inputborderLess", "pl-3"], ["placeholder", "Enter", "formControlName", "pieceProductCode", 1, "inputborderLess", "pl-3"], ["placeholder", "Enter", "formControlName", "tags", 1, "inputborderLess", "pl-3"], ["placeholder", "Enter", "formControlName", "pieceValue", 1, "inputborderLess", "pl-3"], ["placeholder", "Select", "filter", "true", "formControlName", "pieceCurrency", "appendTo", "body", 3, "options", "panelStyle"], [2, "padding-left", "1.5rem !important"], ["type", "button", "src", "./assets/common/actions.png", "alt", "", "srcset", "", 2, "height", "1.4rem", 3, "click"], [1, "d-flex", "flex-column"], ["mat-menu-item", "", 1, "w-100", 2, "width", "8rem", 3, "click"], ["src", "./assets/common/dimension.png", "srcset", "", 2, "padding-right", "10px", "width", "2rem"], ["src", "./assets/common/add.png", "srcset", "", 2, "padding-right", "10px", "width", "2rem"], ["src", "./assets/common/delete1x.png", "srcset", "", 2, "padding-right", "10px", "width", "2rem"], ["src", "./assets/common/image.png", "srcset", "", 2, "padding-right", "10px", "width", "2rem"], [2, "width", "5rem"], [1, "pl-3", 3, "disabled"], [4, "ngFor", "ngForOf"], [2, "width", "5rem", "justify-content", "center"], [1, "pl-3", 3, "disabled", "value"], [3, "style", 4, "ngFor", "ngForOf"], [4, "ngIf", "ngIfElse"], [4, "ngIf"], [1, "my-2", "w-100", "pl-3"]], template: function ConsignmentNewComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(9, " Add Piece");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(10, "div", 11)(11, "p-tabView", 12);
    ...
    \u0275\u0275elementStart(12, "p-tabPanel", 13)(13, "form", 14)(14, "div", 15)(15, "div", 16)(16, "p", 17);
    \u0275\u0275text(17, "Company");
    \u0275\u0275elementEnd();
    \u0275\u0275element(18, "p-dropdown", 18);
    \u0275\u0275template(19, ConsignmentNewComponent_mat_error_19_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "div", 20)(21, "p", 17);
    \u0275\u0275text(22, "Product");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "p-dropdown", 21);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(24, ConsignmentNewComponent_mat_error_24_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "div", 22)(26, "p", 23);
    \u0275\u0275text(27, "Service Type ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(28, "p-dropdown", 24);
    \u0275\u0275template(29, ConsignmentNewComponent_mat_error_29_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "div", 25)(31, "p", 23);
    \u0275\u0275text(32, "Partner Type");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "p-dropdown", 26);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(34, ConsignmentNewComponent_mat_error_34_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "div", 27)(36, "p", 23);
    \u0275\u0275text(37, "Partner");
    \u0275\u0275elementEnd();
    \u0275\u0275element(38, "p-dropdown", 28);
    \u0275\u0275template(39, ConsignmentNewComponent_mat_error_39_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "div", 29)(41, "p", 17);
    \u0275\u0275text(42, "Consignment Type");
    \u0275\u0275elementEnd();
    \u0275\u0275element(43, "p-dropdown", 30);
    \u0275\u0275template(44, ConsignmentNewComponent_mat_error_44_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(45, "div", 31)(46, "p", 23);
    \u0275\u0275text(47, "Load Type ");
    \u0275\u0275element(48, "Code");
    \u0275\u0275elementEnd();
    \u0275\u0275element(49, "p-dropdown", 32);
    \u0275\u0275template(50, ConsignmentNewComponent_mat_error_50_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(51, "div", 33)(52, "p", 17);
    \u0275\u0275text(53, "Customer Ref No");
    \u0275\u0275elementEnd();
    \u0275\u0275element(54, "input", 34);
    \u0275\u0275template(55, ConsignmentNewComponent_mat_error_55_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(56, "div", 35)(57, "p", 17);
    \u0275\u0275text(58, "No of packages");
    \u0275\u0275elementEnd();
    \u0275\u0275element(59, "input", 36);
    \u0275\u0275template(60, ConsignmentNewComponent_mat_error_60_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(61, "div", 37)(62, "p", 17);
    \u0275\u0275text(63, "Country of Origin");
    \u0275\u0275elementEnd();
    \u0275\u0275element(64, "p-dropdown", 38);
    \u0275\u0275template(65, ConsignmentNewComponent_mat_error_65_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(66, "div", 39)(67, "p", 17);
    \u0275\u0275text(68, "Country of Destination");
    \u0275\u0275elementEnd();
    \u0275\u0275element(69, "p-dropdown", 40);
    \u0275\u0275template(70, ConsignmentNewComponent_mat_error_70_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(71, "div", 41)(72, "p", 17);
    \u0275\u0275text(73, "Invoice Number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(74, "p-inputGroup");
    \u0275\u0275element(75, "input", 42);
    \u0275\u0275elementStart(76, "button", 43);
    ...
    \u0275\u0275element(77, "i", 44);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(78, ConsignmentNewComponent_mat_error_78_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(79, "input", 45, 0);
    \u0275\u0275listener("change", function ConsignmentNewComponent_Template_input_change_79_listener($event) {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.selectFiles($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(81, "div", 46)(82, "p", 17);
    \u0275\u0275text(83, "Invoice Amount ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(84, "input", 47);
    \u0275\u0275template(85, ConsignmentNewComponent_mat_error_85_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(86, "div", 48)(87, "p", 17);
    \u0275\u0275text(88, "Invoice URL ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(89, "p-inputGroup");
    \u0275\u0275element(90, "input", 49);
    \u0275\u0275elementStart(91, "button", 43);
    ...
    \u0275\u0275element(92, "i", 50);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(93, ConsignmentNewComponent_mat_error_93_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(94, "div", 51)(95, "p", 17);
    \u0275\u0275text(96, "Inco Terms");
    \u0275\u0275elementEnd();
    \u0275\u0275element(97, "p-dropdown", 52);
    \u0275\u0275template(98, ConsignmentNewComponent_mat_error_98_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(99, "div", 53)(100, "p", 17);
    \u0275\u0275text(101, "Payment Type");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(102, "p-dropdown", 54);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(103, ConsignmentNewComponent_mat_error_103_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275template(104, ConsignmentNewComponent_div_104_Template, 5, 8, "div", 55)(105, ConsignmentNewComponent_div_105_Template, 5, 2, "div", 56)(106, ConsignmentNewComponent_div_106_Template, 5, 2, "div", 57);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(107, "div", 58)(108, "button", 59);
    \u0275\u0275text(109, "Cancel");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(110, "button", 60);
    ...
    \u0275\u0275text(111, "Next");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(112, "p-tabPanel", 61)(113, "form", 62)(114, "p-table", 63);
    \u0275\u0275template(115, ConsignmentNewComponent_ng_template_115_Template, 13, 0, "ng-template", 64)(116, ConsignmentNewComponent_ng_template_116_Template, 28, 10, "ng-template", 65);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(117, "div", 58)(118, "button", 66);
    ...
    \u0275\u0275text(121, "Next");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(122, "p-tabPanel", 67)(123, "form", 14)(124, "div", 15)(125, "div", 68)(126, "p", 17);
    \u0275\u0275text(127, "Partner MAWB");
    \u0275\u0275elementEnd();
    \u0275\u0275element(128, "input", 69);
    \u0275\u0275template(129, ConsignmentNewComponent_mat_error_129_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(130, "div", 70)(131, "p", 17);
    \u0275\u0275text(132, "Partner HAWB");
    \u0275\u0275elementEnd();
    \u0275\u0275element(133, "input", 71);
    \u0275\u0275template(134, ConsignmentNewComponent_mat_error_134_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(135, "div", 72)(136, "p", 17);
    \u0275\u0275text(137, "Airport Origin Code");
    \u0275\u0275elementEnd();
    \u0275\u0275element(138, "input", 73);
    \u0275\u0275template(139, ConsignmentNewComponent_mat_error_139_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(140, "div", 74)(141, "p", 17);
    \u0275\u0275text(142, "Flight No");
    \u0275\u0275elementEnd();
    \u0275\u0275element(143, "input", 75);
    \u0275\u0275template(144, ConsignmentNewComponent_mat_error_144_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(145, "div", 76)(146, "p", 17);
    \u0275\u0275text(147, "Flight ETA");
    \u0275\u0275elementEnd();
    \u0275\u0275element(148, "p-calendar", 77);
    \u0275\u0275template(149, ConsignmentNewComponent_mat_error_149_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(150, "div", 78)(151, "p", 17);
    \u0275\u0275text(152, "No of Packages");
    \u0275\u0275elementEnd();
    \u0275\u0275element(153, "input", 79);
    \u0275\u0275template(154, ConsignmentNewComponent_mat_error_154_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(155, "div", 80)(156, "p", 17);
    \u0275\u0275text(157, "Flight Name");
    \u0275\u0275elementEnd();
    \u0275\u0275element(158, "input", 81);
    \u0275\u0275template(159, ConsignmentNewComponent_mat_error_159_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(160, "div", 82)(161, "p", 17);
    \u0275\u0275text(162, "Length");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(163, "input", 83);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(164, ConsignmentNewComponent_mat_error_164_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(165, "div", 84)(166, "p", 17);
    \u0275\u0275text(167, "Width");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(168, "input", 85);
    \u0275\u0275listener("change", function ConsignmentNewComponent_Template_input_change_168_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.calculateVolume(ctx.consignment));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(169, ConsignmentNewComponent_mat_error_169_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(170, "div", 86)(171, "p", 17);
    \u0275\u0275text(172, "Height");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(173, "input", 87);
    \u0275\u0275listener("change", function ConsignmentNewComponent_Template_input_change_173_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.calculateVolume(ctx.consignment));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(174, ConsignmentNewComponent_mat_error_174_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(175, "div", 88)(176, "p", 17);
    \u0275\u0275text(177, "Dimension Unit");
    \u0275\u0275elementEnd();
    \u0275\u0275element(178, "input", 89);
    \u0275\u0275template(179, ConsignmentNewComponent_mat_error_179_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(180, "div", 90)(181, "p", 17);
    \u0275\u0275text(182, "Weight");
    \u0275\u0275elementEnd();
    \u0275\u0275element(183, "input", 91);
    \u0275\u0275template(184, ConsignmentNewComponent_mat_error_184_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(185, "div", 92)(186, "p", 17);
    \u0275\u0275text(187, "Weight Unit");
    \u0275\u0275elementEnd();
    \u0275\u0275element(188, "input", 93);
    \u0275\u0275template(189, ConsignmentNewComponent_mat_error_189_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(190, "div", 94)(191, "p", 17);
    \u0275\u0275text(192, "Volume");
    \u0275\u0275elementEnd();
    \u0275\u0275element(193, "input", 95);
    \u0275\u0275template(194, ConsignmentNewComponent_mat_error_194_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(195, "div", 96)(196, "p", 17);
    \u0275\u0275text(197, "Volume Unit");
    \u0275\u0275elementEnd();
    \u0275\u0275element(198, "input", 97);
    \u0275\u0275template(199, ConsignmentNewComponent_mat_error_199_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(200, "div", 98)(201, "p", 17);
    \u0275\u0275text(202, "Net Weight");
    \u0275\u0275elementEnd();
    \u0275\u0275element(203, "input", 99);
    \u0275\u0275template(204, ConsignmentNewComponent_mat_error_204_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(205, "div", 100)(206, "p", 17);
    \u0275\u0275text(207, "Gross Weight");
    \u0275\u0275elementEnd();
    \u0275\u0275element(208, "input", 101);
    \u0275\u0275template(209, ConsignmentNewComponent_mat_error_209_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(210, "div", 102)(211, "p", 17);
    \u0275\u0275text(212, "Invoice Date");
    \u0275\u0275elementEnd();
    \u0275\u0275element(213, "p-calendar", 103);
    \u0275\u0275template(214, ConsignmentNewComponent_mat_error_214_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(215, "div", 104)(216, "p", 17);
    \u0275\u0275text(217, "Goods Description");
    \u0275\u0275elementEnd();
    \u0275\u0275element(218, "input", 105);
    \u0275\u0275template(219, ConsignmentNewComponent_mat_error_219_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(220, "div", 106)(221, "p", 17);
    \u0275\u0275text(222, "Consignment Value");
    \u0275\u0275elementEnd();
    \u0275\u0275element(223, "input", 107);
    \u0275\u0275template(224, ConsignmentNewComponent_mat_error_224_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(225, "div", 108)(226, "p", 17);
    \u0275\u0275text(227, "Consignment Currency");
    \u0275\u0275elementEnd();
    \u0275\u0275element(228, "p-dropdown", 109);
    \u0275\u0275template(229, ConsignmentNewComponent_mat_error_229_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(230, "div", 58)(231, "button", 66);
    ...
    \u0275\u0275text(234, "Next");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(235, "p-tabPanel", 110)(236, "form", 14)(237, "div", 15)(238, "div", 111)(239, "p", 17);
    \u0275\u0275text(240, "Name");
    \u0275\u0275elementEnd();
    \u0275\u0275element(241, "input", 112);
    \u0275\u0275template(242, ConsignmentNewComponent_mat_error_242_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(243, "div", 113)(244, "p", 17);
    \u0275\u0275text(245, "Company Name");
    \u0275\u0275elementEnd();
    \u0275\u0275element(246, "input", 114);
    \u0275\u0275template(247, ConsignmentNewComponent_mat_error_247_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(248, "div", 115)(249, "p", 17);
    \u0275\u0275text(250, "Address Line 1 ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(251, "input", 116);
    \u0275\u0275template(252, ConsignmentNewComponent_mat_error_252_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(253, "div", 117)(254, "p", 17);
    \u0275\u0275text(255, "Address Line 2 ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(256, "input", 118);
    \u0275\u0275template(257, ConsignmentNewComponent_mat_error_257_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(258, "div", 119)(259, "p", 17);
    \u0275\u0275text(260, "Country");
    \u0275\u0275elementEnd();
    \u0275\u0275element(261, "p-dropdown", 120);
    \u0275\u0275template(262, ConsignmentNewComponent_mat_error_262_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(263, "div", 121)(264, "p", 17);
    \u0275\u0275text(265, "State");
    \u0275\u0275elementEnd();
    \u0275\u0275element(266, "p-dropdown", 122);
    \u0275\u0275template(267, ConsignmentNewComponent_mat_error_267_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(268, "div", 123)(269, "p", 17);
    \u0275\u0275text(270, "District");
    \u0275\u0275elementEnd();
    \u0275\u0275element(271, "p-dropdown", 124);
    \u0275\u0275template(272, ConsignmentNewComponent_mat_error_272_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(273, "div", 125)(274, "p", 17);
    \u0275\u0275text(275, "City");
    \u0275\u0275elementEnd();
    \u0275\u0275element(276, "p-dropdown", 126);
    \u0275\u0275template(277, ConsignmentNewComponent_mat_error_277_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(278, "div", 127)(279, "p", 17);
    \u0275\u0275text(280, "Pincode");
    \u0275\u0275elementEnd();
    \u0275\u0275element(281, "input", 128);
    \u0275\u0275template(282, ConsignmentNewComponent_mat_error_282_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(283, "div", 129)(284, "p", 17);
    \u0275\u0275text(285, "Latitude");
    \u0275\u0275elementEnd();
    \u0275\u0275element(286, "input", 130);
    \u0275\u0275template(287, ConsignmentNewComponent_mat_error_287_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(288, "div", 131)(289, "p", 17);
    \u0275\u0275text(290, "Longitude");
    \u0275\u0275elementEnd();
    \u0275\u0275element(291, "input", 132);
    \u0275\u0275template(292, ConsignmentNewComponent_mat_error_292_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(293, "div", 133)(294, "p", 17);
    \u0275\u0275text(295, "Phone");
    \u0275\u0275elementEnd();
    \u0275\u0275element(296, "input", 134);
    \u0275\u0275template(297, ConsignmentNewComponent_mat_error_297_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(298, "div", 135)(299, "p", 17);
    \u0275\u0275text(300, "Alternate Phone No");
    \u0275\u0275elementEnd();
    \u0275\u0275element(301, "input", 136);
    \u0275\u0275template(302, ConsignmentNewComponent_mat_error_302_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(303, "div", 137)(304, "p", 17);
    \u0275\u0275text(305, "Email");
    \u0275\u0275elementEnd();
    \u0275\u0275element(306, "input", 138);
    \u0275\u0275template(307, ConsignmentNewComponent_mat_error_307_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(308, "div", 139)(309, "p", 17);
    \u0275\u0275text(310, "Address Hub Code");
    \u0275\u0275elementEnd();
    \u0275\u0275element(311, "input", 140);
    \u0275\u0275template(312, ConsignmentNewComponent_mat_error_312_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(313, "div", 141)(314, "p", 17);
    \u0275\u0275text(315, "Account ID");
    \u0275\u0275elementEnd();
    \u0275\u0275element(316, "input", 142);
    \u0275\u0275template(317, ConsignmentNewComponent_mat_error_317_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(318, "div", 58)(319, "button", 66);
    ...
    \u0275\u0275text(322, "Next");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(323, "p-tabPanel", 143)(324, "form", 14)(325, "div", 15)(326, "div", 144)(327, "p", 17);
    \u0275\u0275text(328, "Consignee Name");
    \u0275\u0275elementEnd();
    \u0275\u0275element(329, "input", 112);
    \u0275\u0275template(330, ConsignmentNewComponent_mat_error_330_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(331, "div", 145)(332, "p", 17);
    \u0275\u0275text(333, "Address Line 1 ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(334, "input", 116);
    \u0275\u0275template(335, ConsignmentNewComponent_mat_error_335_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(336, "div", 146)(337, "p", 17);
    \u0275\u0275text(338, "Address Line 2 ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(339, "input", 118);
    \u0275\u0275template(340, ConsignmentNewComponent_mat_error_340_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(341, "div", 147)(342, "p", 17);
    \u0275\u0275text(343, "Country");
    \u0275\u0275elementEnd();
    \u0275\u0275element(344, "p-dropdown", 120);
    \u0275\u0275template(345, ConsignmentNewComponent_mat_error_345_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(346, "div", 148)(347, "p", 17);
    \u0275\u0275text(348, "State");
    \u0275\u0275elementEnd();
    \u0275\u0275element(349, "p-dropdown", 122);
    \u0275\u0275template(350, ConsignmentNewComponent_mat_error_350_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(351, "div", 149)(352, "p", 17);
    \u0275\u0275text(353, "District");
    \u0275\u0275elementEnd();
    \u0275\u0275element(354, "p-dropdown", 124);
    \u0275\u0275template(355, ConsignmentNewComponent_mat_error_355_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(356, "div", 150)(357, "p", 17);
    \u0275\u0275text(358, "City");
    \u0275\u0275elementEnd();
    \u0275\u0275element(359, "p-dropdown", 126);
    \u0275\u0275template(360, ConsignmentNewComponent_mat_error_360_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(361, "div", 151)(362, "p", 17);
    \u0275\u0275text(363, "Pincode");
    \u0275\u0275elementEnd();
    \u0275\u0275element(364, "input", 128);
    \u0275\u0275template(365, ConsignmentNewComponent_mat_error_365_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(366, "div", 152)(367, "p", 17);
    \u0275\u0275text(368, "Latitude");
    \u0275\u0275elementEnd();
    \u0275\u0275element(369, "input", 130);
    \u0275\u0275template(370, ConsignmentNewComponent_mat_error_370_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(371, "div", 153)(372, "p", 17);
    \u0275\u0275text(373, "Longitude");
    \u0275\u0275elementEnd();
    \u0275\u0275element(374, "input", 132);
    \u0275\u0275template(375, ConsignmentNewComponent_mat_error_375_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(376, "div", 154)(377, "p", 17);
    \u0275\u0275text(378, "Phone");
    \u0275\u0275elementEnd();
    \u0275\u0275element(379, "input", 134);
    \u0275\u0275template(380, ConsignmentNewComponent_mat_error_380_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(381, "div", 155)(382, "p", 17);
    \u0275\u0275text(383, "Alternate Phone No");
    \u0275\u0275elementEnd();
    \u0275\u0275element(384, "input", 136);
    \u0275\u0275template(385, ConsignmentNewComponent_mat_error_385_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(386, "div", 156)(387, "p", 17);
    \u0275\u0275text(388, "Email");
    \u0275\u0275elementEnd();
    \u0275\u0275element(389, "input", 138);
    \u0275\u0275template(390, ConsignmentNewComponent_mat_error_390_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(391, "div", 157)(392, "p", 17);
    \u0275\u0275text(393, "Company Name");
    \u0275\u0275elementEnd();
    \u0275\u0275element(394, "input", 114);
    \u0275\u0275template(395, ConsignmentNewComponent_mat_error_395_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(396, "div", 158)(397, "p", 17);
    \u0275\u0275text(398, "Address Hub Code");
    \u0275\u0275elementEnd();
    \u0275\u0275element(399, "input", 140);
    \u0275\u0275template(400, ConsignmentNewComponent_mat_error_400_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(401, "div", 159)(402, "p", 17);
    \u0275\u0275text(403, "Account ID");
    \u0275\u0275elementEnd();
    \u0275\u0275element(404, "input", 142);
    \u0275\u0275template(405, ConsignmentNewComponent_mat_error_405_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(406, "div", 58)(407, "button", 66);
    ...
    \u0275\u0275text(410, "Next");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(411, "p-tabPanel", 160)(412, "form", 14)(413, "div", 161)(414, "div", 162)(415, "p", 17);
    \u0275\u0275text(416, "Consignment Currency");
    \u0275\u0275elementEnd();
    \u0275\u0275element(417, "input", 163);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(418, "div", 162)(419, "p", 17);
    \u0275\u0275text(420, "Consignment Value");
    \u0275\u0275elementEnd();
    \u0275\u0275element(421, "input", 163);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(422, "div", 164)(423, "p", 17);
    \u0275\u0275text(424, "Customs Insurance");
    \u0275\u0275elementEnd();
    \u0275\u0275element(425, "input", 165);
    \u0275\u0275template(426, ConsignmentNewComponent_mat_error_426_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(427, "div", 166)(428, "p", 17);
    \u0275\u0275text(429, "Duty Percentage");
    \u0275\u0275elementEnd();
    \u0275\u0275element(430, "input", 167);
    \u0275\u0275template(431, ConsignmentNewComponent_mat_error_431_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(432, "div", 168)(433, "p", 17);
    \u0275\u0275text(434, "DDU Charge");
    \u0275\u0275elementEnd();
    \u0275\u0275element(435, "input", 169);
    \u0275\u0275template(436, ConsignmentNewComponent_mat_error_436_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(437, "div", 170)(438, "p", 17);
    \u0275\u0275text(439, "Special Approval Charge");
    \u0275\u0275elementEnd();
    \u0275\u0275element(440, "input", 171);
    \u0275\u0275template(441, ConsignmentNewComponent_mat_error_441_Template, 3, 1, "mat-error", 19);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(442, "div", 58)(443, "button", 66);
    \u0275\u0275listener("click", function ConsignmentNewComponent_Template_button_click_443_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.activeIndex = ctx.activeIndex - 1);
    });
    \u0275\u0275text(444, "Back");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(445, "button", 60);
    \u0275\u0275listener("click", function ConsignmentNewComponent_Template_button_click_445_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.saveBilling());
    });
    \u0275\u0275text(446, "Save");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(447, "p-tabPanel", 172)(448, "p-table", 173, 1);
    \u0275\u0275twoWayListener("selectionChange", function ConsignmentNewComponent_Template_p_table_selectionChange_448_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.selectedConsignment, $event) || (ctx.selectedConsignment = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275template(450, ConsignmentNewComponent_ng_template_450_Template, 4, 2, "ng-template", 64)(451, ConsignmentNewComponent_ng_template_451_Template, 4, 3, "ng-template", 65)(452, ConsignmentNewComponent_ng_template_452_Template, 4, 1, "ng-template", 174)(453, ConsignmentNewComponent_ng_template_453_Template, 4, 1, "ng-template", 175);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(454, "div", 58)(455, "button", 66);
    \u0275\u0275listener("click", function ConsignmentNewComponent_Template_button_click_455_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.activeIndex = ctx.activeIndex - 1);
    });
    \u0275\u0275text(456, "Back");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(457, "button", 60);
    \u0275\u0275listener("click", function ConsignmentNewComponent_Template_button_click_457_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.saveBilling());
    });
    \u0275\u0275text(458, "Save");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(258, _c04));
    \u0275\u0275property("options", ctx.companyIdList)("panelStyle", \u0275\u0275pureFunction0(259, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingShipment("companyId"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(260, _c04));
    \u0275\u0275property("options", ctx.productIdList)("ngClass", ((tmp_12_0 = ctx.shipmentInfo.get("productId")) == null ? null : tmp_12_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(261, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingShipment("productId"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(262, _c04));
    \u0275\u0275property("options", ctx.serviceTypeIdList)("ngClass", ((tmp_17_0 = ctx.shipmentInfo.get("serviceTypeId")) == null ? null : tmp_17_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(263, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingShipment("serviceTypeId"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(264, _c04));
    \u0275\u0275property("options", ctx.partnerType)("ngClass", ((tmp_22_0 = ctx.shipmentInfo.get("partnerType")) == null ? null : tmp_22_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(265, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingShipment("partnerType"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(266, _c04));
    \u0275\u0275property("options", ctx.partnerNameList)("ngClass", ((tmp_27_0 = ctx.shipmentInfo.get("partnerId")) == null ? null : tmp_27_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(267, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingShipment("partnerId"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(268, _c04));
    \u0275\u0275property("options", ctx.consignmentTypeIdList)("panelStyle", \u0275\u0275pureFunction0(269, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingShipment("consignmentType"));
    \u0275\u0275advance(5);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(270, _c04));
    \u0275\u0275property("options", ctx.loadTypeIdList)("ngClass", ((tmp_36_0 = ctx.shipmentInfo.get("loadTypeId")) == null ? null : tmp_36_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(271, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingShipment("loadTypeId"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_39_0 = ctx.shipmentInfo.get("customerReferenceNumber")) == null ? null : tmp_39_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingShipment("customerReferenceNumber"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_41_0 = ctx.shipmentInfo.get("noOfPieceHawb")) == null ? null : tmp_41_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingShipment("noOfPieceHawb"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(272, _c04));
    \u0275\u0275property("options", ctx.countryIdListOrigin)("panelStyle", \u0275\u0275pureFunction0(273, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingShipment("countryOfOrigin"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(274, _c04));
    \u0275\u0275property("options", ctx.countryIdListOrigin)("panelStyle", \u0275\u0275pureFunction0(275, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingShipment("countryOfDestination"));
    \u0275\u0275advance(5);
    \u0275\u0275property("ngClass", ((tmp_51_0 = ctx.shipmentInfo.get("invoiceNumber")) == null ? null : tmp_51_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx.errorHandlingShipment("invoiceNumber"));
    \u0275\u0275advance(6);
    \u0275\u0275property("ngClass", ((tmp_53_0 = ctx.consignment.get("invoiceAmount")) == null ? null : tmp_53_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingShipment("invoiceAmount"));
    \u0275\u0275advance(5);
    \u0275\u0275property("ngClass", ((tmp_55_0 = ctx.shipmentInfo.get("invoiceUrl")) == null ? null : tmp_55_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx.errorHandlingShipment("invoiceUrl"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(276, _c04));
    \u0275\u0275property("options", ctx.incoTerms)("ngClass", ((tmp_59_0 = ctx.shipmentInfo.get("incoTerms")) == null ? null : tmp_59_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(277, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingShipment("incoTerms"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(278, _c04));
    \u0275\u0275property("options", ctx.paymentType)("ngClass", ((tmp_64_0 = ctx.shipmentInfo.get("paymentType")) == null ? null : tmp_64_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(279, _c04));
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(5);
    \u0275\u0275property("ngClass", ((tmp_76_0 = ctx.consignment.get("partnerMasterAirwayBill")) == null ? null : tmp_76_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingConsignment("partnerMasterAirwayBill"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_78_0 = ctx.consignment.get("partnerHouseAirwayBill")) == null ? null : tmp_78_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingConsignment("partnerHouseAirwayBill"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_80_0 = ctx.consignment.get("airportOriginCode")) == null ? null : tmp_80_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingConsignment("airportOriginCode"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_82_0 = ctx.consignment.get("flightNo")) == null ? null : tmp_82_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingConsignment("flightNo"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_84_0 = ctx.consignment.get("flightArrivalTime")) == null ? null : tmp_84_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("iconDisplay", "input")("showIcon", true);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingConsignment("flightArrivalTime"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_88_0 = ctx.consignment.get("noOfPackages")) == null ? null : tmp_88_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingConsignment("noOfPackages"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_90_0 = ctx.consignment.get("flightName")) == null ? null : tmp_90_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingConsignment("flightName"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_92_0 = ctx.consignment.get("length")) == null ? null : tmp_92_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingConsignment("length"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_94_0 = ctx.consignment.get("width")) == null ? null : tmp_94_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingConsignment("width"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_96_0 = ctx.consignment.get("height")) == null ? null : tmp_96_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingConsignment("height"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_98_0 = ctx.consignment.get("dimensionUnit")) == null ? null : tmp_98_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingConsignment("dimensionUnit"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_100_0 = ctx.consignment.get("weight")) == null ? null : tmp_100_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingConsignment("weight"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_102_0 = ctx.consignment.get("weightUnit")) == null ? null : tmp_102_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingConsignment("weightUnit"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_104_0 = ctx.consignment.get("volume")) == null ? null : tmp_104_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingConsignment("volume"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_106_0 = ctx.consignment.get("volumeUnit")) == null ? null : tmp_106_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingConsignment("volumeUnit"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_108_0 = ctx.consignment.get("netWeight")) == null ? null : tmp_108_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingConsignment("netWeight"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_110_0 = ctx.consignment.get("grossWeight")) == null ? null : tmp_110_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingConsignment("grossWeight"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_112_0 = ctx.consignment.get("invoiceDateFE")) == null ? null : tmp_112_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("iconDisplay", "input")("showIcon", true);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingConsignment("invoiceDateFE"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_116_0 = ctx.consignment.get("goodsDescription")) == null ? null : tmp_116_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingConsignment("goodsDescription"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_118_0 = ctx.consignment.get("consignmentValue")) == null ? null : tmp_118_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingConsignment("consignmentValue"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(280, _c04));
    \u0275\u0275property("options", ctx.currencyDropdown)("ngClass", ((tmp_122_0 = ctx.consignment.get("consignmentCurrency")) == null ? null : tmp_122_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(281, _c04));
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(5);
    \u0275\u0275property("ngClass", ((tmp_127_0 = ctx.senderInfo.get("originDetails.name")) == null ? null : tmp_127_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingSender("originDetails.name"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_129_0 = ctx.senderInfo.get("companyName")) == null ? null : tmp_129_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingSender("companyName"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_131_0 = ctx.senderInfo.get("originDetails.addressLine1")) == null ? null : tmp_131_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingSender("originDetails.addressLine1"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_133_0 = ctx.senderInfo.get("originDetails.addressLine2")) == null ? null : tmp_133_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingSender("originDetails.addressLine2"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(282, _c04));
    \u0275\u0275property("options", ctx.countryIdListOrigin)("ngClass", ((tmp_137_0 = ctx.senderInfo.get("originDetails.country")) == null ? null : tmp_137_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(283, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingSender("originDetails.country"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(284, _c04));
    \u0275\u0275property("options", ctx.provinceIdList)("ngClass", ((tmp_142_0 = ctx.senderInfo.get("originDetails.state")) == null ? null : tmp_142_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(285, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingSender("originDetails.state"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(286, _c04));
    \u0275\u0275property("options", ctx.districtIdList)("ngClass", ((tmp_147_0 = ctx.senderInfo.get("originDetails.district")) == null ? null : tmp_147_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(287, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingSender("originDetails.district"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(288, _c04));
    \u0275\u0275property("options", ctx.cityIdList)("ngClass", ((tmp_152_0 = ctx.senderInfo.get("originDetails.city")) == null ? null : tmp_152_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(289, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingSender("originDetails.city"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_155_0 = ctx.senderInfo.get("originDetails.pinCode")) == null ? null : tmp_155_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingSender("originDetails.pinCode"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_157_0 = ctx.senderInfo.get("originDetails.latitude")) == null ? null : tmp_157_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingSender("originDetails.latitude"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_159_0 = ctx.senderInfo.get("originDetails.longitude")) == null ? null : tmp_159_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingSender("originDetails.longitude"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_161_0 = ctx.senderInfo.get("originDetails.phone")) == null ? null : tmp_161_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingSender("originDetails.phone"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_163_0 = ctx.senderInfo.get("originDetails.alternatePhone")) == null ? null : tmp_163_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingSender("originDetails.alternatePhone"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_165_0 = ctx.senderInfo.get("originDetails.email")) == null ? null : tmp_165_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingSender("originDetails.email"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_167_0 = ctx.senderInfo.get("originDetails.addressHubCode")) == null ? null : tmp_167_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingSender("originDetails.addressHubCode"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_169_0 = ctx.senderInfo.get("originDetails.accountId")) == null ? null : tmp_169_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(5);
    \u0275\u0275property("ngClass", ((tmp_173_0 = ctx.deliveryInfo.get("destinationDetails.name")) == null ? null : tmp_173_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingDelivery("destinationDetails.name"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_175_0 = ctx.deliveryInfo.get("destinationDetails.addressLine1")) == null ? null : tmp_175_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingDelivery("destinationDetails.addressLine1"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_177_0 = ctx.deliveryInfo.get("destinationDetails.addressLine2")) == null ? null : tmp_177_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingDelivery("destinationDetails.addressLine2"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(290, _c04));
    \u0275\u0275property("options", ctx.countryIdListDestination)("ngClass", ((tmp_181_0 = ctx.deliveryInfo.get("destinationDetails.country")) == null ? null : tmp_181_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(291, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingDelivery("destinationDetails.country"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(292, _c04));
    \u0275\u0275property("options", ctx.provinceIdList)("ngClass", ((tmp_186_0 = ctx.deliveryInfo.get("destinationDetails.state")) == null ? null : tmp_186_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(293, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingDelivery("destinationDetails.state"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(294, _c04));
    \u0275\u0275property("options", ctx.districtIdList)("ngClass", ((tmp_191_0 = ctx.deliveryInfo.get("destinationDetails.district")) == null ? null : tmp_191_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(295, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingDelivery("destinationDetails.district"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(296, _c04));
    \u0275\u0275property("options", ctx.cityIdList)("ngClass", ((tmp_196_0 = ctx.deliveryInfo.get("destinationDetails.city")) == null ? null : tmp_196_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(297, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingDelivery("destinationDetails.city"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_199_0 = ctx.senderInfo.get("destinationDetails.pinCode")) == null ? null : tmp_199_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingSender("destinationDetails.pinCode"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_201_0 = ctx.deliveryInfo.get("destinationDetails.latitude")) == null ? null : tmp_201_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingDelivery("destinationDetails.latitude"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_203_0 = ctx.deliveryInfo.get("destinationDetails.longitude")) == null ? null : tmp_203_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingDelivery("destinationDetails.longitude"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_205_0 = ctx.deliveryInfo.get("destinationDetails.phone")) == null ? null : tmp_205_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingDelivery("destinationDetails.phone"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_207_0 = ctx.deliveryInfo.get("destinationDetails.alternatePhone")) == null ? null : tmp_207_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingDelivery("destinationDetails.alternatePhone"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_209_0 = ctx.deliveryInfo.get("destinationDetails.email")) == null ? null : tmp_209_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingDelivery("destinationDetails.email"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_211_0 = ctx.deliveryInfo.get("destinationDetails.companyName")) == null ? null : tmp_211_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingDelivery("destinationDetails.companyName"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_213_0 = ctx.deliveryInfo.get("destinationDetails.addressHubCode")) == null ? null : tmp_213_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingDelivery("destinationDetails.addressHubCode"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_215_0 = ctx.deliveryInfo.get("destinationDetails.accountId")) == null ? null : tmp_215_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    ...
    \u0275\u0275property("disabled", ctx.disabledBilling);
    \u0275\u0275advance();
    \u0275\u0275property("columns", ctx.cols)("value", ctx.billingTable)("scrollable", true);
    \u0275\u0275twoWayProperty("selection", ctx.selectedConsignment);
    \u0275\u0275property("sortOrder", -1)("tableStyle", \u0275\u0275pureFunction0(298, _c13));
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConsignmentNewComponent, { className: "ConsignmentNewComponent", filePath: "src\\app\\main\\operation\\consignment\\consignment-new\\consignment-new.component.ts", lineNumber: 26 });
})();
...
//# sourceMappingURL=chunk-4DTYOTDM.js.map
