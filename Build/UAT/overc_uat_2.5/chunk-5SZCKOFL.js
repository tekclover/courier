...
var routes = [{
  ...
  children: [
    { path: "idMaster", loadChildren: () => import("./chunk-ZPSQNCCR.js").then((m) => m.IdMastersModule) },
    { path: "master", loadChildren: () => import("./chunk-W7MFHM3W.js").then((m) => m.MasterModule) },
    { path: "airport", loadChildren: () => import("./chunk-CIUM4FRL.js").then((m) => m.AirportModule) },
    { path: "operation", loadChildren: () => import("./chunk-NXPVJEQ3.js").then((m) => m.OperationModule) },
    { path: "reports", loadChildren: () => import("./chunk-TNDWFJKG.js").then((m) => m.ReportsModule) }
  ]
}];
...
//# sourceMappingURL=chunk-5SZCKOFL.js.map
