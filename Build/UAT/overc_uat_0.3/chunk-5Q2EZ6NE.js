import {
  ...
  ProvinceService,
  SubProductService
} from "./chunk-J2B6DZWC.js";
import {
  IataService
} from "./chunk-7BUM3ULC.js";
import {
  NumberrangeService
} from "./chunk-IPMB46AD.js";
import {
  ProductService
...
function CustomerNewComponent_ng_template_45_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(12);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "td")(14, "p", 28);
    \u0275\u0275text(15);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "td")(17, "div", 29)(18, "img", 30);
    \u0275\u0275listener("click", function CustomerNewComponent_ng_template_45_Template_img_click_18_listener() {
      const i_r3 = \u0275\u0275restoreView(_r2).rowIndex;
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.editItem("Edit", i_r3));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "img", 31);
    \u0275\u0275listener("click", function CustomerNewComponent_ng_template_45_Template_img_click_19_listener() {
      const i_r3 = \u0275\u0275restoreView(_r2).rowIndex;
      const ctx_r0 = \u0275\u0275nextContext();
...
_CustomerNewComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CustomerNewComponent, selectors: [["app-customer-new"]], decls: 51, vars: 27, consts: [[1, "componentBody"], [1, "d-flex", "justify-content-between", "align-items-center"], [1, "componentHeader", "f600", "mb-0"], ["type", "button", 1, "invisible", "buttom1", "bgBlack", "text-white", "ml-2"], [1, "mx-auto", "mt-4"], [3, "formGroup"], [1, "d-flex-row"], [1, "row"], [1, "col-4", "marginFieldNew", "borderRadius12"], [1, "formControlLabel", "f600", "textBlack", "mb-0"], ["formControlName", "languageId", "appendTo", "body", 3, "options", "disabled", "panelStyle"], ["class", "text-danger", 4, "ngIf"], ["formControlName", "companyId", "appendTo", "body", 3, "options", "disabled", "panelStyle"], ["maxlength", "50", "pInputText", "", "pKeyFilter", "alphanum", "formControlName", "customerId", "pInputText", "", "placeholder", "Enter", 1, "w-100"], [1, "formControlLabel", "f600", "textBlack", "mb-0", "required"], ["maxlength", "100", "pInputText", "", "formControlName", "customerName", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["appendTo", "body", "formControlName", "statusId", "placeholder", "Select ", 3, "options"], ["maxlength", "2000", "formControlName", "remark", "pInputText", "", "placeholder", "Enter", 1, "w-100"], [1, "d-flex", "justify-content-end", "mb-3"], ["type", "button", 1, "btn", "ml-2", "addNewbuttom", "bgBlack", "text-white", 3, "click"], [1, "bi", "bi-plus-square", "pr-2"], ["scrollHeight", "calc(100vh - 31.8rem)", 3, "scrollable", "value"], ["pTemplate", "header"], ["pTemplate", "body"], [1, "d-flex", "mt-1", "justify-content-end", 2, "position", "absolute", "right", "5%", "bottom", "7%"], ["routerLink", "/main/master/customer", 1, "buttom1", "textBlack", "mx-1"], [1, "buttom1", "bgBlack", "text-white", "mx-1", 3, "click"], [1, "text-danger"], [1, "w-100", "pl-2", "ml-2"], [1, "d-flex", "img-icon", "px-3"], ["type", "button", "src", "./assets/common/edit.png", "alt", "", "width", "24px", "height", "24px", 3, "click"], ["type", "button", "src", "./assets/common/deletetool.png", "alt", "", "srcset", "", "width", "24px", "height", "24px", 3, "click"]], template: function CustomerNewComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(15, CustomerNewComponent_mat_error_15_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "div", 8)(17, "p", 9);
    \u0275\u0275text(18, "Company");
    \u0275\u0275elementEnd();
    \u0275\u0275element(19, "p-dropdown", 12);
    \u0275\u0275template(20, CustomerNewComponent_mat_error_20_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(29, CustomerNewComponent_mat_error_29_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(44, CustomerNewComponent_ng_template_44_Template, 13, 0, "ng-template", 22)(45, CustomerNewComponent_ng_template_45_Template, 20, 5, "ng-template", 23);
    \u0275\u0275elementEnd()()();
...
function ConsignorNewComponent_ng_template_45_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(15);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "td")(17, "p", 28);
    \u0275\u0275text(18);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "td")(20, "p", 28);
    \u0275\u0275text(21);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "td")(23, "p", 28);
    \u0275\u0275text(24);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(25, "td")(26, "div", 29)(27, "img", 30);
    \u0275\u0275listener("click", function ConsignorNewComponent_ng_template_45_Template_img_click_27_listener() {
      const i_r3 = \u0275\u0275restoreView(_r2).rowIndex;
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.editItem("Edit", i_r3));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "img", 31);
    \u0275\u0275listener("click", function ConsignorNewComponent_ng_template_45_Template_img_click_28_listener() {
      const i_r3 = \u0275\u0275restoreView(_r2).rowIndex;
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.removeItem(i_r3));
    });
...
_ConsignorNewComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConsignorNewComponent, selectors: [["app-consignor-new"]], decls: 51, vars: 27, consts: [[1, "componentBody"], [1, "d-flex", "justify-content-between", "align-items-center"], [1, "componentHeader", "f600", "mb-0"], ["type", "button", 1, "invisible", "buttom1", "bgBlack", "text-white", "ml-2"], [1, "mx-auto", "mt-4"], [3, "formGroup"], [1, "d-flex-row"], [1, "row"], [1, "col-4", "marginFieldNew", "borderRadius12"], [1, "formControlLabel", "f600", "textBlack", "mb-0"], ["formControlName", "languageId", "appendTo", "body", 3, "options", "disabled", "panelStyle"], ["class", "text-danger", 4, "ngIf"], ["formControlName", "companyId", "appendTo", "body", 3, "options", "disabled", "panelStyle"], ["maxlength", "50", "pInputText", "", "pKeyFilter", "alphanum", "formControlName", "consignorId", "pInputText", "", "placeholder", "Enter", 1, "w-100"], [1, "formControlLabel", "f600", "textBlack", "mb-0", "required"], ["maxlength", "100", "pInputText", "", "formControlName", "consignorName", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["appendTo", "body", "formControlName", "statusId", "placeholder", "Select ", 3, "options"], ["maxlength", "2000", "formControlName", "remark", "pInputText", "", "placeholder", "Enter", 1, "w-100"], [1, "d-flex", "justify-content-end", "mb-3"], ["type", "button", 1, "btn", "ml-2", "addNewbuttom", "bgBlack", "text-white", 3, "click"], [1, "bi", "bi-plus-square", "pr-2"], ["scrollHeight", "calc(100vh - 31.8rem)", 3, "scrollable", "value"], ["pTemplate", "header"], ["pTemplate", "body"], [1, "d-flex", "mt-1", "justify-content-end", 2, "position", "absolute", "right", "5%", "bottom", "7%"], ["routerLink", "/main/master/consignor", 1, "buttom1", "textBlack", "mx-1"], [1, "buttom1", "bgBlack", "text-white", "mx-1", 3, "click"], [1, "text-danger"], [1, "w-100", "pl-2", "ml-2"], [1, "d-flex", "img-icon", "px-3"], ["type", "button", "src", "./assets/common/edit.png", "alt", "", "width", "24px", "height", "24px", 3, "click"], ["type", "button", "src", "./assets/common/deletetool.png", "alt", "", "srcset", "", "width", "24px", "height", "24px", 3, "click"]], template: function ConsignorNewComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(14, "p-dropdown", 10);
    \u0275\u0275template(15, ConsignorNewComponent_mat_error_15_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "div", 8)(17, "p", 9);
    \u0275\u0275text(18, "Company");
    \u0275\u0275elementEnd();
    \u0275\u0275element(19, "p-dropdown", 12);
    \u0275\u0275template(20, ConsignorNewComponent_mat_error_20_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "div", 8)(22, "p", 9);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(28, "input", 15);
    \u0275\u0275template(29, ConsignorNewComponent_mat_error_29_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "div", 8)(31, "p", 9);
    \u0275\u0275text(32, "Status");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(42, "div", 6)(43, "p-table", 21);
    \u0275\u0275template(44, ConsignorNewComponent_ng_template_44_Template, 19, 0, "ng-template", 22)(45, ConsignorNewComponent_ng_template_45_Template, 29, 8, "ng-template", 23);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(46, "div", 24)(47, "button", 25);
    \u0275\u0275text(48, "Cancel");
    \u0275\u0275elementEnd();
...
//# sourceMappingURL=chunk-5Q2EZ6NE.js.map
