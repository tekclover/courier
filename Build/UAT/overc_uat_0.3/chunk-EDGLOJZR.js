...
function ConsoleEditComponent_ng_template_30_Template(rf, ctx) {
  if (rf & 1) {
...
function ConsoleEditComponent_ng_template_31_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(44);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(45, "td")(46, "p", 27);
    \u0275\u0275text(47);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(48, "td")(49, "p", 27);
    \u0275\u0275text(50);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(51, "td")(52, "p", 27);
    \u0275\u0275text(53);
    \u0275\u0275pipe(54, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(55, "td")(56, "div", 28)(57, "img", 29);
    \u0275\u0275listener("click", function ConsoleEditComponent_ng_template_31_Template_img_click_57_listener() {
      const item_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.editItem("Edit", item_r4));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(58, "img", 30);
    \u0275\u0275listener("click", function ConsoleEditComponent_ng_template_31_Template_img_click_58_listener() {
      const item_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.removeItem(item_r4));
    });
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", item_r4.masterAirwayBill, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", item_r4.houseAirwayBill, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", item_r4.partnerMasterAirwayBill, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", item_r4.partnerHouseAirwayBill, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", item_r4.description, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", item_r4.quantity, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", item_r4.countryOfOrigin, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", item_r4.grossWeight, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", item_r4.airportOriginCode, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", item_r4.hsCode, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", item_r4.consigneeName, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", item_r4.consignmentValue, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", item_r4.consignmentCurrency, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", item_r4.customsValue, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", item_r4.customsKd, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", item_r4.iataKd, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind2(54, 18, item_r4.createdOn, "dd-MM-yyyy HH:mm"), " ");
  }
}
...
_ConsoleEditComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConsoleEditComponent, selectors: [["app-console-edit"]], decls: 37, vars: 25, consts: [[1, "componentBody"], [1, "d-flex", "justify-content-between", "align-items-center"], [1, "componentHeader", "f600", "mb-0"], ["type", "button", "class", "buttom1 bgBlack text-white ml-2", 3, "click", 4, "ngIf"], [1, "mx-auto", "mt-4"], [3, "formGroup"], [1, "d-flex-row"], [1, "row", "scrollNew"], [1, "col-3", "marginFieldNew", "borderRadius12"], [1, "formControlLabel", "f600", "textBlack", "mb-0"], ["formControlName", "languageId", "appendTo", "body", 3, "options", "disabled", "panelStyle"], ["class", "text-danger", 4, "ngIf"], ["formControlName", "companyId", "appendTo", "body", 3, "options", "disabled", "panelStyle"], ["maxlength", "50", "pInputText", "", "pKeyFilter", "alphanum", "formControlName", "consoleId", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "pKeyFilter", "alphanum", "formControlName", "statusId", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["scrollHeight", "calc(100vh - 23rem)", "selectionMode", "multiple", 3, "selectionChange", "scrollable", "tableStyle", "value", "selection"], ["pTemplate", "header"], ["pTemplate", "body"], [1, "d-flex", "mt-1", "justify-content-end", 2, "position", "absolute", "right", "5%", "bottom", "7%"], ["routerLink", "/main/airport/console", 1, "buttom1", "textBlack", "mx-1"], [1, "buttom1", "bgBlack", "text-white", "mx-1", 3, "click"], ["type", "button", 1, "buttom1", "bgBlack", "text-white", "ml-2", 3, "click"], [1, "text-danger"], [2, "width", "5rem"], [1, "pl-3"], [2, "text-align", "center"], [3, "value"], [1, "w-100", "pl-2", "ml-2"], [1, "d-flex", "img-icon", "px-3"], ["type", "button", "src", "./assets/common/edit.png", "alt", "", "width", "24px", "height", "24px", 3, "click"], ["type", "button", "src", "./assets/common/deletetool.png", "alt", "", "srcset", "", "width", "24px", "height", "24px", 3, "click"]], template: function ConsoleEditComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "p", 2);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 1);
    \u0275\u0275template(5, ConsoleEditComponent_button_5_Template, 2, 0, "button", 3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 4)(7, "form", 5)(8, "div", 6)(9, "div", 7)(10, "div", 8)(11, "p", 9);
    \u0275\u0275text(12, "Language");
    \u0275\u0275elementEnd();
    \u0275\u0275element(13, "p-dropdown", 10);
    \u0275\u0275template(14, ConsoleEditComponent_mat_error_14_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "div", 8)(16, "p", 9);
    \u0275\u0275text(17, "Company");
    \u0275\u0275elementEnd();
    \u0275\u0275element(18, "p-dropdown", 12);
    \u0275\u0275template(19, ConsoleEditComponent_mat_error_19_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "div", 6)(29, "p-table", 15);
    \u0275\u0275twoWayListener("selectionChange", function ConsoleEditComponent_Template_p_table_selectionChange_29_listener($event) {
      \u0275\u0275twoWayBindingSet(ctx.selectedConsole, $event) || (ctx.selectedConsole = $event);
      return $event;
    });
    \u0275\u0275template(30, ConsoleEditComponent_ng_template_30_Template, 39, 0, "ng-template", 16)(31, ConsoleEditComponent_ng_template_31_Template, 59, 21, "ng-template", 17);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(32, "div", 18)(33, "button", 19);
    \u0275\u0275text(34, "Cancel");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "button", 20);
    \u0275\u0275listener("click", function ConsoleEditComponent_Template_button_click_35_listener() {
      return ctx.save();
    });
    \u0275\u0275text(36);
    \u0275\u0275elementEnd()()()()();
...
function CcrEditComponent_ng_template_41_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngForOf", columns_r10);
    \u0275\u0275advance(3);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(4, _c25));
  }
}
...
_CcrEditComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CcrEditComponent, selectors: [["app-ccr-edit"]], decls: 48, vars: 27, consts: [["ccrTag", ""], ["op", ""], ["dateTemplate", ""], [1, "componentBody"], [1, "d-flex", "justify-content-between", "align-items-center"], [1, "componentHeader", "f600", "mb-0"], ["type", "button", 1, "invisible", "buttom1", "bgBlack", "text-white", "ml-2"], [1, "mx-auto", "mt-4"], [3, "formGroup"], [1, "d-flex-row"], [1, "row", "scrollNew"], [1, "col-4", "marginFieldNew", "borderRadius12"], [1, "formControlLabel", "f600", "textBlack", "mb-0"], ["formControlName", "languageId", "appendTo", "body", 3, "options", "disabled", "panelStyle"], ["class", "text-danger", 4, "ngIf"], ["formControlName", "companyId", "appendTo", "body", 3, "options", "disabled", "panelStyle"], ["maxlength", "50", "pInputText", "", "pKeyFilter", "alphanum", "formControlName", "ccrId", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "pKeyFilter", "alphanum", "formControlName", "primaryDo", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "pKeyFilter", "alphanum", "formControlName", "secondaryDo", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "pKeyFilter", "alphanum", "formControlName", "statusId", "pInputText", "", "placeholder", "Enter", 1, "w-100"], [1, "tableProperties"], ["selectionMode", "multiple", "sortField", "createdOn", "scrollHeight", "calc(100vh - 27.8rem)", "sortField", "createdOn", "styleClass", "p-datatable-sm", 1, "custom-table", 3, "selectionChange", "columns", "value", "scrollable", "sortOrder", "selection", "tableStyle"], ["pTemplate", "header"], ["pTemplate", "body"], ["pTemplate", "emptymessage"], [1, "d-flex", "mt-1", "justify-content-end", 2, "position", "absolute", "right", "5%", "bottom", "7%"], ["routerLink", "/main/airport/ccr", 1, "buttom1", "textBlack", "mx-1"], [1, "buttom1", "bgBlack", "text-white", "mx-1", 3, "click"], [1, "text-danger"], ["pFrozenColumn", "", 2, "width", "5rem"], [1, "pl-3", 3, "disabled"], [3, "pSortableColumn", 4, "ngFor", "ngForOf"], ["pFrozenColumn", "", "alignFrozen", "right", 2, "width", "5rem"], [3, "pSortableColumn"], [3, "field"], ["pFrozenColumn", "", 2, "width", "5rem", "justify-content", "center"], [1, "pl-3", 3, "value"], [4, "ngFor", "ngForOf"], ["pFrozenColumn", "", "alignFrozen", "right", 2, "padding-left", "1.5rem !important"], ["type", "button", "src", "./assets/common/actions.png", "alt", "", "srcset", "", 2, "height", "1.4rem", 3, "click"], [1, "d-flex", "flex-column"], ["mat-menu-item", "", 1, "w-100", 2, "width", "8rem", 3, "click"], ["src", "./assets/common/edit.png", "srcset", "", 2, "padding-right", "10px", "width", "2rem"], ["src", "./assets/common/deletetool.png", "srcset", "", 2, "padding-right", "10px", "width", "2rem"], [4, "ngIf", "ngIfElse"], [1, "my-2", "w-100", "pl-3"]], template: function CcrEditComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275twoWayListener("selectionChange", function CcrEditComponent_Template_p_table_selectionChange_38_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.subProductArray, $event) || (ctx.subProductArray = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275template(40, CcrEditComponent_ng_template_40_Template, 6, 2, "ng-template", 22)(41, CcrEditComponent_ng_template_41_Template, 15, 5, "ng-template", 23)(42, CcrEditComponent_ng_template_42_Template, 4, 1, "ng-template", 24);
    \u0275\u0275elementEnd()()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275twoWayProperty("selection", ctx.subProductArray);
...
//# sourceMappingURL=chunk-EDGLOJZR.js.map
