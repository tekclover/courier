...
var routes = [{
  ...
  children: [
    { path: "idMaster", loadChildren: () => import("./chunk-7GVYEWW5.js").then((m) => m.IdMastersModule) },
    { path: "master", loadChildren: () => import("./chunk-EPXEGEDR.js").then((m) => m.MasterModule) },
    { path: "airport", loadChildren: () => import("./chunk-EGON5GP3.js").then((m) => m.AirportModule) },
    { path: "operation", loadChildren: () => import("./chunk-D5RTOUXG.js").then((m) => m.OperationModule) },
    { path: "reports", loadChildren: () => import("./chunk-WH3JBLQZ.js").then((m) => m.ReportsModule) }
  ]
}];
...
//# sourceMappingURL=chunk-2H5P62UR.js.map
