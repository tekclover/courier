...
function ConsignmentNewComponent_ng_template_101_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "th");
    \u0275\u0275text(2, "Piece No");
    \u0275\u0275elementEnd();
...
function ConsignmentNewComponent_ng_template_102_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "td", 192)(12, "img", 193);
    \u0275\u0275listener("click", function ConsignmentNewComponent_ng_template_102_Template_img_click_12_listener($event) {
      \u0275\u0275restoreView(_r2);
      const op_r3 = \u0275\u0275reference(14);
      return \u0275\u0275resetView(op_r3.toggle($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "p-overlayPanel", null, 0)(15, "div", 194)(16, "button", 195);
    \u0275\u0275listener("click", function ConsignmentNewComponent_ng_template_102_Template_button_click_16_listener() {
    ...
    \u0275\u0275element(17, "img", 196);
    \u0275\u0275text(18, "Dimension");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "button", 195);
    \u0275\u0275listener("click", function ConsignmentNewComponent_ng_template_102_Template_button_click_19_listener() {
      const i_r4 = \u0275\u0275restoreView(_r2).rowIndex;
      const op_r3 = \u0275\u0275reference(14);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275element(20, "img", 197);
    \u0275\u0275text(21, "Item");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "button", 195);
    \u0275\u0275listener("click", function ConsignmentNewComponent_ng_template_102_Template_button_click_22_listener() {
    ...
    \u0275\u0275element(23, "img", 198);
    \u0275\u0275text(24, "Delete");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "button", 195);
    \u0275\u0275listener("click", function ConsignmentNewComponent_ng_template_102_Template_button_click_25_listener() {
      const i_r4 = \u0275\u0275restoreView(_r2).rowIndex;
      const op_r3 = \u0275\u0275reference(14);
      const ctx_r0 = \u0275\u0275nextContext();
...
function ConsignmentNewComponent_mat_error_465_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 179)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function ConsignmentNewComponent_mat_error_470_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 179)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function ConsignmentNewComponent_mat_error_475_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 179)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function ConsignmentNewComponent_mat_error_480_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 179)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
_ConsignmentNewComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConsignmentNewComponent, selectors: [["app-consignment-new"]], decls: 486, vars: 305, consts: [["op", ""], [1, "componentBody"], [1, "d-flex", "justify-content-between", "align-items-center"], [1, "componentHeader", "f600", "mb-0"], [1, "mt-4", "mx-auto"], [3, "activeIndexChange", "activeIndex"], ["header", "Shipment Info"], [3, "formGroup"], [1, "row", "scrollNew22"], [1, "col-3", "marginFieldNew", "borderRadius12"], [1, "formControlLabel", "f600", "textBlack", "mb-0"], ["placeholder", "Select", "filter", "true", "formControlName", "companyId", "appendTo", "body", 3, "options", "panelStyle"], ["class", "text-danger", 4, "ngIf"], ["id", "productId", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "productId", "appendTo", "body", 3, "onChange", "options", "ngClass", "panelStyle"], ["id", "serviceTypeId", 1, "col-3", "marginFieldNew", "borderRadius12"], [1, "formControlLabel", "f600", "textBlack", "mb-0", "required"], ["placeholder", "Select", "filter", "true", "formControlName", "serviceTypeId", "appendTo", "body", 3, "options", "ngClass", "panelStyle"], ["id", "partnerType", 1, "col-3", "marginFieldNew", "borderRadius12"], ["formControlName", "partnerType", "appendTo", "body", "placeholder", "Select", 3, "onChange", "options", "ngClass", "panelStyle"], ["id", "partnerId", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "partnerId", "appendTo", "body", 3, "options", "ngClass", "panelStyle"], ["id", "consignmentType", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "serviceTypeId", "appendTo", "body", 3, "options", "panelStyle"], ["id", "loadType", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "loadType", "appendTo", "body", 3, "options", "ngClass", "panelStyle"], ["id", "customerReferenceNumber", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "customerReferenceNumber", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "noOfPieceHawb", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "noOfPieceHawb", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "countryOfOrigin", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "countryOfOrigin", "appendTo", "body", 3, "options", "panelStyle"], ["id", "countryOfDestination", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "countryOfDestination", "appendTo", "body", 3, "options", "panelStyle"], ["id", "invoiceNumber", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "pKeyFilter", "num", "formControlName", "invoiceNumber", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "invoiceAmount", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "pKeyFilter", "num", "formControlName", "invoiceAmount", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "invoiceUrl", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "500", "formControlName", "invoiceUrl", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "incoTerms", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "incoTerms", "appendTo", "body", 3, "options", "ngClass", "panelStyle"], ["id", "paymentType", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "paymentType", "appendTo", "body", 3, "onChange", "options", "ngClass", "panelStyle"], ["class", "col-3 marginFieldNew borderRadius12", "id", "codCollectionMode", 4, "ngIf"], ["class", "col-3 marginFieldNew borderRadius12", "id", "codAmount", 4, "ngIf"], ["class", "col-3 marginFieldNew borderRadius12", "id", "codFavorOf", 4, "ngIf"], [1, "d-flex", "mt-1", "justify-content-end", 2, "position", "absolute", "right", "5%", "bottom", "7%"], ["routerLink", "/main/operation/consignment", 1, "buttom1", "textBlack", "mx-1"], [1, "buttom1", "bgBlack", "text-white", "mx-1", 3, "click"], ["header", "Package Details", 3, "disabled"], [1, "mt-1", 3, "formGroup"], ["scrollHeight", "calc(100vh - 24.8rem)", 1, "paddingZero", 3, "scrollable", "value"], ["pTemplate", "header"], ["pTemplate", "body"], [1, "d-flex", "mt-1", "justify-content-center", 2, "position", "absolute", "right", "50%", "bottom", "7%"], ["type", "button", 1, "btn", "ml-2", "addNewbuttom", "bgOrange", "text-white", 3, "click"], [1, "bi", "bi-plus-square", "pr-2"], [1, "buttom1", "textBlack", "mx-1", 3, "click"], ["header", "Consignment", 3, "disabled"], ["id", "partnerMasterAirwayBill", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "partnerMasterAirwayBill", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "partnerHouseAirwayBill", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "partnerHouseAirwayBill", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "airportOriginCode", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "airportOriginCode", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "flightNo", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "flightNo", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "flightArrivalTime", 1, "col-3", "marginFieldNew", "borderRadius12"], ["formControlName", "flightArrivalTime", "appendTo", "body", "placeholder", "Filter by Date", 1, "w-100", "small-calendar", 3, "ngClass", "iconDisplay", "showIcon"], ["id", "noOfPackages", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "noOfPackages", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "flightName", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "flightName", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "length", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "pKeyFilter", "num", "formControlName", "length", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "change", "ngClass"], ["id", "width", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "pKeyFilter", "num", "formControlName", "width", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "change", "ngClass"], ["id", "height", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "pKeyFilter", "num", "formControlName", "height", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "change", "ngClass"], ["id", "dimensionUnit", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "dimensionUnit", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "weight", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "pKeyFilter", "num", "formControlName", "weight", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "weightUnit", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "weightUnit", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "volume", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "volume", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "volumeUnit", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "volumeUnit", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "netWeight", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "netWeight", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "grossWeight", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "grossWeight", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "invoiceDateFE", 1, "col-3", "marginFieldNew", "borderRadius12"], ["formControlName", "invoiceDateFE", "appendTo", "body", "placeholder", "Filter by Date", 1, "w-100", "small-calendar", 3, "ngClass", "iconDisplay", "showIcon"], ["id", "goodsDescription", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "500", "formControlName", "goodsDescription", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "consignmentValue", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "500", "formControlName", "consignmentValue", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "consignmentCurrency", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "consignmentCurrency", "appendTo", "body", 3, "options", "ngClass", "panelStyle"], ["header", "Origin", 3, "disabled"], ["id", "name", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "name", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "companyName", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "companyName", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "addressLine1", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "addressLine1", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "addressLine2", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "addressLine2", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "country", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "country", "appendTo", "body", 3, "options", "ngClass", "panelStyle"], ["id", "state", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "state", "appendTo", "body", 3, "options", "ngClass", "panelStyle"], ["id", "district", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "district", "appendTo", "body", 3, "options", "ngClass", "panelStyle"], ["id", "city", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "city", "appendTo", "body", 3, "options", "ngClass", "panelStyle"], ["id", "pinCode", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "pinCode", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "latitude", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "latitude", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "longitude", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "longitude", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "phone", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "phone", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "alternatePhone", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "alternatePhone", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "email", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "email", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "addressHubCode", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "addressHubCode", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "accountId", "formGroupName", "originDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "accountId", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["header", "Destination", 3, "disabled"], ["id", "name", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "addressLine1", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "addressLine2", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "country", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "state", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "district", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "city", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "pinCode", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "latitude", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "longitude", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "phone", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "alternatePhone", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "email", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "companyName", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "addressHubCode", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["id", "accountId", "formGroupName", "destinationDetails", 1, "col-3", "marginFieldNew", "borderRadius12"], ["header", "Billing", 3, "disabled"], [1, "row"], ["maxlength", "500", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "value", "disabled"], ["id", "exchangeRate", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "exchangeRate", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "iataCharge", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "iataCharge", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "customsInsurance", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "customsInsurance", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "dutyPercentage", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "dutyPercentage", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "consignmentValueLocal", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "consignmentValueLocal", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "consignmentValuwithIATA", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "consignmentValuwithIATA", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "consignmentInsurance", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "consignmentInsurance", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "customsValue", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "customsValue", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "calculatedTotalDuty", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "calculatedTotalDuty", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "dduCharge", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "dduCharge", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "specialApprovalCharge", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "specialApprovalCharge", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "actualDuty", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "actualDuty", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], [1, "text-danger"], ["id", "codCollectionMode", 1, "col-3", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "codCollectionMode", "appendTo", "body", 3, "options", "ngClass", "panelStyle"], ["id", "codAmount", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "codAmount", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "codFavorOf", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "50", "formControlName", "codFavorOf", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], [2, "min-width", "9rem", "justify-content", "center"], ["placeholder", "Enter", "formControlName", "packReferenceNumber", 1, "inputborderLess", "pl-3"], ["placeholder", "Enter", "formControlName", "pieceProductCode", 1, "inputborderLess", "pl-3"], ["placeholder", "Enter", "formControlName", "tags", 1, "inputborderLess", "pl-3"], ["placeholder", "Enter", "formControlName", "pieceValue", 1, "inputborderLess", "pl-3"], ["placeholder", "Select", "filter", "true", "formControlName", "pieceCurrency", "appendTo", "body", 3, "options", "panelStyle"], [2, "padding-left", "1.5rem !important"], ["type", "button", "src", "./assets/common/actions.png", "alt", "", "srcset", "", 2, "height", "1.4rem", 3, "click"], [1, "d-flex", "flex-column"], ["mat-menu-item", "", 1, "w-100", 2, "width", "8rem", 3, "click"], ["src", "./assets/common/dimension.png", "srcset", "", 2, "padding-right", "10px", "width", "2rem"], ["src", "./assets/common/add.png", "srcset", "", 2, "padding-right", "10px", "width", "2rem"], ["src", "./assets/common/delete1x.png", "srcset", "", 2, "padding-right", "10px", "width", "2rem"], ["src", "./assets/common/image.png", "srcset", "", 2, "padding-right", "10px", "width", "2rem"]], template: function ConsignmentNewComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(97, "Next");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(98, "p-tabPanel", 50)(99, "form", 51)(100, "p-table", 52);
    \u0275\u0275template(101, ConsignmentNewComponent_ng_template_101_Template, 13, 0, "ng-template", 53)(102, ConsignmentNewComponent_ng_template_102_Template, 28, 10, "ng-template", 54);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(103, "div", 55)(104, "button", 56);
    \u0275\u0275listener("click", function ConsignmentNewComponent_Template_button_click_104_listener() {
      return ctx.addPieceDetail();
    });
    \u0275\u0275element(105, "i", 57);
    \u0275\u0275text(106, " Add New");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(107, "div", 47)(108, "button", 48);
    \u0275\u0275text(109, "Cancel");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(111, "Back");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(112, "button", 49);
    \u0275\u0275listener("click", function ConsignmentNewComponent_Template_button_click_112_listener() {
      return ctx.savePiece();
    });
    \u0275\u0275text(113, "Next");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(114, "p-tabPanel", 59)(115, "form", 7)(116, "div", 8)(117, "div", 60)(118, "p", 10);
    \u0275\u0275text(119, "Partner MAWB");
    \u0275\u0275elementEnd();
    \u0275\u0275element(120, "input", 61);
    \u0275\u0275template(121, ConsignmentNewComponent_mat_error_121_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(122, "div", 62)(123, "p", 10);
    \u0275\u0275text(124, "Partner HAWB");
    \u0275\u0275elementEnd();
    \u0275\u0275element(125, "input", 63);
    \u0275\u0275template(126, ConsignmentNewComponent_mat_error_126_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(127, "div", 64)(128, "p", 10);
    \u0275\u0275text(129, "Airport Origin Code");
    \u0275\u0275elementEnd();
    \u0275\u0275element(130, "input", 65);
    \u0275\u0275template(131, ConsignmentNewComponent_mat_error_131_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(132, "div", 66)(133, "p", 10);
    \u0275\u0275text(134, "Flight No");
    \u0275\u0275elementEnd();
    \u0275\u0275element(135, "input", 67);
    \u0275\u0275template(136, ConsignmentNewComponent_mat_error_136_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(137, "div", 68)(138, "p", 10);
    \u0275\u0275text(139, "Flight ETA");
    \u0275\u0275elementEnd();
    \u0275\u0275element(140, "p-calendar", 69);
    \u0275\u0275template(141, ConsignmentNewComponent_mat_error_141_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(142, "div", 70)(143, "p", 10);
    \u0275\u0275text(144, "No of Packages");
    \u0275\u0275elementEnd();
    \u0275\u0275element(145, "input", 71);
    \u0275\u0275template(146, ConsignmentNewComponent_mat_error_146_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(147, "div", 72)(148, "p", 10);
    \u0275\u0275text(149, "Flight Name");
    \u0275\u0275elementEnd();
    \u0275\u0275element(150, "input", 73);
    \u0275\u0275template(151, ConsignmentNewComponent_mat_error_151_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(152, "div", 74)(153, "p", 10);
    \u0275\u0275text(154, "Length");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(155, "input", 75);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(156, ConsignmentNewComponent_mat_error_156_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(157, "div", 76)(158, "p", 10);
    \u0275\u0275text(159, "Width");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(160, "input", 77);
    \u0275\u0275listener("change", function ConsignmentNewComponent_Template_input_change_160_listener() {
      return ctx.calculateVolume(ctx.consignment);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(161, ConsignmentNewComponent_mat_error_161_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(162, "div", 78)(163, "p", 10);
    \u0275\u0275text(164, "Height");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(165, "input", 79);
    \u0275\u0275listener("change", function ConsignmentNewComponent_Template_input_change_165_listener() {
      return ctx.calculateVolume(ctx.consignment);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(166, ConsignmentNewComponent_mat_error_166_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(167, "div", 80)(168, "p", 10);
    \u0275\u0275text(169, "Dimension Unit");
    \u0275\u0275elementEnd();
    \u0275\u0275element(170, "input", 81);
    \u0275\u0275template(171, ConsignmentNewComponent_mat_error_171_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(172, "div", 82)(173, "p", 10);
    \u0275\u0275text(174, "Weight");
    \u0275\u0275elementEnd();
    \u0275\u0275element(175, "input", 83);
    \u0275\u0275template(176, ConsignmentNewComponent_mat_error_176_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(177, "div", 84)(178, "p", 10);
    \u0275\u0275text(179, "Weight Unit");
    \u0275\u0275elementEnd();
    \u0275\u0275element(180, "input", 85);
    \u0275\u0275template(181, ConsignmentNewComponent_mat_error_181_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(182, "div", 86)(183, "p", 10);
    \u0275\u0275text(184, "Volume");
    \u0275\u0275elementEnd();
    \u0275\u0275element(185, "input", 87);
    \u0275\u0275template(186, ConsignmentNewComponent_mat_error_186_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(187, "div", 88)(188, "p", 10);
    \u0275\u0275text(189, "Volume Unit");
    \u0275\u0275elementEnd();
    \u0275\u0275element(190, "input", 89);
    \u0275\u0275template(191, ConsignmentNewComponent_mat_error_191_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(192, "div", 90)(193, "p", 10);
    \u0275\u0275text(194, "Net Weight");
    \u0275\u0275elementEnd();
    \u0275\u0275element(195, "input", 91);
    \u0275\u0275template(196, ConsignmentNewComponent_mat_error_196_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(197, "div", 92)(198, "p", 10);
    \u0275\u0275text(199, "Gross Weight");
    \u0275\u0275elementEnd();
    \u0275\u0275element(200, "input", 93);
    \u0275\u0275template(201, ConsignmentNewComponent_mat_error_201_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(202, "div", 94)(203, "p", 10);
    \u0275\u0275text(204, "Invoice Date");
    \u0275\u0275elementEnd();
    \u0275\u0275element(205, "p-calendar", 95);
    \u0275\u0275template(206, ConsignmentNewComponent_mat_error_206_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(207, "div", 96)(208, "p", 10);
    \u0275\u0275text(209, "Goods Description");
    \u0275\u0275elementEnd();
    \u0275\u0275element(210, "input", 97);
    \u0275\u0275template(211, ConsignmentNewComponent_mat_error_211_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(212, "div", 98)(213, "p", 10);
    \u0275\u0275text(214, "Consignment Value");
    \u0275\u0275elementEnd();
    \u0275\u0275element(215, "input", 99);
    \u0275\u0275template(216, ConsignmentNewComponent_mat_error_216_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(217, "div", 100)(218, "p", 10);
    \u0275\u0275text(219, "Consignment Currency");
    \u0275\u0275elementEnd();
    \u0275\u0275element(220, "p-dropdown", 101);
    \u0275\u0275template(221, ConsignmentNewComponent_mat_error_221_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(222, "div", 47)(223, "button", 48);
    \u0275\u0275text(224, "Cancel");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(225, "button", 58);
    ...
    \u0275\u0275text(408, "Next");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(409, "p-tabPanel", 152)(410, "form", 7)(411, "div", 153)(412, "form", 7)(413, "div", 9)(414, "p", 10);
    \u0275\u0275text(415, "Consignment Currency");
    \u0275\u0275elementEnd();
    \u0275\u0275element(416, "input", 154);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(417, "div", 9)(418, "p", 10);
    \u0275\u0275text(419, "Consignment Value");
    \u0275\u0275elementEnd();
    \u0275\u0275element(420, "input", 154);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(421, "div", 155)(422, "p", 10);
    \u0275\u0275text(423, "Exchange Rate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(424, "input", 156);
    \u0275\u0275template(425, ConsignmentNewComponent_mat_error_425_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(426, "div", 157)(427, "p", 10);
    \u0275\u0275text(428, "IATA");
    \u0275\u0275elementEnd();
    \u0275\u0275element(429, "input", 158);
    \u0275\u0275template(430, ConsignmentNewComponent_mat_error_430_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(431, "div", 159)(432, "p", 10);
    \u0275\u0275text(433, "Customs Insurance");
    \u0275\u0275elementEnd();
    \u0275\u0275element(434, "input", 160);
    \u0275\u0275template(435, ConsignmentNewComponent_mat_error_435_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(436, "div", 161)(437, "p", 10);
    \u0275\u0275text(438, "Duty Percentage");
    \u0275\u0275elementEnd();
    \u0275\u0275element(439, "input", 162);
    \u0275\u0275template(440, ConsignmentNewComponent_mat_error_440_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(441, "div", 163)(442, "p", 10);
    \u0275\u0275text(443, "Consignment Value Local");
    \u0275\u0275elementEnd();
    \u0275\u0275element(444, "input", 164);
    \u0275\u0275template(445, ConsignmentNewComponent_mat_error_445_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(446, "div", 165)(447, "p", 10);
    \u0275\u0275text(448, "Consignment Value with IATA");
    \u0275\u0275elementEnd();
    \u0275\u0275element(449, "input", 166);
    \u0275\u0275template(450, ConsignmentNewComponent_mat_error_450_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(451, "div", 167)(452, "p", 10);
    \u0275\u0275text(453, "Consignment Insurance");
    \u0275\u0275elementEnd();
    \u0275\u0275element(454, "input", 168);
    \u0275\u0275template(455, ConsignmentNewComponent_mat_error_455_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(456, "div", 169)(457, "p", 10);
    \u0275\u0275text(458, "Customs Value");
    \u0275\u0275elementEnd();
    \u0275\u0275element(459, "input", 170);
    \u0275\u0275template(460, ConsignmentNewComponent_mat_error_460_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(461, "div", 171)(462, "p", 10);
    \u0275\u0275text(463, "Calculated Total Duty");
    \u0275\u0275elementEnd();
    \u0275\u0275element(464, "input", 172);
    \u0275\u0275template(465, ConsignmentNewComponent_mat_error_465_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(466, "div", 173)(467, "p", 10);
    \u0275\u0275text(468, "DDU Charge");
    \u0275\u0275elementEnd();
    \u0275\u0275element(469, "input", 174);
    \u0275\u0275template(470, ConsignmentNewComponent_mat_error_470_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(471, "div", 175)(472, "p", 10);
    \u0275\u0275text(473, "Special Approval Charge");
    \u0275\u0275elementEnd();
    \u0275\u0275element(474, "input", 176);
    \u0275\u0275template(475, ConsignmentNewComponent_mat_error_475_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(476, "div", 177)(477, "p", 10);
    \u0275\u0275text(478, "Actual Duty");
    \u0275\u0275elementEnd();
    \u0275\u0275element(479, "input", 178);
    \u0275\u0275template(480, ConsignmentNewComponent_mat_error_480_Template, 3, 1, "mat-error", 12);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(481, "div", 47)(482, "button", 58);
    \u0275\u0275listener("click", function ConsignmentNewComponent_Template_button_click_482_listener() {
      return ctx.activeIndex = ctx.activeIndex - 1;
    });
    \u0275\u0275text(483, "Back");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(484, "button", 49);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("options", ctx.companyIdList)("panelStyle", \u0275\u0275pureFunction0(266, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingShipment("companyId"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(267, _c04));
    \u0275\u0275property("options", ctx.productIdList)("ngClass", ((tmp_9_0 = ctx.shipmentInfo.get("productId")) == null ? null : tmp_9_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(268, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingShipment("productId"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(269, _c04));
    \u0275\u0275property("options", ctx.serviceTypeIdList)("ngClass", ((tmp_14_0 = ctx.shipmentInfo.get("serviceTypeId")) == null ? null : tmp_14_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(270, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingShipment("serviceTypeId"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(271, _c04));
    \u0275\u0275property("options", ctx.partnerType)("ngClass", ((tmp_19_0 = ctx.shipmentInfo.get("partnerType")) == null ? null : tmp_19_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(272, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingShipment("partnerType"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(273, _c04));
    \u0275\u0275property("options", ctx.partnerNameList)("ngClass", ((tmp_24_0 = ctx.shipmentInfo.get("partnerId")) == null ? null : tmp_24_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(274, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingShipment("partnerId"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(275, _c04));
    \u0275\u0275property("options", ctx.consignmentTypeIdList)("panelStyle", \u0275\u0275pureFunction0(276, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingShipment("consignmentType"));
    \u0275\u0275advance(5);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(277, _c04));
    \u0275\u0275property("options", ctx.loadTypeIdList)("ngClass", ((tmp_33_0 = ctx.shipmentInfo.get("loadType")) == null ? null : tmp_33_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(278, _c04));
    \u0275\u0275advance();
    ...
    \u0275\u0275property("options", ctx.countryIdListOrigin)("panelStyle", \u0275\u0275pureFunction0(280, _c04));
    \u0275\u0275advance();
    ...
    \u0275\u0275property("options", ctx.incoTerms)("ngClass", ((tmp_56_0 = ctx.shipmentInfo.get("incoTerms")) == null ? null : tmp_56_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(284, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingShipment("incoTerms"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(285, _c04));
    \u0275\u0275property("options", ctx.paymentType)("ngClass", ((tmp_61_0 = ctx.shipmentInfo.get("paymentType")) == null ? null : tmp_61_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(286, _c04));
    \u0275\u0275advance();
    ...
    \u0275\u0275property("options", ctx.currencyDropdown)("ngClass", ((tmp_119_0 = ctx.consignment.get("consignmentCurrency")) == null ? null : tmp_119_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(288, _c04));
    \u0275\u0275advance();
    ...
    \u0275\u0275property("options", ctx.countryIdListOrigin)("ngClass", ((tmp_134_0 = ctx.senderInfo.get("originDetails.country")) == null ? null : tmp_134_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(290, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingSender("originDetails.country"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(291, _c04));
    \u0275\u0275property("options", ctx.provinceIdList)("ngClass", ((tmp_139_0 = ctx.senderInfo.get("originDetails.state")) == null ? null : tmp_139_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(292, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingSender("originDetails.state"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(293, _c04));
    \u0275\u0275property("options", ctx.districtIdList)("ngClass", ((tmp_144_0 = ctx.senderInfo.get("originDetails.district")) == null ? null : tmp_144_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(294, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingSender("originDetails.district"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(295, _c04));
    \u0275\u0275property("options", ctx.cityIdList)("ngClass", ((tmp_149_0 = ctx.senderInfo.get("originDetails.city")) == null ? null : tmp_149_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(296, _c04));
    \u0275\u0275advance();
    ...
    \u0275\u0275property("options", ctx.countryIdListDestination)("ngClass", ((tmp_178_0 = ctx.deliveryInfo.get("destinationDetails.country")) == null ? null : tmp_178_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(298, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingDelivery("destinationDetails.country"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(299, _c04));
    \u0275\u0275property("options", ctx.provinceIdList)("ngClass", ((tmp_183_0 = ctx.deliveryInfo.get("destinationDetails.state")) == null ? null : tmp_183_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(300, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingDelivery("destinationDetails.state"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(301, _c04));
    \u0275\u0275property("options", ctx.districtIdList)("ngClass", ((tmp_188_0 = ctx.deliveryInfo.get("destinationDetails.district")) == null ? null : tmp_188_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(302, _c04));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingDelivery("destinationDetails.district"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(303, _c04));
    \u0275\u0275property("options", ctx.cityIdList)("ngClass", ((tmp_193_0 = ctx.deliveryInfo.get("destinationDetails.city")) == null ? null : tmp_193_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(304, _c04));
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_221_0 = ctx.billing.get("exchangeRate")) == null ? null : tmp_221_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingBilling("exchangeRate"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_223_0 = ctx.billing.get("iataCharge")) == null ? null : tmp_223_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_227_0 = ctx.billing.get("dutyPercentage")) == null ? null : tmp_227_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingBilling("dutyPercentage"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_229_0 = ctx.billing.get("consignmentValueLocal")) == null ? null : tmp_229_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingBilling("consignmentValueLocal"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_231_0 = ctx.billing.get("consignmentValuwithIATA")) == null ? null : tmp_231_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingBilling("consignmentValuwithIATA"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_233_0 = ctx.billing.get("consignmentInsurance")) == null ? null : tmp_233_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingBilling("consignmentInsurance"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_235_0 = ctx.billing.get("customsValue")) == null ? null : tmp_235_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingBilling("customsValue"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_237_0 = ctx.billing.get("calculatedTotalDuty")) == null ? null : tmp_237_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingBilling("calculatedTotalDuty"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_239_0 = ctx.billing.get("dduCharge")) == null ? null : tmp_239_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingBilling("dduCharge"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_241_0 = ctx.billing.get("specialApprovalCharge")) == null ? null : tmp_241_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandlingBilling("specialApprovalCharge"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_243_0 = ctx.billing.get("actualDuty")) == null ? null : tmp_243_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
...
//# sourceMappingURL=chunk-DTV32ZJT.js.map
