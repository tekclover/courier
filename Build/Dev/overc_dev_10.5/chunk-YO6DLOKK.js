...
var routes = [{
  ...
  children: [
    { path: "idMaster", loadChildren: () => import("./chunk-YVKRWKRP.js").then((m) => m.IdMastersModule) },
    { path: "master", loadChildren: () => import("./chunk-AXRSRNSE.js").then((m) => m.MasterModule) },
    { path: "airport", loadChildren: () => import("./chunk-6RKF5NP5.js").then((m) => m.AirportModule) },
    { path: "operation", loadChildren: () => import("./chunk-W5KHR4CA.js").then((m) => m.OperationModule) },
    { path: "reports", loadChildren: () => import("./chunk-UKQNRIAU.js").then((m) => m.ReportsModule) }
  ]
}];
...
//# sourceMappingURL=chunk-YO6DLOKK.js.map
