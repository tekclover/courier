import {
  require_JsBarcode
} from "./chunk-JFBDLV3E.js";
import "./chunk-MBBZ74EH.js";
import {
  AuthService,
  BehaviorSubject,
...
var routes = [
  { path: "", loadChildren: () => import("./chunk-RIFGQZ7W.js").then((m) => m.LoginModule) },
  { path: "main", loadChildren: () => import("./chunk-C5ALG2AA.js").then((m) => m.MainModule) }
];
...
_AppComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], decls: 5, vars: 1, consts: [["position", "bottom-center", "key", "br", 3, "life"], ["bdColor", "rgba(51,51,51,0.8)", "size", "medium", "color", "#fff", "type", "line-spin-clockwise-fade"], [2, "font-size", "20px", "color", "white"]], template: function AppComponent_Template(rf, ctx) {
  if (rf & 1) {
