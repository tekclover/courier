...
var routes = [{
  ...
  children: [
    { path: "idMaster", loadChildren: () => import("./chunk-BO4CWAAQ.js").then((m) => m.IdMastersModule) },
    { path: "master", loadChildren: () => import("./chunk-4IAZCD5B.js").then((m) => m.MasterModule) },
    { path: "airport", loadChildren: () => import("./chunk-DQ4EQVR6.js").then((m) => m.AirportModule) },
    { path: "operation", loadChildren: () => import("./chunk-27LXQZXJ.js").then((m) => m.OperationModule) }
  ]
}];
...
//# sourceMappingURL=chunk-VAXRKCPO.js.map
