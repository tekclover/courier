...
var routes = [{
  ...
  children: [
    { path: "idMaster", loadChildren: () => import("./chunk-VAVPS3CV.js").then((m) => m.IdMastersModule) },
    { path: "master", loadChildren: () => import("./chunk-B5TTWUUV.js").then((m) => m.MasterModule) },
    { path: "airport", loadChildren: () => import("./chunk-YKKZW2CT.js").then((m) => m.AirportModule) },
    { path: "operation", loadChildren: () => import("./chunk-3FS54HVZ.js").then((m) => m.OperationModule) },
    { path: "reports", loadChildren: () => import("./chunk-3RMTJX7H.js").then((m) => m.ReportsModule) }
  ]
}];
...
//# sourceMappingURL=chunk-OD7LDTAF.js.map
