...
function ConsignmentStatusPopupComponent_tr_23_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(15, 7, item_r1.pieceEventTimestamp, "dd-MM-yyyy HH:mm"));
  }
}
...
_ConsignmentStatusPopupComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConsignmentStatusPopupComponent, selectors: [["app-consignment-status-popup"]], decls: 27, vars: 1, consts: [[1, "bgWhite", "text-black", "w-93", "h-100", "m-4", "mt-4"], [1, "d-flex", "justify-content-between", "align-items-center"], [1, "componentHeader", "f600", "mb-0"], [1, "d-flex", "scrollNew", "table-responsive", "mt-4"], [1, "table", 2, "width", "150rem"], [1, "sticky-top", "table-style"], ["scope", "col"], [1, "table-style-body"], [4, "ngFor", "ngForOf"], [1, "d-flex", "float-right", "py-2", 2, "position", "absolute", "right", "3.5%", "bottom", "5%"], ["mat-dialog-close", "", 1, "buttom1", "textBlack", "mx-1"], ["scope", "row", 2, "font-weight", "normal"]], template: function ConsignmentStatusPopupComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(13, "Piece Status ID");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "th", 6);
    \u0275\u0275text(15, "Piece Status");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "th", 6);
    \u0275\u0275text(17, "Piece Event Code");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "th", 6);
    \u0275\u0275text(19, "Piece Event Text");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "th", 6);
    \u0275\u0275text(21, "Piece Event Time");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(22, "tbody", 7);
    \u0275\u0275template(23, ConsignmentStatusPopupComponent_tr_23_Template, 16, 10, "tr", 8);
    \u0275\u0275elementEnd()()();
...
function ConsignmentNewComponent_p_tabPanel_411_ng_template_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ConsignmentNewComponent_p_tabPanel_411_ng_template_4_Template_img_click_5_listener() {
      ...
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.editItem("Popup", rowData_r15));
    });
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
//# sourceMappingURL=chunk-2YKB4Q4C.js.map
