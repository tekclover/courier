...
_ConsoleEditpopupComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConsoleEditpopupComponent, selectors: [["app-console-editpopup"]], decls: 73, vars: 27, consts: [[1, "bgWhite", "text-black", "w-93", "h-100", "m-4", "mt-4"], [1, "d-flex", "justify-content-between", "align-items-center"], [1, "componentHeader", "f600", "mb-0"], [1, "mt-4"], [3, "formGroup"], [1, "d-flex-row"], [1, "row", "scrollNew"], [1, "col-6", "marginFieldNew", "borderRadius12"], [1, "formControlLabel", "f600", "textBlack", "mb-0"], ["maxlength", "50", "formControlName", "houseAirwayBill", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "masterAirwayBill", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "partnerHouseAirwayBill", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "partnerMasterAirwayBill", "pInputText", "", "placeholder", "Enter", 1, "w-100"], [1, "formControlLabel", "f600", "textBlack", "mb-0", "required"], ["formControlName", "airportOriginCode", "appendTo", "body", "placeholder", "Select", 3, "options", "panelStyle"], ["maxlength", "50", "pInputText", "", "formControlName", "goodsDescription", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "grossWeight", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "noOfPieceHawb", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["formControlName", "countryOfOrigin", "appendTo", "body", "placeholder", "Select", 3, "options", "disabled", "panelStyle"], ["maxlength", "50", "pInputText", "", "formControlName", "hsCode", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "consigneeName", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "consignmentValue", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["placeholder", "Select", "filter", "true", "formControlName", "consignmentCurrency", "appendTo", "body", 3, "options", "panelStyle"], ["maxlength", "50", "pInputText", "", "formControlName", "customsKd", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["placeholder", "Select", "filter", "true", "formControlName", "iataKd", "appendTo", "body", 3, "options", "panelStyle"], [1, "d-flex", "float-right", "py-2"], ["mat-dialog-close", "", 1, "buttom1", "textBlack", "mx-1"], ["type", "button", 1, "buttom1", "bgBlack", "text-white", "mx-1", 3, "click"]], template: function ConsoleEditpopupComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(66, "IATA");
    \u0275\u0275elementEnd();
    \u0275\u0275element(67, "p-dropdown", 24);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(68, "div", 25)(69, "button", 26);
    \u0275\u0275text(70, "Cancel");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(71, "button", 27);
    \u0275\u0275listener("click", function ConsoleEditpopupComponent_Template_button_click_71_listener() {
      return ctx.save();
    });
    \u0275\u0275text(72, "Save");
    \u0275\u0275elementEnd()()()()()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("options", ctx.countryIdList)("panelStyle", \u0275\u0275pureFunction0(20, _c010));
    \u0275\u0275advance(16);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(21, _c010));
    \u0275\u0275property("options", ctx.countryIdList)("disabled", true)("panelStyle", \u0275\u0275pureFunction0(22, _c010));
    \u0275\u0275advance(16);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(23, _c010));
    \u0275\u0275property("options", ctx.currencyIdList)("panelStyle", \u0275\u0275pureFunction0(24, _c010));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_11_0 = ctx.form.get("customsKd")) == null ? null : tmp_11_0.invalid) && ((tmp_11_0 = ctx.form.get("customsKd")) == null ? null : tmp_11_0.dirty) ? "invalid" : "");
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(25, _c010));
    \u0275\u0275property("options", ctx.iataList)("panelStyle", \u0275\u0275pureFunction0(26, _c010));
  }
...
function ConsoleEditComponent_ng_template_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(51, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(52, "td")(53, "div", 27)(54, "img", 28);
    \u0275\u0275listener("click", function ConsoleEditComponent_ng_template_29_Template_img_click_54_listener() {
      const item_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.editItem("Edit", item_r3));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(55, "img", 29);
    \u0275\u0275listener("click", function ConsoleEditComponent_ng_template_29_Template_img_click_55_listener() {
      const item_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r0 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind2(51, 17, item_r3.createdOn, "dd-MM-yyyy HH:mm"), " ");
  }
}
...
_ConsoleEditComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConsoleEditComponent, selectors: [["app-console-edit"]], decls: 36, vars: 25, consts: [[1, "componentBody"], [1, "d-flex", "justify-content-between", "align-items-center"], [1, "componentHeader", "f600", "mb-0"], [1, "mx-auto", "mt-4"], [3, "formGroup"], [1, "d-flex-row"], [1, "row", "scrollNew"], [1, "col-4", "marginFieldNew", "borderRadius12"], [1, "formControlLabel", "f600", "textBlack", "mb-0"], ["formControlName", "languageId", "appendTo", "body", 3, "options", "disabled", "panelStyle"], ["class", "text-danger", 4, "ngIf"], ["formControlName", "companyId", "appendTo", "body", 3, "options", "disabled", "panelStyle"], ["maxlength", "50", "pInputText", "", "pKeyFilter", "alphanum", "formControlName", "consoleId", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "pKeyFilter", "alphanum", "formControlName", "statusId", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["scrollHeight", "calc(100vh - 27.8rem)", "selectionMode", "multiple", 3, "selectionChange", "scrollable", "tableStyle", "value", "selection"], ["pTemplate", "header"], ["pTemplate", "body"], [1, "d-flex", "mt-1", "justify-content-end", 2, "position", "absolute", "right", "5%", "bottom", "7%"], ["routerLink", "/main/airport/console", 1, "buttom1", "textBlack", "mx-1"], [1, "buttom1", "bgBlack", "text-white", "mx-1", 3, "click"], ["class", "buttom1 bgBlack text-white mx-1", 3, "click", 4, "ngIf"], [1, "text-danger"], [2, "width", "5rem"], [1, "pl-3"], [2, "text-align", "center"], [3, "value"], [1, "w-100", "pl-2", "ml-2"], [1, "d-flex", "img-icon", "px-3"], ["type", "button", "src", "./assets/common/edit.png", "alt", "", "width", "24px", "height", "24px", 3, "click"], ["type", "button", "src", "./assets/common/deletetool.png", "alt", "", "srcset", "", "width", "24px", "height", "24px", 3, "click"]], template: function ConsoleEditComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(28, ConsoleEditComponent_ng_template_28_Template, 37, 0, "ng-template", 15)(29, ConsoleEditComponent_ng_template_29_Template, 56, 20, "ng-template", 16);
    \u0275\u0275elementEnd()()();
...
//# sourceMappingURL=chunk-6F27FO2V.js.map
