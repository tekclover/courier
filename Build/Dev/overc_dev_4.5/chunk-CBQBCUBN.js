import {
  ...
  ProvinceService,
  SubProductService
} from "./chunk-NAICB4NT.js";
import {
  IataService
} from "./chunk-U4FXXVB4.js";
import {
  NumberrangeService
} from "./chunk-4MTMX26S.js";
import {
  ProductService
} from "./chunk-74AKBBQ5.js";
import {
  ConsignorService,
  CustomerService
} from "./chunk-WKHJM6WC.js";
import {
  CommonAPIService
} from "./chunk-JTYOLVB3.js";
import {
  CustomTableComponent,
  DeleteComponent
} from "./chunk-TP2P22CH.js";
import {
  PathNameService
} from "./chunk-L2MDYXGD.js";
import {
  ActivatedRoute,
  AuthService,
  Checkbox,
...
function CustomerNewComponent_ng_template_41_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "th");
    \u0275\u0275text(4, "Product Name");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "th");
    \u0275\u0275text(6, "Sub Product");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "th");
    \u0275\u0275text(8, "Sub Product Name");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "th");
    \u0275\u0275text(10, "Sub Product Value");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "th");
    \u0275\u0275text(12, "Sub Product Value Description");
    \u0275\u0275elementEnd();
...
function CustomerNewComponent_ng_template_42_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(18);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "td")(20, "div", 28)(21, "img", 29);
    \u0275\u0275listener("click", function CustomerNewComponent_ng_template_42_Template_img_click_21_listener() {
      const i_r3 = \u0275\u0275restoreView(_r2).rowIndex;
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.editItem("Edit", i_r3));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "img", 30);
    \u0275\u0275listener("click", function CustomerNewComponent_ng_template_42_Template_img_click_22_listener() {
      const i_r3 = \u0275\u0275restoreView(_r2).rowIndex;
      const ctx_r0 = \u0275\u0275nextContext();
...
_CustomerNewComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CustomerNewComponent, selectors: [["app-customer-new"]], decls: 48, vars: 27, consts: [[1, "componentBody"], [1, "d-flex", "justify-content-between", "align-items-center"], [1, "componentHeader", "f600", "mb-0"], [1, "mx-auto", "mt-4"], [3, "formGroup"], [1, "d-flex-row"], [1, "row"], [1, "col-4", "marginFieldNew", "borderRadius12"], [1, "formControlLabel", "f600", "textBlack", "mb-0"], ["formControlName", "languageId", "appendTo", "body", 3, "options", "disabled", "panelStyle"], ["class", "text-danger", 4, "ngIf"], ["formControlName", "companyId", "appendTo", "body", 3, "options", "disabled", "panelStyle"], ["maxlength", "50", "pInputText", "", "pKeyFilter", "alphanum", "formControlName", "customerId", "pInputText", "", "placeholder", "Enter", 1, "w-100"], [1, "formControlLabel", "f600", "textBlack", "mb-0", "required"], ["maxlength", "100", "pInputText", "", "formControlName", "customerName", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["appendTo", "body", "formControlName", "statusId", "placeholder", "Select ", 3, "options"], ["maxlength", "2000", "formControlName", "remark", "pInputText", "", "placeholder", "Enter", 1, "w-100"], [1, "d-flex", "justify-content-end", "mb-3"], ["type", "button", 1, "btn", "ml-2", "addNewbuttom", "bgBlack", "text-white", 3, "click"], [1, "bi", "bi-plus-square", "pr-2"], ["scrollHeight", "calc(100vh - 31.8rem)", 3, "scrollable", "value"], ["pTemplate", "header"], ["pTemplate", "body"], [1, "d-flex", "mt-1", "justify-content-end", 2, "position", "absolute", "right", "5%", "bottom", "7%"], ["routerLink", "/main/master/customer", 1, "buttom1", "textBlack", "mx-1"], [1, "buttom1", "bgBlack", "text-white", "mx-1", 3, "click"], [1, "text-danger"], [1, "w-100", "pl-2", "ml-2"], [1, "d-flex", "img-icon", "px-3"], ["type", "button", "src", "./assets/common/edit.png", "alt", "", "width", "24px", "height", "24px", 3, "click"], ["type", "button", "src", "./assets/common/deletetool.png", "alt", "", "srcset", "", "width", "24px", "height", "24px", 3, "click"]], template: function CustomerNewComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(41, CustomerNewComponent_ng_template_41_Template, 15, 0, "ng-template", 21)(42, CustomerNewComponent_ng_template_42_Template, 23, 6, "ng-template", 22);
    \u0275\u0275elementEnd()()();
...
//# sourceMappingURL=chunk-CBQBCUBN.js.map
