...
var routes = [
  { path: "", loadChildren: () => import("./chunk-ADPFGADM.js").then((m) => m.LoginModule) },
  { path: "main", loadChildren: () => import("./chunk-EUFMXEG3.js").then((m) => m.MainModule) }
];
