...
var routes = [{
  ...
  children: [
    { path: "idMaster", loadChildren: () => import("./chunk-7VTBQDI5.js").then((m) => m.IdMastersModule) },
    { path: "master", loadChildren: () => import("./chunk-O6P3ZB2H.js").then((m) => m.MasterModule) },
    { path: "airport", loadChildren: () => import("./chunk-YP2LYBPM.js").then((m) => m.AirportModule) },
    { path: "operation", loadChildren: () => import("./chunk-G43P3BE6.js").then((m) => m.OperationModule) },
    { path: "reports", loadChildren: () => import("./chunk-H7D7R2DD.js").then((m) => m.ReportsModule) }
  ]
}];
...
//# sourceMappingURL=chunk-5MI2NOHX.js.map
