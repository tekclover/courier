...
function SublevelMenuComponent_ul_0_li_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "div", 4);
    \u0275\u0275template(2, SublevelMenuComponent_ul_0_li_1_a_2_Template, 3, 2, "a", 5)(3, SublevelMenuComponent_ul_0_li_1_a_3_Template, 2, 3, "a", 6)(4, SublevelMenuComponent_ul_0_li_1_div_4_Template, 2, 4, "div", 7);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function SublevelMenuComponent_ul_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, SublevelMenuComponent_ul_0_li_1_Template, 5, 9, "li", 2);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SublevelMenuComponent, { className: "SublevelMenuComponent", filePath: "src\\app\\main\\sublevel-menu.component.ts", lineNumber: 60 });
})();
...
_MainComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MainComponent, selectors: [["app-main"]], outputs: { onToggleSideNav: "onToggleSideNav" }, decls: 41, vars: 16, consts: [["menu", "matMenu"], [1, "bgBlack", 3, "mode", "opened"], [1, "sidenav", "d-flex-column", 3, "ngClass"], [1, "logo-container"], ["src", "./assets/dashboard/Circle Icon.svg", "style", "width: 3.3rem !important; height: 3.3rem !important;", "alt", "", 4, "ngIf"], ["src", "./assets/dashboard/Circle Icon.svg", "style", "width: 3.3rem !important; height: 3.3rem !important; ", "alt", "", 4, "ngIf"], ["id", "overc-container"], ["id", "overc"], ["src", "./assets/dashboard/Later.svg", "alt", "", 2, "width", "4.3rem !important", "height", "3.3rem !important", "margin-left", "-25px"], ["id", "span360"], ["src", "./assets/dashboard/360.svg", "alt", "", 2, "width", "3.3rem !important", "height", "1rem !important", "margin-top", "-4px"], [1, "hrline"], [1, "toggle-btn"], ["class", "btn", 3, "click", 4, "ngIf"], [1, "Menu", 2, "padding", "5px"], [1, "sidenav-nav"], ["class", "sidenav-nav-item", 4, "ngFor", "ngForOf"], [1, "bodyBackGround", 2, "margin-left", "120px", 3, "ngStyle"], [1, "d-flex", "justify-content-between"], ["id", "breadcrumbs"], [1, "headerPageName"], ["aria-label", "breadcrumb"], [1, "breadcrumb"], ["class", "breadcrumb-item", 3, "ngClass", 4, "ngFor", "ngForOf"], ["id", "logout"], [1, "d-flex", "justify-content-between", "align-items-center"], ["src", "./assets/dashboard/notifications.png", "alt", "", "srcset", "", 1, "img-fluid", "mr-5"], [1, "d-flex", "flex-column", "mr-2"], [1, "mb-1", "headerPageName", "text-right"], [1, "mb-0", "breadcrumb-item", "text-right"], ["src", "./assets/dashboard/User.png", "alt", "", "srcset", "", 1, "img-fluid", 3, "matMenuTriggerFor"], [1, "componentBackground"], [1, "customClass"], ["matMenuContent", ""], ["src", "./assets/dashboard/Circle Icon.svg", "alt", "", 2, "width", "3.3rem !important", "height", "3.3rem !important"], [1, "btn", 3, "click"], [1, "sidenav-nav-item"], ["class", "sidenav-nav-link", 3, "ngClass", "click", 4, "ngIf"], ["class", "sidenav-nav-link", 3, "routerLink", "ngClass", "click", 4, "ngIf"], [4, "ngIf"], [1, "sidenav-nav-link", 3, "click", "ngClass"], ["alt", "", 1, "sidenav-nav-icon", 3, "src"], ["class", "sidenav-link-text", 4, "ngIf"], ["class", "menu-collapse-icon", "alt", "", 3, "src", 4, "ngIf"], [1, "sidenav-link-text"], ["alt", "", 1, "menu-collapse-icon", 3, "src"], [1, "sidenav-nav-link", 3, "click", "routerLink", "ngClass"], [3, "data", "collapsed", "multiple", "expanded"], [1, "breadcrumb-item", 3, "ngClass"], ["mat-menu-item", "", 3, "click"]], template: function MainComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngStyle", \u0275\u0275pureFunction1(14, _c02, ctx.collapsed ? "300px" : "105px"));
    \u0275\u0275advance(4);
...
var routes = [{
  ...
  children: [
    { path: "idMaster", loadChildren: () => import("./chunk-R25JPHRR.js").then((m) => m.IdMastersModule) },
    { path: "master", loadChildren: () => import("./chunk-7SFOZMES.js").then((m) => m.MasterModule) },
    { path: "airport", loadChildren: () => import("./chunk-XQTFTTCK.js").then((m) => m.AirportModule) },
    { path: "operation", loadChildren: () => import("./chunk-SSO46RTX.js").then((m) => m.OperationModule) }
  ]
}];
...
//# sourceMappingURL=chunk-T2W6KE24.js.map
