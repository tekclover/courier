...
function PreAlertUpdateComponent_ng_template_29_th_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1);
    \u0275\u0275element(2, "p-sortIcon", 31);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const col_r2 = ctx.$implicit;
    \u0275\u0275property("pSortableColumn", col_r2.field);
    \u0275\u0275advance();
...
function PreAlertUpdateComponent_ng_template_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(2, "p-tableHeaderCheckbox", 27);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, PreAlertUpdateComponent_ng_template_29_th_3_Template, 3, 3, "th", 28);
    \u0275\u0275elementStart(4, "th", 29);
    \u0275\u0275text(5, " Actions ");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function PreAlertUpdateComponent_ng_template_30_td_3_ng_template_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(1, 1, rowData_r6.createdOn, "dd-MM-yyyy HH:mm"), " ");
  }
}
function PreAlertUpdateComponent_ng_template_30_td_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td");
    \u0275\u0275template(1, PreAlertUpdateComponent_ng_template_30_td_3_ng_container_1_Template, 2, 1, "ng-container", 40)(2, PreAlertUpdateComponent_ng_template_30_td_3_ng_template_2_Template, 2, 4, "ng-template", null, 2, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const col_r5 = ctx.$implicit;
...
function PreAlertUpdateComponent_ng_template_30_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, PreAlertUpdateComponent_ng_template_30_td_3_Template, 4, 2, "td", 34);
    \u0275\u0275elementStart(4, "td", 35)(5, "img", 36);
    \u0275\u0275listener("click", function PreAlertUpdateComponent_ng_template_30_Template_img_click_5_listener($event) {
      \u0275\u0275restoreView(_r4);
      const op_r8 = \u0275\u0275reference(7);
      return \u0275\u0275resetView(op_r8.toggle($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p-overlayPanel", null, 1)(8, "div", 37)(9, "button", 38);
    \u0275\u0275listener("click", function PreAlertUpdateComponent_ng_template_30_Template_button_click_9_listener() {
      const rowData_r6 = \u0275\u0275restoreView(_r4).$implicit;
      const op_r8 = \u0275\u0275reference(7);
      const ctx_r8 = \u0275\u0275nextContext();
      ctx_r8.editItem("Edit", rowData_r6);
      return \u0275\u0275resetView(op_r8.hide());
    });
    \u0275\u0275element(10, "img", 39);
    \u0275\u0275text(11, "Edit");
    \u0275\u0275elementEnd()()()()();
  ...
  if (rf & 2) {
    ...
    const columns_r10 = ctx.columns;
    const ctx_r8 = \u0275\u0275nextContext();
    \u0275\u0275classProp("selectedRow", ctx_r8.selectedPreAlertManifest[0] === rowData_r6);
    \u0275\u0275advance(2);
...
_PreAlertUpdateComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PreAlertUpdateComponent, selectors: [["app-pre-alert-update"]], decls: 35, vars: 12, consts: [["preAlertEditTag", ""], ["op", ""], ["dateTemplate", ""], [1, "componentBody"], [1, "d-flex", "justify-content-between", "align-items-center"], [1, "componentHeader", "f600", "mb-0"], ["type", "button", "class", "invisible buttom1 bgBlack text-white ml-2", 4, "ngIf"], [1, "mx-auto", "mt-4"], [3, "formGroup"], [1, "d-flex-row"], [1, "row", "scrollNew"], [1, "col-3", "marginFieldNew", "borderRadius12"], [1, "formControlLabel", "f600", "textBlack", "mb-0"], ["maxlength", "50", "pInputText", "", "formControlName", "companyId", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "partnerMasterAirwayBill", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["id", "partnerHouseAirwayBill", 1, "col-3", "marginFieldNew", "borderRadius12"], ["maxlength", "100", "pInputText", "", "formControlName", "partnerHouseAirwayBill", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["maxlength", "50", "pInputText", "", "pKeyFilter", "alphanum", "formControlName", "statusText", "pInputText", "", "placeholder", "Enter", 1, "w-100"], [1, "tableProperties"], ["selectionMode", "multiple", "sortField", "createdOn", "scrollHeight", "calc(100vh - 25rem)", "sortField", "createdOn", "styleClass", "p-datatable-sm", 1, "custom-table", 3, "selectionChange", "columns", "value", "scrollable", "sortOrder", "selection", "tableStyle"], ["pTemplate", "header"], ["pTemplate", "body"], ["pTemplate", "emptymessage"], [1, "d-flex", "mt-1", "justify-content-end", 2, "position", "absolute", "right", "3.5%", "bottom", "7%"], ["routerLink", "/main/airport/console", 1, "buttom1", "textBlack", "mx-1"], ["type", "button", 1, "invisible", "buttom1", "bgBlack", "text-white", "ml-2"], ["pFrozenColumn", "", 2, "width", "5rem"], [1, "pl-3"], [3, "pSortableColumn", 4, "ngFor", "ngForOf"], ["pFrozenColumn", "", "alignFrozen", "right", 2, "width", "5rem"], [3, "pSortableColumn"], [3, "field"], ["pFrozenColumn", "", 2, "width", "5rem", "justify-content", "center"], [1, "pl-3", 3, "value"], [4, "ngFor", "ngForOf"], ["pFrozenColumn", "", "alignFrozen", "right", 2, "padding-left", "1.5rem !important"], ["type", "button", "src", "./assets/common/actions.png", "alt", "", "srcset", "", 2, "height", "1.4rem", 3, "click"], [1, "d-flex", "flex-column"], ["mat-menu-item", "", 1, "w-100", 2, "width", "8rem", 3, "click"], ["src", "./assets/common/edit.png", "srcset", "", 2, "padding-right", "10px", "width", "2rem"], [4, "ngIf", "ngIfElse"], [1, "my-2", "w-100", "pl-3"]], template: function PreAlertUpdateComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 3)(1, "div", 4)(2, "p", 5);
    \u0275\u0275text(3);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "div", 15)(19, "p", 12);
    \u0275\u0275text(20, "Partner HAWB");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(26, "div", 18)(27, "p-table", 19, 0);
    \u0275\u0275twoWayListener("selectionChange", function PreAlertUpdateComponent_Template_p_table_selectionChange_27_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.selectedPreAlertManifest, $event) || (ctx.selectedPreAlertManifest = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275template(29, PreAlertUpdateComponent_ng_template_29_Template, 6, 1, "ng-template", 20)(30, PreAlertUpdateComponent_ng_template_30_Template, 12, 7, "ng-template", 21)(31, PreAlertUpdateComponent_ng_template_31_Template, 4, 1, "ng-template", 22);
    \u0275\u0275elementEnd()()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("formGroup", ctx.form);
    \u0275\u0275advance(14);
    \u0275\u0275property("ngClass", ((tmp_4_0 = ctx.form.get("partnerHouseAirwayBill")) == null ? null : tmp_4_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance(6);
    \u0275\u0275property("columns", ctx.cols)("value", ctx.preAlertManifestTableArray)("scrollable", true)("sortOrder", -1);
    \u0275\u0275twoWayProperty("selection", ctx.selectedPreAlertManifest);
    \u0275\u0275property("sortOrder", -1)("tableStyle", \u0275\u0275pureFunction0(11, _c016));
  }
}, dependencies: [NgClass, NgForOf, NgIf, RouterLink, PrimeTemplate, Table, SortableColumn, FrozenColumn, SortIcon, TableCheckbox, TableHeaderCheckbox, InputText, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, MaxLengthValidator, KeyFilter, OverlayPanel, MatMenuItem, FormGroupDirective, FormControlName, DatePipe], styles: ["\n\n.circle[_ngcontent-%COMP%] {\n  width: 44px;\n  height: 44px;\n  flex-grow: 0;\n  margin: 0 6px 12px;\n  border-radius: 100%;\n  padding: 12px 17px 11px;\n  background-color: var(--white);\n}\n.borderCircle[_ngcontent-%COMP%] {\n  border: solid 1.5px var(--black);\n}\n.marginFieldNew[_ngcontent-%COMP%] {\n  margin-bottom: 2.5rem;\n}\n.scrollNew[_ngcontent-%COMP%] {\n  height: calc(100vh - 40rem);\n  overflow-y: scroll;\n}\n/*# sourceMappingURL=pre-alert-update.component.css.map */"] });
var PreAlertUpdateComponent = _PreAlertUpdateComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PreAlertUpdateComponent, { className: "PreAlertUpdateComponent", filePath: "src\\app\\main\\airport\\pre-alert-manifest\\pre-alert-update\\pre-alert-update.component.ts", lineNumber: 21 });
})();
...
//# sourceMappingURL=chunk-PQ6LODWS.js.map
