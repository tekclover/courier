import {
  require_JsBarcode
} from "./chunk-RK3O7MLG.js";
import "./chunk-TD57RCS5.js";
import {
  AuthService,
  BehaviorSubject,
...
var routes = [
  { path: "", loadChildren: () => import("./chunk-N7KZ2MVW.js").then((m) => m.LoginModule) },
  { path: "main", loadChildren: () => import("./chunk-BPFG62RP.js").then((m) => m.MainModule) }
];
...
_AppComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], decls: 5, vars: 0, consts: [["position", "bottom-center", "key", "br"], ["bdColor", "rgba(51,51,51,0.8)", "size", "medium", "color", "#fff", "type", "ball-beat"], [2, "font-size", "20px", "color", "white"]], template: function AppComponent_Template(rf, ctx) {
  if (rf & 1) {
...
var environment = {
  production: false,
  title: "OVERC360",
  apiURL: "https://overc360.com:9296/d-overc",
