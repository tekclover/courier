...
var routes = [
  { path: "", loadChildren: () => import("./chunk-FLFCSYQK.js").then((m) => m.LoginModule) },
  { path: "main", loadChildren: () => import("./chunk-PMUBPII7.js").then((m) => m.MainModule) }
];
...
_AppComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], decls: 5, vars: 0, consts: [["position", "bottom-right", "key", "br"], ["bdColor", "rgba(51,51,51,0.8)", "size", "medium", "color", "#fff", "type", "ball-scale-multiple"], [2, "font-size", "20px", "color", "white"]], template: function AppComponent_Template(rf, ctx) {
  if (rf & 1) {
