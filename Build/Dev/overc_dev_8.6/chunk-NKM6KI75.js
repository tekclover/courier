import {
  CurrencyService
} from "./chunk-JKYOKA3S.js";
import {
  IataService
} from "./chunk-TYZ3LQX4.js";
import {
  NumberrangeService
} from "./chunk-Z22ZR3IG.js";
import {
  CcrService,
  ConsignmentLabelComponent,
  ConsignmentService,
  ConsignmentUpdatebulkComponent
} from "./chunk-PQMF74RW.js";
import "./chunk-2AFTU43M.js";
import {
  ConsignorService,
  CustomerService
} from "./chunk-2KRRAIIS.js";
import {
  CommonAPIService
} from "./chunk-SRME4EU3.js";
import {
  CustomTableComponent,
  DeleteComponent
} from "./chunk-FGCRRL2U.js";
import {
  PathNameService
} from "./chunk-ER6KWWDE.js";
import {
  ActivatedRoute,
  AuthService,
  ButtonDirective,
  ...
  ɵɵtwoWayProperty,
  ɵɵviewQuery
} from "./chunk-V7QZNX2H.js";

// src/app/main/airport/pre-alert-manifest/pre-alert-bulk/pre-alert-bulk.component.ts
var _c0 = () => ({ "width": "100%" });
function PreAlertBulkComponent_div_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 7)(1, "p", 8);
    \u0275\u0275text(2, "HUB");
    \u0275\u0275elementEnd();
    \u0275\u0275element(3, "p-dropdown", 23);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275property("options", ctx_r0.hubList)("panelStyle", \u0275\u0275pureFunction0(5, _c0));
  }
}
var _PreAlertBulkComponent = class _PreAlertBulkComponent {
...
_PreAlertBulkComponent.\u0275fac = function PreAlertBulkComponent_Factory(t) {
  return new (t || _PreAlertBulkComponent)(\u0275\u0275directiveInject(MatDialogRef), \u0275\u0275directiveInject(MAT_DIALOG_DATA), \u0275\u0275directiveInject(CommonServiceService), \u0275\u0275directiveInject(NgxSpinnerService), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(PathNameService), \u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(ConsignmentService), \u0275\u0275directiveInject(MessageService), \u0275\u0275directiveInject(CommonAPIService), \u0275\u0275directiveInject(AuthService));
};
_PreAlertBulkComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PreAlertBulkComponent, selectors: [["app-pre-alert-bulk"]], decls: 54, vars: 41, consts: [[1, "bgWhite", "text-black", "w-93", "h-100", "m-4", "mt-4"], [1, "d-flex", "justify-content-between", "align-items-center"], [1, "componentHeader", "f600", "mb-0"], [1, "mt-4", "pt-2"], [3, "formGroup"], [1, "d-flex-row"], [1, "row", "scrollNew"], [1, "col-6", "marginFieldNew", "borderRadius12"], [1, "formControlLabel", "f600", "textBlack", "mb-0"], ["maxlength", "50", "pInputText", "", "formControlName", "partnerMasterAirwayBill", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["formControlName", "countryOfOrigin", "appendTo", "body", "placeholder", "Select", 3, "options", "disabled", "panelStyle"], ["class", "col-6 marginFieldNew borderRadius12", 4, "ngIf"], ["maxlength", "50", "pInputText", "", "formControlName", "flightNo", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["formControlName", "shipperId", "appendTo", "body", "placeholder", "Select", 3, "options", "disabled", "panelStyle"], ["placeholder", "Select", "filter", "true", "formControlName", "incoTerms", "appendTo", "body", 3, "options", "panelStyle"], ["placeholder", "Select", "filter", "true", "formControlName", "hsCode", "appendTo", "body", 3, "options", "panelStyle"], ["maxlength", "50", "pInputText", "", "formControlName", "bayanHv", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["placeholder", "Select", "filter", "true", "formControlName", "currency", "appendTo", "body", 3, "options", "panelStyle"], ["maxlength", "50", "pInputText", "", "formControlName", "flightName", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["placeholder", "Select", "filter", "true", "formControlName", "origin", "appendTo", "body", 3, "options", "panelStyle"], [1, "d-flex", "float-right", "py-2"], ["mat-dialog-close", "", 1, "buttom1", "textBlack", "mx-1", 3, "click"], ["type", "button", 1, "buttom1", "bgBlack", "text-white", "mx-1", 3, "click"], ["placeholder", "Select", "filter", "true", "formControlName", "hubCode", "appendTo", "body", 3, "options", "panelStyle"]], template: function PreAlertBulkComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(16, PreAlertBulkComponent_div_16_Template, 4, 6, "div", 11);
    \u0275\u0275elementStart(17, "div", 7)(18, "p", 8);
    \u0275\u0275text(19, "Flight No ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(20, "input", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "div", 7)(22, "p", 8);
    \u0275\u0275text(23, "Customer/Consignor");
    \u0275\u0275elementEnd();
    \u0275\u0275element(24, "p-dropdown", 13);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "div", 7)(26, "p", 8);
    \u0275\u0275text(27, "Inco Terms");
    \u0275\u0275elementEnd();
    \u0275\u0275element(28, "p-dropdown", 14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "div", 7)(30, "p", 8);
    \u0275\u0275text(31, "HS Code");
    \u0275\u0275elementEnd();
    \u0275\u0275element(32, "p-dropdown", 15);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(39, "Currency");
    \u0275\u0275elementEnd();
    \u0275\u0275element(40, "p-dropdown", 17);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "div", 7)(42, "p", 8);
    \u0275\u0275text(43, "Flight Name");
    \u0275\u0275elementEnd();
    \u0275\u0275element(44, "input", 18);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(45, "div", 7)(46, "p", 8);
    \u0275\u0275text(47, "Origin");
    \u0275\u0275elementEnd();
    \u0275\u0275element(48, "p-dropdown", 19);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(49, "div", 20)(50, "button", 21);
    \u0275\u0275listener("click", function PreAlertBulkComponent_Template_button_click_50_listener() {
      return ctx.cancel();
    });
    \u0275\u0275text(51, "Cancel");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(52, "button", 22);
    \u0275\u0275listener("click", function PreAlertBulkComponent_Template_button_click_52_listener() {
      return ctx.save();
    });
    \u0275\u0275text(53, "Save");
    \u0275\u0275elementEnd()()()()()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("options", ctx.countryIdList)("disabled", true)("panelStyle", \u0275\u0275pureFunction0(30, _c0));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.showHub == true);
    \u0275\u0275advance(8);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(31, _c0));
    \u0275\u0275property("options", ctx.consignorIdList)("disabled", true)("panelStyle", \u0275\u0275pureFunction0(32, _c0));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(33, _c0));
    \u0275\u0275property("options", ctx.incoTerms)("panelStyle", \u0275\u0275pureFunction0(34, _c0));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(35, _c0));
    \u0275\u0275property("options", ctx.hsCodeList)("panelStyle", \u0275\u0275pureFunction0(36, _c0));
    \u0275\u0275advance(8);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(37, _c0));
    \u0275\u0275property("options", ctx.currencyIdList)("panelStyle", \u0275\u0275pureFunction0(38, _c0));
    \u0275\u0275advance(8);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(39, _c0));
    \u0275\u0275property("options", ctx.airportOriginList)("panelStyle", \u0275\u0275pureFunction0(40, _c0));
  }
}, dependencies: [NgIf, Dropdown, InputText, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, MaxLengthValidator, MatDialogClose, FormGroupDirective, FormControlName], styles: ["\n\n.deleteBody[_ngcontent-%COMP%] {\n  font-family: Nunito;\n  font-size: 14px;\n  font-weight: 400;\n  line-height: 20.8px;\n  text-align: center;\n  color: rgba(255, 255, 255, 0.8);\n  padding-bottom: 1rem;\n}\n.deleteHeader[_ngcontent-%COMP%] {\n  font-family: Nunito;\n  font-size: 22px;\n  font-weight: 700;\n  line-height: 31.2px;\n  text-align: left;\n  padding-bottom: 1rem;\n}\n.cancelButton[_ngcontent-%COMP%] {\n  padding: 7px 25px 7px 25px;\n  gap: 10px;\n  border-radius: 6px;\n  border: 1px 0px 0px 0px;\n  opacity: 0px;\n  background-color: var(--white);\n  color: var(--black);\n}\n.saveButton[_ngcontent-%COMP%] {\n  padding: 7px 35px 7px 35px;\n  gap: 10px;\n  border-radius: 6px;\n  opacity: 0px;\n  background-color: var(--overcOrange);\n  color: var(--black);\n}\n  .mat-mdc-dialog-container .mdc-dialog__surface {\n  border-radius: 12px !important;\n}\n.marginFieldNew[_ngcontent-%COMP%] {\n  margin-bottom: 1.5rem;\n}\n.deleteDialog[_ngcontent-%COMP%] {\n  padding: 2rem 1rem;\n}\n.scrollNew[_ngcontent-%COMP%] {\n  height: calc(100vh - 20rem);\n  overflow-y: scroll !important;\n}\n/*# sourceMappingURL=pre-alert-bulk.component.css.map */"] });
var PreAlertBulkComponent = _PreAlertBulkComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PreAlertBulkComponent, { className: "PreAlertBulkComponent", filePath: "src\\app\\main\\airport\\pre-alert-manifest\\pre-alert-bulk\\pre-alert-bulk.component.ts", lineNumber: 19 });
})();
...
var _BondedManifestService = class _BondedManifestService {
  ...
  CreatefromPrealert(obj) {
    return this.http.post("/overc-midmile-service/bondedManifest/create/preAlert", obj);
  }
  Update(obj) {
...
var _ConsoleService = class _ConsoleService {
  ...
  UpdateStatusforConsole(obj) {
    return this.http.post("/overc-midmile-service/console/update/hawbtype", obj);
  }
  Transfer(obj) {
...
var _c02 = ["preAlertManifest"];
var _c1 = () => ({ width: "80vw" });
var _c2 = () => ({ "width": "100%" });
var _c3 = () => ({ "width": "125rem" });
var _c4 = (a0) => ({ "selectedRow": a0 });
var _c5 = () => ({ "cursor": "pointer" });
function PreAlertManifestComponent_ng_template_64_th_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function PreAlertManifestComponent_ng_template_64_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "th", 43);
    \u0275\u0275element(2, "p-tableHeaderCheckbox", 44);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, PreAlertManifestComponent_ng_template_64_th_3_Template, 2, 1, "th", 45);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function PreAlertManifestComponent_ng_template_65_td_3_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
...
function PreAlertManifestComponent_ng_template_65_td_3_ng_template_2_span_0_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const rowData_r7 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275propertyInterpolate("alt", rowData_r7[col_r6.field] == 0 ? "No" : "Yes");
    \u0275\u0275property("src", rowData_r7[col_r6.field] == 1 ? "./assets/common/okCircle.png" : "./assets/common/wrongCircle.png", \u0275\u0275sanitizeUrl);
  }
}
function PreAlertManifestComponent_ng_template_65_td_3_ng_template_2_span_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 53);
    \u0275\u0275element(1, "img", 54);
    \u0275\u0275elementEnd();
...
function PreAlertManifestComponent_ng_template_65_td_3_ng_template_2_span_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "span", 55);
    \u0275\u0275listener("click", function PreAlertManifestComponent_ng_template_65_td_3_ng_template_2_span_2_Template_span_click_0_listener() {
      \u0275\u0275restoreView(_r8);
      const rowData_r7 = \u0275\u0275nextContext(3).$implicit;
      const ctx_r8 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r8.preAlertIndicator("Indicator", rowData_r7));
    });
    \u0275\u0275element(1, "img", 54);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const col_r6 = \u0275\u0275nextContext(2).$implicit;
    const rowData_r7 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275property("ngStyle", \u0275\u0275pureFunction0(3, _c5));
    \u0275\u0275advance();
    \u0275\u0275propertyInterpolate("alt", rowData_r7[col_r6.field] == 0 ? "Yes" : "No");
    \u0275\u0275property("src", rowData_r7[col_r6.field] == 0 ? "./assets/common/okCircle.png" : "./assets/common/wrongCircle.png", \u0275\u0275sanitizeUrl);
  }
}
function PreAlertManifestComponent_ng_template_65_td_3_ng_template_2_span_3_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const rowData_r7 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(2, 1, rowData_r7[col_r6.field], "dd-MM-yyyy HH:mm"));
  }
}
function PreAlertManifestComponent_ng_template_65_td_3_ng_template_2_span_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
...
function PreAlertManifestComponent_ng_template_65_td_3_ng_template_2_span_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
...
function PreAlertManifestComponent_ng_template_65_td_3_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, PreAlertManifestComponent_ng_template_65_td_3_ng_template_2_span_0_Template, 2, 2, "span", 50)(1, PreAlertManifestComponent_ng_template_65_td_3_ng_template_2_span_1_Template, 2, 2, "span", 50)(2, PreAlertManifestComponent_ng_template_65_td_3_ng_template_2_span_2_Template, 2, 4, "span", 51)(3, PreAlertManifestComponent_ng_template_65_td_3_ng_template_2_span_3_Template, 3, 4, "span", 52)(4, PreAlertManifestComponent_ng_template_65_td_3_ng_template_2_span_4_Template, 3, 4, "span", 52)(5, PreAlertManifestComponent_ng_template_65_td_3_ng_template_2_span_5_Template, 3, 4, "span", 52);
  }
  if (rf & 2) {
    const col_r6 = \u0275\u0275nextContext().$implicit;
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", col_r6.field === "preAlertManifestIndicator");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", col_r6.format === "date");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", col_r6.format === "date1");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", col_r6.format === "date1");
  }
}
function PreAlertManifestComponent_ng_template_65_td_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td");
    \u0275\u0275template(1, PreAlertManifestComponent_ng_template_65_td_3_ng_container_1_Template, 2, 1, "ng-container", 49)(2, PreAlertManifestComponent_ng_template_65_td_3_ng_template_2_Template, 6, 6, "ng-template", null, 3, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", col_r6.format !== "date" && col_r6.format !== "boolean")("ngIfElse", dateTemplate_r10);
  }
}
function PreAlertManifestComponent_ng_template_65_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr", 46)(1, "td", 47);
    \u0275\u0275element(2, "p-tableCheckbox", 48);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, PreAlertManifestComponent_ng_template_65_td_3_Template, 4, 2, "td", 45);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r8 = \u0275\u0275nextContext();
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(3, _c4, ctx_r8.isSelected(rowData_r7)));
    \u0275\u0275advance(2);
...
function PreAlertManifestComponent_ng_template_66_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "p", 56);
...
function PreAlertManifestComponent_ng_template_69_Template(rf, ctx) {
  if (rf & 1) {
...
var _PreAlertManifestComponent = class _PreAlertManifestComponent {
  constructor(messageService, cs, router, path, service, dialog, datePipe, auth, spin, manifest, console2, fb, prealertService) {
    this.messageService = messageService;
    this.cs = cs;
    this.router = router;
    this.path = path;
  ...
  deleteDialog() {
    ...
    dialogRef.afterClosed().subscribe((result) => {
      if (result) {
        ...
        this.service.searchPrealert({ partnerMasterAirwayBill }).subscribe({
          next: (result2) => {
            this.deleterecord(result2);
          }
        });
      }
    });
  ...
  downloadExcelByColsAndTarget(res) {
    this.bols = [
    ...
    const bolsSheet = utils.json_to_sheet(bolsData);
    utils.book_append_sheet(wb, bolsSheet, `BOLs`);
    const itemsData = res.map((item) => {
      const exportItem = {};
    ...
    utils.book_append_sheet(wb, itemsSheet, `Items`);
    sheetNumber += 2;
    writeFileSync(wb, `Bonded-Manifest_${(/* @__PURE__ */ new Date()).getDate()}-${(/* @__PURE__ */ new Date()).getMonth() + 1}-${(/* @__PURE__ */ new Date()).getFullYear()}.xlsx`);
  }
};
_PreAlertManifestComponent.\u0275fac = function PreAlertManifestComponent_Factory(t) {
  return new (t || _PreAlertManifestComponent)(\u0275\u0275directiveInject(MessageService), \u0275\u0275directiveInject(CommonServiceService), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(PathNameService), \u0275\u0275directiveInject(ConsignmentService), \u0275\u0275directiveInject(MatDialog), \u0275\u0275directiveInject(DatePipe), \u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(NgxSpinnerService), \u0275\u0275directiveInject(BondedManifestService), \u0275\u0275directiveInject(ConsoleService), \u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(PrealertService));
};
_PreAlertManifestComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PreAlertManifestComponent, selectors: [["app-pre-alert-manifest"]], viewQuery: function PreAlertManifestComponent_Query(rf, ctx) {
  ...
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function PreAlertManifestComponent_Template_p_inputIcon_click_15_listener($event) {
      \u0275\u0275restoreView(_r1);
      const preAlertManifest_r2 = \u0275\u0275reference(18);
      return \u0275\u0275resetView(preAlertManifest_r2.toggle($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "input", 17);
    \u0275\u0275listener("input", function PreAlertManifestComponent_Template_input_input_16_listener($event) {
      \u0275\u0275restoreView(_r1);
      const preAlertManifestTag_r3 = \u0275\u0275reference(63);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "div", 21)(34, "p", 22);
    \u0275\u0275text(35, "Console Status");
    \u0275\u0275elementEnd();
    \u0275\u0275element(36, "p-multiSelect", 26);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "div", 21)(38, "p", 22);
    \u0275\u0275text(39, "Manifest Status");
    \u0275\u0275elementEnd();
    \u0275\u0275element(40, "p-multiSelect", 27);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "div", 21)(42, "p", 22);
    \u0275\u0275text(43, "Status");
    \u0275\u0275elementEnd();
    \u0275\u0275element(44, "p-multiSelect", 28);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(45, "div", 29)(46, "div")(47, "img", 30);
    \u0275\u0275listener("click", function PreAlertManifestComponent_Template_img_click_47_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.reset());
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(48, "div")(49, "button", 31);
    ...
    \u0275\u0275listener("click", function PreAlertManifestComponent_Template_button_click_51_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.search());
    });
    \u0275\u0275text(52, "Apply");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(53, "p-chips", 33);
    \u0275\u0275listener("onRemove", function PreAlertManifestComponent_Template_p_chips_onRemove_53_listener($event) {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.chipClear($event));
    });
    \u0275\u0275twoWayListener("ngModelChange", function PreAlertManifestComponent_Template_p_chips_ngModelChange_53_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.fieldsWithValue, $event) || (ctx.fieldsWithValue = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(54, "div", 14)(55, "button", 34);
    ...
    \u0275\u0275listener("click", function PreAlertManifestComponent_Template_button_click_58_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275text(60, "Bonded");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(61, "div", 36)(62, "p-table", 37, 1);
    \u0275\u0275twoWayListener("selectionChange", function PreAlertManifestComponent_Template_p_table_selectionChange_62_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.selectedPreAlertManifest, $event) || (ctx.selectedPreAlertManifest = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275template(64, PreAlertManifestComponent_ng_template_64_Template, 4, 1, "ng-template", 38)(65, PreAlertManifestComponent_ng_template_65_Template, 4, 5, "ng-template", 39)(66, PreAlertManifestComponent_ng_template_66_Template, 4, 1, "ng-template", 40);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(67, "mat-menu", 41, 2);
    \u0275\u0275template(69, PreAlertManifestComponent_ng_template_69_Template, 4, 0, "ng-template", 42);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance(17);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(40, _c1));
    ...
    \u0275\u0275property("options", ctx.masterAirwayBillDropdown)("panelStyle", \u0275\u0275pureFunction0(42, _c2));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(43, _c2));
    \u0275\u0275property("options", ctx.houseAirwayBillDropdown)("panelStyle", \u0275\u0275pureFunction0(44, _c2));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(45, _c2));
    \u0275\u0275property("options", ctx.partnerDropdown)("panelStyle", \u0275\u0275pureFunction0(46, _c2));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(47, _c2));
    \u0275\u0275property("options", ctx.indicatorDropdown)("panelStyle", \u0275\u0275pureFunction0(48, _c2));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(49, _c2));
    \u0275\u0275property("options", ctx.indicatorDropdown)("panelStyle", \u0275\u0275pureFunction0(50, _c2));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(51, _c2));
    \u0275\u0275property("options", ctx.statusDropdown)("panelStyle", \u0275\u0275pureFunction0(52, _c2));
    \u0275\u0275advance(9);
    ...
    \u0275\u0275property("paginator", true)("rows", 100)("showCurrentPageReport", true)("sortOrder", -1)("tableStyle", \u0275\u0275pureFunction0(53, _c3));
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PreAlertManifestComponent, { className: "PreAlertManifestComponent", filePath: "src\\app\\main\\airport\\pre-alert-manifest\\pre-alert-manifest.component.ts", lineNumber: 37 });
})();
...
function ConsoleComponent_ng_template_50_th_3_Template(rf, ctx) {
  if (rf & 1) {
...
function ConsoleComponent_ng_template_50_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "th", 39);
    \u0275\u0275element(2, "p-tableHeaderCheckbox", 40);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, ConsoleComponent_ng_template_50_th_3_Template, 3, 3, "th", 41);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ConsoleComponent_ng_template_51_td_4_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
...
function ConsoleComponent_ng_template_51_td_4_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
    \u0275\u0275pipe(1, "date");
  }
...
function ConsoleComponent_ng_template_51_td_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td");
    \u0275\u0275template(1, ConsoleComponent_ng_template_51_td_4_ng_container_1_Template, 2, 1, "ng-container", 48)(2, ConsoleComponent_ng_template_51_td_4_ng_template_2_Template, 2, 4, "ng-template", null, 4, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ConsoleComponent_ng_template_51_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr");
    \u0275\u0275elementStart(1, "tr", 44)(2, "td", 45);
    \u0275\u0275element(3, "p-tableCheckbox", 46);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, ConsoleComponent_ng_template_51_td_4_Template, 4, 2, "td", 47);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ConsoleComponent_ng_template_52_Template(rf, ctx) {
  if (rf & 1) {
        ...
        for (const consoleId in groupedByConsoleId) {
          if (groupedByConsoleId.hasOwnProperty(consoleId)) {
            ...
            const newRow = {
              ...
              "Currency": "",
              "Value": "Date",
              "Customs KD": this.datePipe.transform(/* @__PURE__ */ new Date(), "dd-MM-yyyy"),
              "IATA KD": "",
              "HS Code": "",
              "Console ID": ""
              // Include the console ID in the new row
            };
            const consoleSheetData = [];
            consoleSheetData.push(Object.values(newRow).map(String));
            consoleSheetData.push(cols.map((col) => col.header));
            const consoleRows = Object.values(consoleData).map((item, index) => {
              const exportItem = {};
              cols.forEach((col) => {
                if (col.format == "number") {
                  exportItem[col.header] = index + 1;
            ...
            const consoleSheet = utils.aoa_to_sheet(consoleSheetData);
            utils.book_append_sheet(wb, consoleSheet, `CONSOLE-${consoleId}`);
          }
        }
        writeFileSync(wb, `CONSOLE_${(/* @__PURE__ */ new Date()).getDate()}-${(/* @__PURE__ */ new Date()).getMonth() + 1}-${(/* @__PURE__ */ new Date()).getFullYear()}.xlsx`);
      }
    });
  }
  downloadExcelWBRD() {
...
_ConsoleComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConsoleComponent, selectors: [["app-console"]], viewQuery: function ConsoleComponent_Query(rf, ctx) {
  ...
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ConsoleComponent_Template_img_click_6_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.downloadExcelWBRD());
    });
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(9, "p-overlayPanel", null, 0);
    \u0275\u0275elementStart(11, "button", 12);
    \u0275\u0275listener("click", function ConsoleComponent_Template_button_click_11_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.openCrud("New"));
    });
    \u0275\u0275element(12, "i", 13);
    \u0275\u0275text(13, " Add New");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(14, "div", 14)(15, "p-iconField", 15)(16, "p-inputIcon", 16);
    \u0275\u0275listener("click", function ConsoleComponent_Template_p_inputIcon_click_16_listener($event) {
      \u0275\u0275restoreView(_r1);
      const console_r3 = \u0275\u0275reference(19);
      return \u0275\u0275resetView(console_r3.toggle($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "input", 17);
    \u0275\u0275listener("input", function ConsoleComponent_Template_input_input_17_listener($event) {
      \u0275\u0275restoreView(_r1);
      const consoleTag_r4 = \u0275\u0275reference(49);
      return \u0275\u0275resetView(consoleTag_r4.filterGlobal($event.target.value, "contains"));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "p-overlayPanel", 18, 1)(20, "form", 19)(21, "div", 20)(22, "div", 21)(23, "p", 22);
    \u0275\u0275text(24, "Console ID");
    \u0275\u0275elementEnd();
    \u0275\u0275element(25, "p-multiSelect", 23);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "div", 21)(27, "p", 22);
    \u0275\u0275text(28, "MAWB");
    \u0275\u0275elementEnd();
    \u0275\u0275element(29, "p-multiSelect", 24);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "div", 21)(31, "p", 22);
    \u0275\u0275text(32, "HAWB");
    \u0275\u0275elementEnd();
    \u0275\u0275element(33, "p-multiSelect", 25);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "div", 21)(35, "p", 22);
    \u0275\u0275text(36, "Partner");
    \u0275\u0275elementEnd();
    \u0275\u0275element(37, "p-multiSelect", 26);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(38, "div", 27)(39, "div")(40, "img", 28);
    \u0275\u0275listener("click", function ConsoleComponent_Template_img_click_40_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.reset());
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(41, "div")(42, "button", 29);
    \u0275\u0275listener("click", function ConsoleComponent_Template_button_click_42_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.closeOverLay());
    });
    \u0275\u0275text(43, "Cancel");
    ...
    \u0275\u0275listener("click", function ConsoleComponent_Template_button_click_44_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.search());
    });
    \u0275\u0275text(45, "Apply");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(46, "p-chips", 31);
    \u0275\u0275listener("onRemove", function ConsoleComponent_Template_p_chips_onRemove_46_listener($event) {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.chipClear($event));
    });
    \u0275\u0275twoWayListener("ngModelChange", function ConsoleComponent_Template_p_chips_ngModelChange_46_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.fieldsWithValue, $event) || (ctx.fieldsWithValue = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(47, "div", 32)(48, "p-table", 33, 2);
    \u0275\u0275twoWayListener("selectionChange", function ConsoleComponent_Template_p_table_selectionChange_48_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.selectedConsole, $event) || (ctx.selectedConsole = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275template(50, ConsoleComponent_ng_template_50_Template, 4, 1, "ng-template", 34)(51, ConsoleComponent_ng_template_51_Template, 5, 7, "ng-template", 35)(52, ConsoleComponent_ng_template_52_Template, 4, 1, "ng-template", 36);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(53, "mat-menu", 37, 3);
    \u0275\u0275template(55, ConsoleComponent_ng_template_55_Template, 4, 0, "ng-template", 38);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance(9);
    ...
    \u0275\u0275advance(9);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(34, _c32));
    \u0275\u0275property("dismissable", false)("styleClass", "custom-overlay-panel");
    \u0275\u0275advance(2);
    \u0275\u0275property("formGroup", ctx.searchform);
    \u0275\u0275advance(5);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(35, _c42));
    \u0275\u0275property("options", ctx.consoleIdDropdown)("panelStyle", \u0275\u0275pureFunction0(36, _c42));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(37, _c42));
    \u0275\u0275property("options", ctx.masterAirwayBillDropdown)("panelStyle", \u0275\u0275pureFunction0(38, _c42));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(39, _c42));
    \u0275\u0275property("options", ctx.houseAirwayBillDropdown)("panelStyle", \u0275\u0275pureFunction0(40, _c42));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(41, _c42));
    \u0275\u0275property("options", ctx.partnerDropdown)("panelStyle", \u0275\u0275pureFunction0(42, _c42));
    \u0275\u0275advance(9);
    \u0275\u0275twoWayProperty("ngModel", ctx.fieldsWithValue);
    \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConsoleComponent, { className: "ConsoleComponent", filePath: "src\\app\\main\\airport\\console\\console.component.ts", lineNumber: 25 });
})();
...
var _c05 = () => ({ "width": "100%" });
function ConsoleBulkComponent_div_19_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("options", ctx_r0.hubList)("panelStyle", \u0275\u0275pureFunction0(5, _c05));
  }
}
function ConsoleBulkComponent_div_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 8)(1, "p", 9);
...
_ConsoleBulkComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConsoleBulkComponent, selectors: [["app-console-bulk"]], decls: 50, vars: 18, consts: [[1, "bgWhite", "text-black", "w-93", "h-100", "m-4", "mt-4"], [1, "d-flex", "justify-content-between", "align-items-center"], [1, "componentHeader", "f600", "mb-0"], ["type", "button", 1, "invisible", "buttom1", "bgBlack", "text-white", "ml-2"], [1, "mt-4", "pt-2"], [3, "formGroup"], [1, "d-flex-row"], [1, "row"], [1, "col-6", "marginFieldNew", "borderRadius12"], [1, "formControlLabel", "f600", "textBlack", "mb-0"], ["maxlength", "50", "pInputText", "", "formControlName", "partnerMasterAirwayBill", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["formControlName", "countryOfOrigin", "appendTo", "body", "placeholder", "Select", 3, "options", "disabled", "panelStyle"], ["class", "col-6 marginFieldNew borderRadius12", 4, "ngIf"], ["maxlength", "50", "pInputText", "", "formControlName", "flightNo", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["formControlName", "shipperId", "appendTo", "body", "placeholder", "Select", 3, "options", "disabled", "panelStyle"], ["maxlength", "50", "pInputText", "", "formControlName", "primaryDo", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "secondaryDo", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "consoleGroupName", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "customsCcrNo", "pInputText", "", "placeholder", "Enter", 1, "w-100"], [1, "d-flex", "float-right", "py-2"], ["mat-dialog-close", "", 1, "buttom1", "textBlack", "mx-1"], ["type", "button", 1, "buttom1", "bgBlack", "text-white", "mx-1", 3, "click"], ["placeholder", "Select", "filter", "true", "formControlName", "hubCode", "appendTo", "body", 3, "options", "panelStyle"]], template: function ConsoleBulkComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "p", 2);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(19, ConsoleBulkComponent_div_19_Template, 4, 6, "div", 12);
    \u0275\u0275elementStart(20, "div", 8)(21, "p", 9);
    \u0275\u0275text(22, "Flight No ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(23, "input", 13);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "div", 8)(25, "p", 9);
    \u0275\u0275text(26, "Customer/Consignor");
    \u0275\u0275elementEnd();
    \u0275\u0275element(27, "p-dropdown", 14);
    \u0275\u0275elementEnd();
    \u0275\u0275template(28, ConsoleBulkComponent_div_28_Template, 4, 0, "div", 12);
    \u0275\u0275elementStart(29, "div", 8)(30, "p", 9);
    \u0275\u0275text(31, "Primary DO ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(32, "input", 15);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "div", 8)(34, "p", 9);
    \u0275\u0275text(35, "Secondary DO ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(36, "input", 16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "div", 8)(38, "p", 9);
    \u0275\u0275text(39, "Console Group Name ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(40, "input", 17);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "div", 8)(42, "p", 9);
    \u0275\u0275text(43, "Customs CCR No ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(44, "input", 18);
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("formGroup", ctx.form);
    \u0275\u0275advance(10);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(14, _c05));
    \u0275\u0275property("options", ctx.countryIdList)("disabled", true)("panelStyle", \u0275\u0275pureFunction0(15, _c05));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.showHub == true);
    \u0275\u0275advance(8);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(16, _c05));
    \u0275\u0275property("options", ctx.consignorIdList)("disabled", true)("panelStyle", \u0275\u0275pureFunction0(17, _c05));
    \u0275\u0275advance();
...
function CcrComponent_ng_template_77_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const expanded_r11 = ctx.expanded;
    const ctx_r11 = \u0275\u0275nextContext();
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(5, _c6, ctx_r11.isSelected(rowData_r8)));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", rowData_r8);
    \u0275\u0275advance(2);
    \u0275\u0275property("pRowToggler", rowData_r8)("ngClass", expanded_r11 ? "bi-chevron-up" : "bi-chevron-right");
...
function PreAlertNewComponent_ng_template_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "div", 33)(32, "p", 20);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "div", 35)(37, "p", 20);
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(31, _c07));
    \u0275\u0275property("options", ctx_r2.companyIdList)("disabled", true)("panelStyle", \u0275\u0275pureFunction0(32, _c07));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.errorHandling("companyId"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(33, _c07));
    \u0275\u0275property("options", ctx_r2.partnerType)("panelStyle", \u0275\u0275pureFunction0(34, _c07));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.errorHandling("partnerType"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(35, _c07));
    \u0275\u0275property("options", ctx_r2.customerIdList)("ngClass", ((tmp_14_0 = ctx_r2.form.get("partnerId")) == null ? null : tmp_14_0.invalid) && ctx_r2.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(36, _c07));
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_27_0 = ctx_r2.form.get("estimatedTimeOfArrivalFE")) == null ? null : tmp_27_0.invalid) && ctx_r2.submitted ? "ng-invalid ng-dirty" : "")("iconDisplay", "input")("showIcon", true);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.errorHandling("estimatedTimeOfArrivalFE"));
  }
}
...
function BondedManifestNewComponent_ng_template_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(55, _c08));
    \u0275\u0275property("options", ctx_r2.languageIdList)("disabled", true)("panelStyle", \u0275\u0275pureFunction0(56, _c08));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.errorHandling("languageId"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(57, _c08));
    \u0275\u0275property("options", ctx_r2.companyIdList)("disabled", true)("panelStyle", \u0275\u0275pureFunction0(58, _c08));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.errorHandling("companyId"));
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(59, _c08));
    ...
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(60, _c08));
    \u0275\u0275property("options", ctx_r2.consignorIdList)("disabled", true)("panelStyle", \u0275\u0275pureFunction0(61, _c08));
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(62, _c08));
    \u0275\u0275property("options", ctx_r2.flag);
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(63, _c08));
    \u0275\u0275property("options", ctx_r2.flag);
    \u0275\u0275advance(4);
    ...
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(64, _c08));
    \u0275\u0275property("options", ctx_r2.flag);
    \u0275\u0275advance(4);
...
function CcrNewComponent_ng_template_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("options", ctx_r2.currencyIdList)("panelStyle", \u0275\u0275pureFunction0(74, _c09));
    \u0275\u0275advance();
    ...
    \u0275\u0275property("options", ctx_r2.hsCodeList)("ngClass", ((tmp_41_0 = ctx_r2.form.get("hsCode")) == null ? null : tmp_41_0.invalid) && ctx_r2.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(76, _c09));
    \u0275\u0275advance();
    ...
    \u0275\u0275property("options", ctx_r2.value)("panelStyle", \u0275\u0275pureFunction0(78, _c09));
    \u0275\u0275advance(4);
...
function ConsoleNewComponent_ng_template_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(68, _c010));
    \u0275\u0275property("options", ctx_r2.languageIdList)("disabled", true)("panelStyle", \u0275\u0275pureFunction0(69, _c010));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.errorHandling("languageId"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(70, _c010));
    \u0275\u0275property("options", ctx_r2.companyIdList)("disabled", true)("panelStyle", \u0275\u0275pureFunction0(71, _c010));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.errorHandling("companyId"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(72, _c010));
    \u0275\u0275property("options", ctx_r2.mawbList)("ngClass", ((tmp_14_0 = ctx_r2.form.get("masterAirwayBill")) == null ? null : tmp_14_0.invalid) && ctx_r2.submitted ? "ng-invalid ng-dirty" : "")("disabled", true)("panelStyle", \u0275\u0275pureFunction0(73, _c010));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.errorHandling("masterAirwayBill"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(74, _c010));
    \u0275\u0275property("options", ctx_r2.hawbList)("ngClass", ((tmp_20_0 = ctx_r2.form.get("houseAirwayBill")) == null ? null : tmp_20_0.invalid) && ctx_r2.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(75, _c010));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.errorHandling("houseAirwayBill"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(76, _c010));
    \u0275\u0275property("options", ctx_r2.countryIdList)("disabled", true)("panelStyle", \u0275\u0275pureFunction0(77, _c010));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(78, _c010));
    \u0275\u0275property("options", ctx_r2.countryIdList)("disabled", true)("panelStyle", \u0275\u0275pureFunction0(79, _c010));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.errorHandling("airportOriginCode"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(80, _c010));
    \u0275\u0275property("options", ctx_r2.consignorIdList)("disabled", true)("panelStyle", \u0275\u0275pureFunction0(81, _c010));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.errorHandling("shipperId"));
    \u0275\u0275advance(4);
    ...
    \u0275\u0275property("ngIf", ctx_r2.errorHandling("consigneeName"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(82, _c010));
    \u0275\u0275property("options", ctx_r2.currencyIdList)("panelStyle", \u0275\u0275pureFunction0(83, _c010));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.errorHandling("currency"));
    \u0275\u0275advance(4);
    ...
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(84, _c010));
    \u0275\u0275property("options", ctx_r2.iataList)("panelStyle", \u0275\u0275pureFunction0(85, _c010));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.errorHandling("iata"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(86, _c010));
...
_ConsoleEditpopupComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConsoleEditpopupComponent, selectors: [["app-console-editpopup"]], decls: 88, vars: 22, consts: [[1, "bgWhite", "text-black", "w-93", "h-100", "m-4", "mt-4"], [1, "d-flex", "justify-content-between", "align-items-center"], [1, "componentHeader", "f600", "mb-0"], ["type", "button", 1, "invisible", "buttom1", "bgBlack", "text-white", "ml-2"], [1, "mt-4", "pt-2"], [3, "formGroup"], [1, "d-flex-row"], [1, "row", "scrollNew"], [1, "col-6", "marginFieldNew", "borderRadius12"], [1, "formControlLabel", "f600", "textBlack", "mb-0"], ["maxlength", "50", "pInputText", "", "formControlName", "partnerHouseAirwayBill", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "partnerMasterAirwayBill", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "consoleName", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "consoleGroupName", "pInputText", "", "placeholder", "Enter", 1, "w-100"], [1, "formControlLabel", "f600", "textBlack", "mb-0", "required"], ["maxlength", "50", "pInputText", "", "formControlName", "airportOriginCode", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "goodsDescription", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "grossWeight", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "noOfPieces", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["formControlName", "countryOfOrigin", "appendTo", "body", "placeholder", "Select", 3, "options", "disabled", "panelStyle"], ["maxlength", "50", "pInputText", "", "formControlName", "hsCode", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "consigneeName", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "consignmentValue", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["placeholder", "Select", "filter", "true", "formControlName", "currency", "appendTo", "body", 3, "options", "panelStyle"], ["maxlength", "50", "pInputText", "", "formControlName", "customsValue", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["placeholder", "Select", "filter", "true", "formControlName", "iata", "appendTo", "body", 3, "options", "panelStyle"], ["maxlength", "50", "pInputText", "", "formControlName", "customsCcrNo", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["maxlength", "50", "pInputText", "", "formControlName", "primaryDo", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "secondaryDo", "pInputText", "", "placeholder", "Enter", 1, "w-100"], [1, "d-flex", "float-right", "py-2"], ["mat-dialog-close", "", 1, "buttom1", "textBlack", "mx-1"], ["type", "button", 1, "buttom1", "bgBlack", "text-white", "mx-1", 3, "click"]], template: function ConsoleEditpopupComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "p", 2);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(71, "div", 8)(72, "p", 9);
    \u0275\u0275text(73, "Customs CCR No");
    \u0275\u0275elementEnd();
    \u0275\u0275element(74, "input", 26);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(75, "div", 8)(76, "p", 9);
    \u0275\u0275text(77, "Primary DO ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(78, "input", 27);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(79, "div", 8)(80, "p", 9);
    \u0275\u0275text(81, "Secondary DO ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(82, "input", 28);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(83, "div", 29)(84, "button", 30);
    \u0275\u0275text(85, "Cancel");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(86, "button", 31);
    \u0275\u0275listener("click", function ConsoleEditpopupComponent_Template_button_click_86_listener() {
      return ctx.save();
    });
    \u0275\u0275text(87, "Save");
    \u0275\u0275elementEnd()()()()()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("options", ctx.countryIdList)("disabled", true)("panelStyle", \u0275\u0275pureFunction0(17, _c011));
    \u0275\u0275advance(16);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(18, _c011));
    \u0275\u0275property("options", ctx.currencyIdList)("panelStyle", \u0275\u0275pureFunction0(19, _c011));
    \u0275\u0275advance(4);
    ...
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(20, _c011));
    \u0275\u0275property("options", ctx.iataList)("panelStyle", \u0275\u0275pureFunction0(21, _c011));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_12_0 = ctx.form.get("customsCcrNo")) == null ? null : tmp_12_0.invalid) && ((tmp_12_0 = ctx.form.get("customsCcrNo")) == null ? null : tmp_12_0.dirty) ? "invalid" : "");
  }
...
_ConsoleTransferComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConsoleTransferComponent, selectors: [["app-console-transfer"]], decls: 20, vars: 8, consts: [[1, "bgWhite", "text-black", "w-93", "h-100", "m-4", "mt-4"], [1, "d-flex", "justify-content-between", "align-items-center"], [1, "componentHeader", "f600", "mb-0"], ["type", "button", 1, "invisible", "buttom1", "bgBlack", "text-white", "ml-2"], [1, "mt-4", "pt-2"], [3, "formGroup"], [1, "d-flex-row"], [1, "row"], [1, "col-6", "marginFieldNew", "borderRadius12"], [1, "formControlLabel", "f600", "textBlack", "mb-0"], ["formControlName", "toConsoleId", "appendTo", "body", "placeholder", "Select", 3, "options", "disabled", "panelStyle"], [1, "d-flex", "float-right", "py-2", 2, "position", "absolute", "right", "3.5%", "bottom", "7%"], ["mat-dialog-close", "", 1, "buttom1", "textBlack", "mx-1"], ["type", "button", 1, "buttom1", "bgBlack", "text-white", "mx-1", 3, "click"]], template: function ConsoleTransferComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("options", ctx.consoleList)("disabled", true)("panelStyle", \u0275\u0275pureFunction0(7, _c012));
  }
...
// src/app/main/airport/console/console-edit/hub-code-poupup/hub-code-poupup.component.ts
var _c013 = () => ({ "width": "100%" });
var _HubCodePoupupComponent = class _HubCodePoupupComponent {
  constructor(dialogRef, data, cs, spin, route, router, path, fb, service, messageService, cas, auth) {
    this.dialogRef = dialogRef;
    this.data = data;
    this.cs = cs;
...
_HubCodePoupupComponent.\u0275fac = function HubCodePoupupComponent_Factory(t) {
  return new (t || _HubCodePoupupComponent)(\u0275\u0275directiveInject(MatDialogRef), \u0275\u0275directiveInject(MAT_DIALOG_DATA), \u0275\u0275directiveInject(CommonServiceService), \u0275\u0275directiveInject(NgxSpinnerService), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(PathNameService), \u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(ConsoleService), \u0275\u0275directiveInject(MessageService), \u0275\u0275directiveInject(CommonAPIService), \u0275\u0275directiveInject(AuthService));
};
_HubCodePoupupComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HubCodePoupupComponent, selectors: [["app-hub-code-poupup"]], decls: 20, vars: 8, consts: [[1, "bgWhite", "text-black", "w-93", "h-100", "m-4", "mt-4"], [1, "d-flex", "justify-content-between", "align-items-center"], [1, "componentHeader", "f600", "mb-0"], ["type", "button", 1, "invisible", "buttom1", "bgBlack", "text-white", "ml-2"], [1, "mt-4", "pt-2"], [3, "formGroup"], [1, "d-flex-row"], [1, "row"], [1, "col-6", "marginFieldNew", "borderRadius12"], [1, "formControlLabel", "f600", "textBlack", "mb-0"], ["placeholder", "Select", "filter", "true", "formControlName", "hubCode", "appendTo", "body", 3, "options", "panelStyle"], [1, "d-flex", "float-right", "py-2"], ["mat-dialog-close", "", 1, "buttom1", "textBlack", "mx-1"], ["type", "button", 1, "buttom1", "bgBlack", "text-white", "mx-1", 3, "click"]], template: function HubCodePoupupComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "p", 2);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "button", 13);
    \u0275\u0275listener("click", function HubCodePoupupComponent_Template_button_click_18_listener() {
      return ctx.save();
    });
    \u0275\u0275text(19, "Save");
    \u0275\u0275elementEnd()()()()()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("formGroup", ctx.form);
    \u0275\u0275advance(6);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(6, _c013));
    \u0275\u0275property("options", ctx.hubList)("panelStyle", \u0275\u0275pureFunction0(7, _c013));
  }
}, dependencies: [Dropdown, \u0275NgNoValidate, NgControlStatus, NgControlStatusGroup, MatDialogClose, FormGroupDirective, FormControlName] });
var HubCodePoupupComponent = _HubCodePoupupComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HubCodePoupupComponent, { className: "HubCodePoupupComponent", filePath: "src\\app\\main\\airport\\console\\console-edit\\hub-code-poupup\\hub-code-poupup.component.ts", lineNumber: 19 });
})();

// src/app/main/airport/console/console-edit/console-edit.component.ts
var _c014 = ["fileInput1"];
var _c15 = () => ({ width: "180" });
var _c25 = () => ({ "width": "100%" });
var _c35 = () => ({ "width": "270rem" });
function ConsoleEditComponent_mat_error_59_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r4.getErrorMessage());
  }
}
function ConsoleEditComponent_mat_error_64_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 37)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function ConsoleEditComponent_ng_template_72_th_3_Template(rf, ctx) {
  if (rf & 1) {
...
function ConsoleEditComponent_ng_template_72_th_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "th")(1, "input", 46);
    \u0275\u0275listener("input", function ConsoleEditComponent_ng_template_72_th_9_Template_input_input_1_listener($event) {
      const col_r8 = \u0275\u0275restoreView(_r7).$implicit;
      \u0275\u0275nextContext(2);
      const ccrTag_r9 = \u0275\u0275reference(71);
      return \u0275\u0275resetView(ccrTag_r9.filter($event.target == null ? null : $event.target.value, col_r8.field, "contains"));
    });
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ccrTag_r9 = \u0275\u0275reference(71);
    \u0275\u0275advance();
    \u0275\u0275property("value", ccrTag_r9.filters[col_r8.field] == null ? null : ccrTag_r9.filters[col_r8.field].value);
  }
}
function ConsoleEditComponent_ng_template_72_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "th", 38);
    \u0275\u0275element(2, "p-tableHeaderCheckbox", 39);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, ConsoleEditComponent_ng_template_72_th_3_Template, 3, 3, "th", 40);
    \u0275\u0275elementStart(4, "th", 41);
    \u0275\u0275text(5, " Actions ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "tr")(7, "th", 38);
    \u0275\u0275element(8, "p-tableHeaderCheckbox", 42);
    \u0275\u0275elementEnd();
    \u0275\u0275template(9, ConsoleEditComponent_ng_template_72_th_9_Template, 2, 1, "th", 43);
    \u0275\u0275element(10, "th", 41);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ConsoleEditComponent_ng_template_73_td_3_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
  ...
  if (rf & 2) {
    ...
    const rowData_r13 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", rowData_r13[col_r12.field], " ");
  }
}
function ConsoleEditComponent_ng_template_73_td_3_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
    \u0275\u0275pipe(1, "date");
  }
  if (rf & 2) {
    const rowData_r13 = \u0275\u0275nextContext(2).$implicit;
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(1, 1, rowData_r13.createdOn, "dd-MM-yyyy HH:mm"), " ");
  }
}
function ConsoleEditComponent_ng_template_73_td_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td");
    \u0275\u0275template(1, ConsoleEditComponent_ng_template_73_td_3_ng_container_1_Template, 2, 1, "ng-container", 52)(2, ConsoleEditComponent_ng_template_73_td_3_ng_template_2_Template, 2, 4, "ng-template", null, 5, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const col_r12 = ctx.$implicit;
    const dateTemplate_r14 = \u0275\u0275reference(3);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", col_r12.format !== "date")("ngIfElse", dateTemplate_r14);
  }
}
function ConsoleEditComponent_ng_template_73_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr")(1, "td", 38);
    \u0275\u0275element(2, "p-tableCheckbox", 47);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, ConsoleEditComponent_ng_template_73_td_3_Template, 4, 2, "td", 43);
    \u0275\u0275elementStart(4, "td", 48)(5, "img", 49);
    \u0275\u0275listener("click", function ConsoleEditComponent_ng_template_73_Template_img_click_5_listener($event) {
      \u0275\u0275restoreView(_r11);
      const op_r15 = \u0275\u0275reference(7);
      return \u0275\u0275resetView(op_r15.toggle($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p-overlayPanel", null, 2)(8, "div", 10)(9, "button", 11);
    \u0275\u0275listener("click", function ConsoleEditComponent_ng_template_73_Template_button_click_9_listener() {
      const rowData_r13 = \u0275\u0275restoreView(_r11).$implicit;
      const op_r15 = \u0275\u0275reference(7);
      const ctx_r4 = \u0275\u0275nextContext();
      ctx_r4.editItem("Edit", rowData_r13);
      return \u0275\u0275resetView(op_r15.hide());
    });
    \u0275\u0275element(10, "img", 50);
    \u0275\u0275text(11, "Edit");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "button", 11);
    \u0275\u0275listener("click", function ConsoleEditComponent_ng_template_73_Template_button_click_12_listener() {
      const rowData_r13 = \u0275\u0275restoreView(_r11).$implicit;
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.removeItem(rowData_r13));
    });
    \u0275\u0275element(13, "img", 51);
    \u0275\u0275text(14, "Delete");
    \u0275\u0275elementEnd()()()()();
  ...
  if (rf & 2) {
    ...
    const ctx_r4 = \u0275\u0275nextContext();
    \u0275\u0275classProp("selectedRow", ctx_r4.selectedConsole[0] === rowData_r13);
    \u0275\u0275advance(2);
    \u0275\u0275property("value", rowData_r13);
    \u0275\u0275advance();
...
function ConsoleEditComponent_ng_template_74_Template(rf, ctx) {
  if (rf & 1) {
...
var _ConsoleEditComponent = class _ConsoleEditComponent {
  constructor(cs, spin, route, router, path, fb, service, numberRangeService, messageService, cas, auth, dialog, datePipe, label) {
    this.cs = cs;
    this.spin = spin;
    this.route = route;
    this.router = router;
  ...
  downloadExcelWB(res) {
    ...
    for (const consoleId in groupedByConsoleId) {
      if (groupedByConsoleId.hasOwnProperty(consoleId)) {
        ...
        const consoleRows = Object.values(consoleData).map((item, index2) => {
          const exportItem = {};
          this.consoleManifest.forEach((col) => {
            if (col.format == "number") {
              exportItem[col.header] = index2 + 1;
            } else {
              exportItem[col.header] = item[col.field];
            }
          });
        ...
        consoleSheetData.push(...consoleRows);
        const consoleSheet = utils.aoa_to_sheet(consoleSheetData);
        utils.book_append_sheet(wb, consoleSheet, `CONSOLE-${index + 1}`);
        ...
        for (const ccrId in groupedByCcrId) {
          if (groupedByCcrId.hasOwnProperty(ccrId)) {
            ...
            const invoicesData = Object.values(ccrData).map((item) => {
              const exportItem = {};
            ...
            const invoiceSheet = utils.json_to_sheet(invoicesData);
            utils.book_append_sheet(wb, invoiceSheet, `INVOICES-${index + 1}`);
            const invoiceItemsData = Object.values(ccrData).map((item) => {
              const exportItem = {};
            ...
            const invoiceItemSheet = utils.json_to_sheet(invoiceItemsData);
            utils.book_append_sheet(wb, invoiceItemSheet, `INVOICEITEM-${index + 1}`);
          }
        }
      }
      index++;
    }
    writeFileSync(wb, `CCR-Manifest_${(/* @__PURE__ */ new Date()).getDate()}-${(/* @__PURE__ */ new Date()).getMonth() + 1}-${(/* @__PURE__ */ new Date()).getFullYear()}.xlsx`);
  }
  downloadConsole() {
    if (this.selectedConsole.length === 0) {
      this.messageService.add({ severity: "warn", summary: "Warning", key: "br", detail: "Kindly select any row" });
...
}, decls: 78, vars: 35, consts: [["status", ""], ["download", ""], ["op", ""], ["fileInput1", ""], ["ccrTag", ""], ["dateTemplate", ""], [1, "componentBody"], [1, "d-flex", "justify-content-between", "align-items-center"], [1, "componentHeader", "f600", "mb-0"], ["type", "button", "src", "./assets/common/edit.png", "alt", "", "srcset", "", 2, "margin", "0 17px", "height", "1.5rem", 3, "click"], [1, "d-flex", "flex-column"], ["mat-menu-item", "", 1, "w-100", 2, "width", "8rem", 3, "click"], ["src", "./assets/common/document.png", "srcset", "", 2, "padding-right", "10px", "width", "2rem"], ["type", "button", "src", "./assets/common/download.png", "alt", "", "srcset", "", 2, "margin", "0 17px", "height", "1.5rem", 3, "click"], ["src", "./assets/common2x/invoice.png", "srcset", "", 2, "padding-right", "10px", "width", "2rem"], ["src", "./assets/common2x/merge.png", "srcset", "", 2, "padding-right", "10px", "width", "2rem"], ["type", "button", "src", "./assets/common/settings.png", "alt", "", "srcset", "", 2, "margin-left", "19px", "margin-right", "28px", "height", "1.5rem", 3, "click"], ["type", "file", 2, "display", "none", 3, "change"], ["src", "./assets/common/upload.png", "srcset", "", 2, "padding-right", "10px", "width", "2rem"], ["type", "button", 1, "btn", "ml-2", "addNewbuttom", "bgBlack", "text-white", 3, "click"], [1, "mx-auto", "mt-4"], [3, "formGroup"], [1, "d-flex-row"], [1, "row", "scrollNew"], [1, "col-3", "marginFieldNew", "borderRadius12"], [1, "formControlLabel", "f600", "textBlack", "mb-0"], ["formControlName", "languageId", "appendTo", "body", 3, "options", "disabled", "panelStyle"], ["class", "text-danger", 4, "ngIf"], ["formControlName", "companyId", "appendTo", "body", 3, "options", "disabled", "panelStyle"], ["maxlength", "50", "pInputText", "", "formControlName", "partnerMasterAirwayBill", "pInputText", "", "placeholder", "Enter", 1, "w-100"], [1, "tableProperties"], ["selectionMode", "multiple", "sortField", "createdOn", "scrollHeight", "calc(100vh - 23rem)", "sortField", "createdOn", "styleClass", "p-datatable-sm", 1, "custom-table", 3, "selectionChange", "columns", "value", "scrollable", "sortOrder", "selection", "tableStyle"], ["pTemplate", "header"], ["pTemplate", "body"], ["pTemplate", "emptymessage"], [1, "d-flex", "mt-1", "justify-content-end", 2, "position", "absolute", "right", "3.5%", "bottom", "7%"], ["routerLink", "/main/airport/console", 1, "buttom1", "textBlack", "mx-1"], [1, "text-danger"], ["pFrozenColumn", "", 2, "width", "5rem"], [1, "pl-3"], [3, "pSortableColumn", 4, "ngFor", "ngForOf"], ["pFrozenColumn", "", "alignFrozen", "right", 2, "width", "5rem"], [1, "pl-3", 3, "disabled"], [4, "ngFor", "ngForOf"], [3, "pSortableColumn"], [3, "field"], ["pInputText", "", "type", "text", "placeholder", "Search", 1, "p-column-filter", 3, "input", "value"], [1, "pl-3", 3, "value"], ["pFrozenColumn", "", "alignFrozen", "right", 2, "padding-left", "1.5rem !important"], ["type", "button", "src", "./assets/common/actions.png", "alt", "", "srcset", "", 2, "height", "1.4rem", 3, "click"], ["src", "./assets/common/edit.png", "srcset", "", 2, "padding-right", "10px", "width", "2rem"], ["src", "./assets/common/deletetool.png", "srcset", "", 2, "padding-right", "10px", "width", "2rem"], [4, "ngIf", "ngIfElse"], [1, "my-2", "w-100", "pl-3"]], template: function ConsoleEditComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 6)(1, "div", 7)(2, "p", 8);
    \u0275\u0275text(3);
    ...
    \u0275\u0275listener("click", function ConsoleEditComponent_Template_img_click_5_listener($event) {
      \u0275\u0275restoreView(_r1);
      const status_r2 = \u0275\u0275reference(7);
      return \u0275\u0275resetView(status_r2.toggle($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p-overlayPanel", null, 0)(8, "div", 10)(9, "button", 11);
    \u0275\u0275listener("click", function ConsoleEditComponent_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r1);
      const op_r3 = \u0275\u0275reference(36);
      ctx.updateConsole("cleared");
      return \u0275\u0275resetView(op_r3.hide());
    });
    \u0275\u0275element(10, "img", 12);
    \u0275\u0275text(11, "Customs Cleared");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "button", 11);
    \u0275\u0275listener("click", function ConsoleEditComponent_Template_button_click_12_listener() {
      \u0275\u0275restoreView(_r1);
      const op_r3 = \u0275\u0275reference(36);
      ctx.updateConsole("self");
      return \u0275\u0275resetView(op_r3.hide());
    });
    \u0275\u0275element(13, "img", 12);
    \u0275\u0275text(14, "Self Clearance ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "button", 11);
    \u0275\u0275listener("click", function ConsoleEditComponent_Template_button_click_15_listener() {
      \u0275\u0275restoreView(_r1);
      const op_r3 = \u0275\u0275reference(36);
      ctx.callHubCode();
      return \u0275\u0275resetView(op_r3.hide());
    ...
    \u0275\u0275text(17, "Outscan ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(18, "img", 13);
    \u0275\u0275listener("click", function ConsoleEditComponent_Template_img_click_18_listener($event) {
      \u0275\u0275restoreView(_r1);
      const download_r4 = \u0275\u0275reference(20);
      return \u0275\u0275resetView(download_r4.toggle($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "p-overlayPanel", null, 1)(21, "div", 10)(22, "button", 11);
    \u0275\u0275listener("click", function ConsoleEditComponent_Template_button_click_22_listener() {
      \u0275\u0275restoreView(_r1);
      const op_r3 = \u0275\u0275reference(36);
      ctx.downloadConsole();
      return \u0275\u0275resetView(op_r3.hide());
    ...
    \u0275\u0275listener("click", function ConsoleEditComponent_Template_button_click_25_listener() {
      \u0275\u0275restoreView(_r1);
      const op_r3 = \u0275\u0275reference(36);
      ctx.generateLabel();
      return \u0275\u0275resetView(op_r3.hide());
    ...
    \u0275\u0275listener("click", function ConsoleEditComponent_Template_button_click_28_listener() {
      \u0275\u0275restoreView(_r1);
      const op_r3 = \u0275\u0275reference(36);
      ctx.generateInvoice();
      return \u0275\u0275resetView(op_r3.hide());
    ...
    \u0275\u0275listener("click", function ConsoleEditComponent_Template_button_click_31_listener() {
      \u0275\u0275restoreView(_r1);
      const op_r3 = \u0275\u0275reference(36);
      ctx.generateMerge();
      return \u0275\u0275resetView(op_r3.hide());
    ...
    \u0275\u0275element(32, "img", 15);
    \u0275\u0275text(33, "Invoice & Label ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(34, "img", 16);
    \u0275\u0275listener("click", function ConsoleEditComponent_Template_img_click_34_listener($event) {
      \u0275\u0275restoreView(_r1);
      const op_r3 = \u0275\u0275reference(36);
      return \u0275\u0275resetView(op_r3.toggle($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "p-overlayPanel", null, 2)(37, "input", 17, 3);
    \u0275\u0275listener("change", function ConsoleEditComponent_Template_input_change_37_listener($event) {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.onFileSelectedBayan($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "div", 10)(40, "button", 11);
    \u0275\u0275listener("click", function ConsoleEditComponent_Template_button_click_40_listener() {
      \u0275\u0275restoreView(_r1);
      const op_r3 = \u0275\u0275reference(36);
      ctx.saveCCR();
      return \u0275\u0275resetView(op_r3.hide());
    ...
    \u0275\u0275element(41, "img", 12);
    \u0275\u0275text(42, "Create CCR ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(43, "button", 11);
    \u0275\u0275listener("click", function ConsoleEditComponent_Template_button_click_43_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.uploadBayan());
    });
    \u0275\u0275element(44, "img", 18);
    \u0275\u0275text(45, "Upload Bayan");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "button", 11);
    \u0275\u0275listener("click", function ConsoleEditComponent_Template_button_click_46_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.updateBulk());
    });
    \u0275\u0275element(47, "img", 18);
    \u0275\u0275text(48, "Bulk Update");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(49, "button", 19);
    \u0275\u0275listener("click", function ConsoleEditComponent_Template_button_click_49_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.transfer());
    });
    \u0275\u0275text(50, "Transfer");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(51, "div", 20)(52, "form", 21)(53, "div", 22)(54, "div", 23)(55, "div", 24)(56, "p", 25);
    \u0275\u0275text(57, "Language");
    \u0275\u0275elementEnd();
    \u0275\u0275element(58, "p-dropdown", 26);
    \u0275\u0275template(59, ConsoleEditComponent_mat_error_59_Template, 3, 1, "mat-error", 27);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(60, "div", 24)(61, "p", 25);
    \u0275\u0275text(62, "Company");
    \u0275\u0275elementEnd();
    \u0275\u0275element(63, "p-dropdown", 28);
    \u0275\u0275template(64, ConsoleEditComponent_mat_error_64_Template, 3, 1, "mat-error", 27);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(65, "div", 24)(66, "p", 25);
    \u0275\u0275text(67, "Partner MAWB");
    \u0275\u0275elementEnd();
    \u0275\u0275element(68, "input", 29);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(69, "div", 30)(70, "p-table", 31, 4);
    \u0275\u0275twoWayListener("selectionChange", function ConsoleEditComponent_Template_p_table_selectionChange_70_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.selectedConsole, $event) || (ctx.selectedConsole = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275template(72, ConsoleEditComponent_ng_template_72_Template, 11, 3, "ng-template", 32)(73, ConsoleEditComponent_ng_template_73_Template, 15, 7, "ng-template", 33)(74, ConsoleEditComponent_ng_template_74_Template, 4, 1, "ng-template", 34);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(75, "div", 35)(76, "button", 36);
    \u0275\u0275text(77, "Cancel");
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate1("Console - ", ctx.pageToken.pageflow, "");
    \u0275\u0275advance(3);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(27, _c15));
    \u0275\u0275advance(13);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(28, _c15));
    \u0275\u0275advance(16);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(29, _c15));
    \u0275\u0275advance(17);
    \u0275\u0275property("formGroup", ctx.form);
    \u0275\u0275advance(6);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(30, _c25));
    \u0275\u0275property("options", ctx.languageIdList)("disabled", true)("panelStyle", \u0275\u0275pureFunction0(31, _c25));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandling("languageId"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(32, _c25));
    \u0275\u0275property("options", ctx.companyIdList)("disabled", true)("panelStyle", \u0275\u0275pureFunction0(33, _c25));
    \u0275\u0275advance();
    ...
    \u0275\u0275twoWayProperty("selection", ctx.selectedConsole);
    \u0275\u0275property("sortOrder", -1)("tableStyle", \u0275\u0275pureFunction0(34, _c35));
  }
}, dependencies: [NgForOf, NgIf, RouterLink, PrimeTemplate, Table, SortableColumn, FrozenColumn, SortIcon, TableCheckbox, TableHeaderCheckbox, Dropdown, InputText, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, MaxLengthValidator, OverlayPanel, MatError, MatMenuItem, FormGroupDirective, FormControlName, DatePipe], styles: ["\n\n.circle[_ngcontent-%COMP%] {\n  width: 44px;\n  height: 44px;\n  flex-grow: 0;\n  margin: 0 6px 12px;\n  border-radius: 100%;\n  padding: 12px 17px 11px;\n  background-color: var(--white);\n}\n.borderCircle[_ngcontent-%COMP%] {\n  border: solid 1.5px var(--black);\n}\n.marginFieldNew[_ngcontent-%COMP%] {\n  margin-bottom: 1.5rem;\n}\n.img-icon[_ngcontent-%COMP%] {\n  gap: 2rem;\n}\n/*# sourceMappingURL=console-edit.component.css.map */"] });
var ConsoleEditComponent = _ConsoleEditComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConsoleEditComponent, { className: "ConsoleEditComponent", filePath: "src\\app\\main\\airport\\console\\console-edit\\console-edit.component.ts", lineNumber: 28 });
})();
...
_CcrEditpopupComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CcrEditpopupComponent, selectors: [["app-ccr-editpopup"]], decls: 149, vars: 21, consts: [[1, "bgWhite", "text-black", "w-93", "h-100", "m-4", "mt-4"], [1, "d-flex", "justify-content-between", "align-items-center"], [1, "componentHeader", "f600", "mb-0"], [1, "mt-4", "pt-2"], [3, "formGroup"], [1, "d-flex-row"], [1, "row", "scrollNew"], [1, "col-6", "marginFieldNew", "borderRadius12"], [1, "formControlLabel", "f600", "textBlack", "mb-0"], ["maxlength", "50", "formControlName", "houseAirwayBill", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "masterAirwayBill", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "partnerHouseAirwayBill", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "partnerMasterAirwayBill", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "customsCcrNo", "pInputText", "", "placeholder", "Enter", 1, "w-100"], [1, "formControlLabel", "f600", "textBlack", "mb-0", "required"], ["maxlength", "50", "pInputText", "", "formControlName", "airportOriginCode", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["formControlName", "countryOfOrigin", "appendTo", "body", "placeholder", "Select", 3, "options", "disabled", "panelStyle"], ["maxlength", "50", "pInputText", "", "formControlName", "hsCode", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "goodsDescription", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "invoiceNumber", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "invoiceType", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "invoiceDate", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "invoiceSupplierName", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "isExempted", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "exemptionFor", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "exemptionBeneficiary", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "exemptionReference", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "consigneeName", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "consignmentValue", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["placeholder", "Select", "filter", "true", "formControlName", "consignmentCurrency", "appendTo", "body", 3, "options", "panelStyle"], ["maxlength", "50", "pInputText", "", "formControlName", "exchangeRate", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "customsInsurance", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "duty", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "consignmentValueLocal", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "addIATA", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "addInsurance", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "customsValue", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "calculatedTotalDuty", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "dduCharge", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "specialApprovalCharge", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "totalDuty", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "customsKd", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["placeholder", "Select", "filter", "true", "formControlName", "iata", "appendTo", "body", 3, "options", "panelStyle"], ["maxlength", "50", "pInputText", "", "formControlName", "createdOn", "pInputText", "", "placeholder", "Enter", 1, "w-100"], [1, "d-flex", "float-right", "py-2"], ["mat-dialog-close", "", 1, "buttom1", "textBlack", "mx-1"], ["type", "button", 1, "buttom1", "bgBlack", "text-white", "mx-1", 3, "click"]], template: function CcrEditpopupComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("formGroup", ctx.form);
    \u0275\u0275advance(30);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(15, _c015));
    \u0275\u0275property("options", ctx.countryIdList)("disabled", true)("panelStyle", \u0275\u0275pureFunction0(16, _c015));
    \u0275\u0275advance(52);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(17, _c015));
    \u0275\u0275property("options", ctx.currencyIdList)("panelStyle", \u0275\u0275pureFunction0(18, _c015));
    \u0275\u0275advance(48);
    ...
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(19, _c015));
    \u0275\u0275property("options", ctx.iataList)("panelStyle", \u0275\u0275pureFunction0(20, _c015));
  }
...
_CcrEditComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CcrEditComponent, selectors: [["app-ccr-edit"]], decls: 49, vars: 27, consts: [["ccrTag", ""], ["op", ""], ["dateTemplate", ""], [1, "componentBody"], [1, "d-flex", "justify-content-between", "align-items-center"], [1, "componentHeader", "f600", "mb-0"], ["type", "button", 1, "invisible", "buttom1", "bgBlack", "text-white", "ml-2"], [1, "mx-auto", "mt-4"], [3, "formGroup"], [1, "d-flex-row"], [1, "row", "scrollNew"], [1, "col-3", "marginFieldNew", "borderRadius12"], [1, "formControlLabel", "f600", "textBlack", "mb-0"], ["formControlName", "languageId", "appendTo", "body", 3, "options", "disabled", "panelStyle"], ["class", "text-danger", 4, "ngIf"], ["formControlName", "companyId", "appendTo", "body", 3, "options", "disabled", "panelStyle"], ["maxlength", "50", "pInputText", "", "pKeyFilter", "alphanum", "formControlName", "ccrId", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "pKeyFilter", "alphanum", "formControlName", "primaryDo", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "pKeyFilter", "alphanum", "formControlName", "secondaryDo", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "pKeyFilter", "alphanum", "formControlName", "statusText", "pInputText", "", "placeholder", "Enter", 1, "w-100"], [1, "tableProperties"], ["selectionMode", "multiple", "sortField", "createdOn", "scrollHeight", "calc(100vh - 28.8rem)", "sortField", "createdOn", "styleClass", "p-datatable-sm", 1, "custom-table", 3, "selectionChange", "columns", "value", "scrollable", "sortOrder", "selection", "tableStyle"], ["pTemplate", "header"], ["pTemplate", "body"], ["pTemplate", "footer"], ["pTemplate", "emptymessage"], [1, "d-flex", "mt-1", "justify-content-end", 2, "position", "absolute", "right", "3.5%", "bottom", "7%"], ["routerLink", "/main/airport/ccr", 1, "buttom1", "textBlack", "mx-1"], [1, "buttom1", "bgBlack", "text-white", "mx-1", 3, "click"], [1, "text-danger"], ["pFrozenColumn", "", 2, "width", "5rem"], [1, "pl-3"], [3, "pSortableColumn", 4, "ngFor", "ngForOf"], ["pFrozenColumn", "", "alignFrozen", "right", 2, "width", "5rem"], [3, "pSortableColumn"], [3, "field"], ["pFrozenColumn", "", 2, "width", "5rem", "justify-content", "center"], [1, "pl-3", 3, "value"], [4, "ngFor", "ngForOf"], ["pFrozenColumn", "", "alignFrozen", "right", 2, "padding-left", "1.5rem !important"], ["type", "button", "src", "./assets/common/actions.png", "alt", "", "srcset", "", 2, "height", "1.4rem", 3, "click"], [1, "d-flex", "flex-column"], ["mat-menu-item", "", 1, "w-100", 2, "width", "8rem", 3, "click"], ["src", "./assets/common/edit.png", "srcset", "", 2, "padding-right", "10px", "width", "2rem"], ["src", "./assets/common/deletetool.png", "srcset", "", 2, "padding-right", "10px", "width", "2rem"], [4, "ngIf", "ngIfElse"], [4, "ngIf"], [1, "my-2", "w-100", "pl-3"]], template: function CcrEditComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("formGroup", ctx.form);
    \u0275\u0275advance(6);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(22, _c016));
    \u0275\u0275property("options", ctx.languageIdList)("disabled", true)("panelStyle", \u0275\u0275pureFunction0(23, _c016));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandling("languageId"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(24, _c016));
    \u0275\u0275property("options", ctx.companyIdList)("disabled", true)("panelStyle", \u0275\u0275pureFunction0(25, _c016));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandling("companyId"));
    \u0275\u0275advance(18);
    \u0275\u0275property("columns", ctx.cols)("value", ctx.subProductArray)("scrollable", true)("sortOrder", -1);
...
function PreAlertManifestIndicatorComponent_ng_container_27_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.preAlertManifestIndicatorTable[0].consignmentCurrency, " ");
  }
}
function PreAlertManifestIndicatorComponent_ng_template_28_Template(rf, ctx) {
  if (rf & 1) {
...
function PreAlertManifestIndicatorComponent_ng_container_36_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.preAlertManifestIndicatorTable[0].consignmentId, " ");
  }
}
function PreAlertManifestIndicatorComponent_ng_template_37_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 17);
    \u0275\u0275text(1, "Null");
    \u0275\u0275elementEnd();
...
function PreAlertManifestIndicatorComponent_ng_container_45_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.preAlertManifestIndicatorTable[0].countryOfOrigin, " ");
  }
}
function PreAlertManifestIndicatorComponent_ng_template_46_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 17);
    \u0275\u0275text(1, "Null");
    \u0275\u0275elementEnd();
...
function PreAlertManifestIndicatorComponent_ng_container_54_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(2, 1, ctx_r0.preAlertManifestIndicatorTable[0].createdOn, "dd-MM-yyyy HH:mm"), " ");
  }
}
function PreAlertManifestIndicatorComponent_ng_template_55_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 17);
    \u0275\u0275text(1, "Null");
    \u0275\u0275elementEnd();
...
function PreAlertManifestIndicatorComponent_ng_container_63_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
...
function PreAlertManifestIndicatorComponent_ng_template_64_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 17);
    \u0275\u0275text(1, "Null");
    \u0275\u0275elementEnd();
...
function PreAlertManifestIndicatorComponent_ng_container_72_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.preAlertManifestIndicatorTable[0].grossWeight, " ");
  }
}
function PreAlertManifestIndicatorComponent_ng_template_73_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 17);
    \u0275\u0275text(1, "Null");
    \u0275\u0275elementEnd();
...
function PreAlertManifestIndicatorComponent_ng_container_81_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.preAlertManifestIndicatorTable[0].incoTerms, " ");
  }
}
function PreAlertManifestIndicatorComponent_ng_template_82_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 17);
    \u0275\u0275text(1, "Null");
    \u0275\u0275elementEnd();
...
function PreAlertManifestIndicatorComponent_ng_container_90_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.preAlertManifestIndicatorTable[0].noOfPackageHawb, " ");
  }
}
function PreAlertManifestIndicatorComponent_ng_template_91_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 17);
    \u0275\u0275text(1, "Null");
    \u0275\u0275elementEnd();
...
function PreAlertManifestIndicatorComponent_ng_container_99_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.preAlertManifestIndicatorTable[0].noOfPieceHawb, " ");
  }
}
function PreAlertManifestIndicatorComponent_ng_template_100_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 17);
    \u0275\u0275text(1, "Null");
    \u0275\u0275elementEnd();
...
function PreAlertManifestIndicatorComponent_ng_container_108_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.preAlertManifestIndicatorTable[0].partnerHouseAirwayBill, " ");
  }
}
function PreAlertManifestIndicatorComponent_ng_template_109_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 17);
    \u0275\u0275text(1, "Null");
    \u0275\u0275elementEnd();
...
function PreAlertManifestIndicatorComponent_ng_container_117_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.preAlertManifestIndicatorTable[0].paymentType, " ");
  }
}
function PreAlertManifestIndicatorComponent_ng_template_118_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 17);
    \u0275\u0275text(1, "Null");
    \u0275\u0275elementEnd();
...
function PreAlertManifestIndicatorComponent_ng_container_138_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.preAlertManifestIndicatorTable[0].originDetails.name, " ");
  }
}
function PreAlertManifestIndicatorComponent_ng_template_139_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 17);
    \u0275\u0275text(1, "Null");
    \u0275\u0275elementEnd();
...
function PreAlertManifestIndicatorComponent_ng_container_147_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.preAlertManifestIndicatorTable[0].originDetails.phone, " ");
  }
}
function PreAlertManifestIndicatorComponent_ng_template_148_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 17);
    \u0275\u0275text(1, "Null");
    \u0275\u0275elementEnd();
...
function PreAlertManifestIndicatorComponent_ng_container_156_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.preAlertManifestIndicatorTable[0].originDetails.addressLine1, " ");
  }
}
function PreAlertManifestIndicatorComponent_ng_template_157_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 17);
    \u0275\u0275text(1, "Null");
    \u0275\u0275elementEnd();
...
function PreAlertManifestIndicatorComponent_ng_container_165_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.preAlertManifestIndicatorTable[0].originDetails.addressLine2, " ");
  }
}
function PreAlertManifestIndicatorComponent_ng_template_166_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 17);
    \u0275\u0275text(1, "Null");
    \u0275\u0275elementEnd();
...
function PreAlertManifestIndicatorComponent_ng_container_174_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.preAlertManifestIndicatorTable[0].originDetails.city, " ");
  }
}
function PreAlertManifestIndicatorComponent_ng_template_175_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 17);
    \u0275\u0275text(1, "Null");
    \u0275\u0275elementEnd();
...
function PreAlertManifestIndicatorComponent_ng_container_183_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.preAlertManifestIndicatorTable[0].originDetails.country, " ");
  }
}
function PreAlertManifestIndicatorComponent_ng_template_184_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 17);
    \u0275\u0275text(1, "Null");
    \u0275\u0275elementEnd();
...
function PreAlertManifestIndicatorComponent_ng_container_204_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.preAlertManifestIndicatorTable[0].destinationDetails.name, " ");
  }
}
function PreAlertManifestIndicatorComponent_ng_template_205_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 17);
    \u0275\u0275text(1, "Null");
    \u0275\u0275elementEnd();
...
function PreAlertManifestIndicatorComponent_ng_container_213_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.preAlertManifestIndicatorTable[0].destinationDetails.phone, " ");
  }
}
function PreAlertManifestIndicatorComponent_ng_template_214_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 17);
    \u0275\u0275text(1, "Null");
    \u0275\u0275elementEnd();
...
function PreAlertManifestIndicatorComponent_ng_container_222_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.preAlertManifestIndicatorTable[0].destinationDetails.addressLine1, " ");
  }
}
function PreAlertManifestIndicatorComponent_ng_template_223_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 17);
    \u0275\u0275text(1, "Null");
    \u0275\u0275elementEnd();
...
function PreAlertManifestIndicatorComponent_ng_container_231_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.preAlertManifestIndicatorTable[0].destinationDetails.addressLine2, " ");
  }
}
function PreAlertManifestIndicatorComponent_ng_template_232_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 17);
    \u0275\u0275text(1, "Null");
    \u0275\u0275elementEnd();
...
function PreAlertManifestIndicatorComponent_ng_container_240_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.preAlertManifestIndicatorTable[0].destinationDetails.city, " ");
  }
}
function PreAlertManifestIndicatorComponent_ng_template_241_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 17);
    \u0275\u0275text(1, "Null");
    \u0275\u0275elementEnd();
...
function PreAlertManifestIndicatorComponent_ng_container_249_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.preAlertManifestIndicatorTable[0].destinationDetails.country, " ");
  }
}
function PreAlertManifestIndicatorComponent_ng_template_250_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 17);
    \u0275\u0275text(1, "Null");
    \u0275\u0275elementEnd();
...
function PreAlertManifestIndicatorComponent_tr_264_ng_container_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
...
function PreAlertManifestIndicatorComponent_tr_264_ng_template_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 17);
    \u0275\u0275text(1, "Null");
    \u0275\u0275elementEnd();
...
function PreAlertManifestIndicatorComponent_tr_264_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "td");
    \u0275\u0275template(6, PreAlertManifestIndicatorComponent_tr_264_ng_container_6_Template, 2, 1, "ng-container", 13)(7, PreAlertManifestIndicatorComponent_tr_264_ng_template_7_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function PreAlertManifestIndicatorComponent_tr_265_ng_container_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
...
function PreAlertManifestIndicatorComponent_tr_265_ng_template_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 17);
    \u0275\u0275text(1, "Null");
    \u0275\u0275elementEnd();
...
function PreAlertManifestIndicatorComponent_tr_265_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "th", 12);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "td");
    \u0275\u0275template(6, PreAlertManifestIndicatorComponent_tr_265_ng_container_6_Template, 2, 1, "ng-container", 13)(7, PreAlertManifestIndicatorComponent_tr_265_ng_template_7_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function PreAlertManifestIndicatorComponent_tr_266_ng_container_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
...
function PreAlertManifestIndicatorComponent_tr_266_ng_template_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 17);
    \u0275\u0275text(1, "Null");
    \u0275\u0275elementEnd();
...
function PreAlertManifestIndicatorComponent_tr_266_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "th", 12);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "td");
    \u0275\u0275template(6, PreAlertManifestIndicatorComponent_tr_266_ng_container_6_Template, 2, 1, "ng-container", 13)(7, PreAlertManifestIndicatorComponent_tr_266_ng_template_7_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function PreAlertManifestIndicatorComponent_tr_267_ng_container_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
...
function PreAlertManifestIndicatorComponent_tr_267_ng_template_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 17);
    \u0275\u0275text(1, "Null");
    \u0275\u0275elementEnd();
...
function PreAlertManifestIndicatorComponent_tr_267_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "th", 12);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "td");
    \u0275\u0275template(6, PreAlertManifestIndicatorComponent_tr_267_ng_container_6_Template, 2, 1, "ng-container", 13)(7, PreAlertManifestIndicatorComponent_tr_267_ng_template_7_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function PreAlertManifestIndicatorComponent_tr_268_ng_container_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
...
function PreAlertManifestIndicatorComponent_tr_268_ng_template_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 17);
    \u0275\u0275text(1, "Null");
    \u0275\u0275elementEnd();
...
function PreAlertManifestIndicatorComponent_tr_268_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "th", 12);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "td");
    \u0275\u0275template(6, PreAlertManifestIndicatorComponent_tr_268_ng_container_6_Template, 2, 1, "ng-container", 13)(7, PreAlertManifestIndicatorComponent_tr_268_ng_template_7_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
_PreAlertManifestIndicatorComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PreAlertManifestIndicatorComponent, selectors: [["app-pre-alert-manifest-indicator"]], decls: 272, vars: 52, consts: [["nullOrUndefined", ""], [1, "componentBody"], [1, "d-flex", "justify-content-between", "align-items-center"], [1, "componentHeader", "f600", "mb-0"], ["type", "button", 1, "invisible", "buttom1", "bgBlack", "text-white", "ml-2"], [1, "mx-auto", "mt-4"], [1, "d-flex-row", "scrollNew"], [1, "componentTableHeader", "f400", "mb-0"], [1, "table"], [1, "table-style"], ["scope", "col"], [1, "table-style-body"], ["scope", "row", 2, "font-weight", "normal"], [4, "ngIf", "ngIfElse"], [4, "ngFor", "ngForOf"], [1, "d-flex", "float-right", "py-2", 2, "position", "absolute", "right", "3.5%", "bottom", "7%"], ["routerLink", "/main/airport/preAlertManifest/", 1, "buttom1", "textBlack", "mx-1"], [1, "null-value"]], template: function PreAlertManifestIndicatorComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(27, PreAlertManifestIndicatorComponent_ng_container_27_Template, 2, 1, "ng-container", 13)(28, PreAlertManifestIndicatorComponent_ng_template_28_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(30, "tr")(31, "th", 12);
    \u0275\u0275text(32, "2");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "td");
    \u0275\u0275text(34, "Consignment ID");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "td");
    \u0275\u0275template(36, PreAlertManifestIndicatorComponent_ng_container_36_Template, 2, 1, "ng-container", 13)(37, PreAlertManifestIndicatorComponent_ng_template_37_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(39, "tr")(40, "th", 12);
    \u0275\u0275text(41, "3");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(42, "td");
    \u0275\u0275text(43, "Country Of Origin");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(44, "td");
    \u0275\u0275template(45, PreAlertManifestIndicatorComponent_ng_container_45_Template, 2, 1, "ng-container", 13)(46, PreAlertManifestIndicatorComponent_ng_template_46_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(48, "tr")(49, "th", 12);
    \u0275\u0275text(50, "4");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(51, "td");
    \u0275\u0275text(52, "Created On");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(53, "td");
    \u0275\u0275template(54, PreAlertManifestIndicatorComponent_ng_container_54_Template, 3, 4, "ng-container", 13)(55, PreAlertManifestIndicatorComponent_ng_template_55_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(57, "tr")(58, "th", 12);
    \u0275\u0275text(59, "5");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(60, "td");
    \u0275\u0275text(61, "Declared Value");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(62, "td");
    \u0275\u0275template(63, PreAlertManifestIndicatorComponent_ng_container_63_Template, 2, 1, "ng-container", 13)(64, PreAlertManifestIndicatorComponent_ng_template_64_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(66, "tr")(67, "th", 12);
    \u0275\u0275text(68, "6");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(69, "td");
    \u0275\u0275text(70, "Gross Weight");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(71, "td");
    \u0275\u0275template(72, PreAlertManifestIndicatorComponent_ng_container_72_Template, 2, 1, "ng-container", 13)(73, PreAlertManifestIndicatorComponent_ng_template_73_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(75, "tr")(76, "th", 12);
    \u0275\u0275text(77, "7");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(78, "td");
    \u0275\u0275text(79, "Inco Terms");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(80, "td");
    \u0275\u0275template(81, PreAlertManifestIndicatorComponent_ng_container_81_Template, 2, 1, "ng-container", 13)(82, PreAlertManifestIndicatorComponent_ng_template_82_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(84, "tr")(85, "th", 12);
    \u0275\u0275text(86, "8");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(87, "td");
    \u0275\u0275text(88, "No Of Package Hawb");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(89, "td");
    \u0275\u0275template(90, PreAlertManifestIndicatorComponent_ng_container_90_Template, 2, 1, "ng-container", 13)(91, PreAlertManifestIndicatorComponent_ng_template_91_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(93, "tr")(94, "th", 12);
    \u0275\u0275text(95, "9");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(96, "td");
    \u0275\u0275text(97, "No Of Piece Hawb");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(98, "td");
    \u0275\u0275template(99, PreAlertManifestIndicatorComponent_ng_container_99_Template, 2, 1, "ng-container", 13)(100, PreAlertManifestIndicatorComponent_ng_template_100_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(102, "tr")(103, "th", 12);
    \u0275\u0275text(104, "10");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(105, "td");
    \u0275\u0275text(106, "Partner Hawb");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(107, "td");
    \u0275\u0275template(108, PreAlertManifestIndicatorComponent_ng_container_108_Template, 2, 1, "ng-container", 13)(109, PreAlertManifestIndicatorComponent_ng_template_109_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(111, "tr")(112, "th", 12);
    \u0275\u0275text(113, "11");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(114, "td");
    \u0275\u0275text(115, "Payment Type");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(116, "td");
    \u0275\u0275template(117, PreAlertManifestIndicatorComponent_ng_container_117_Template, 2, 1, "ng-container", 13)(118, PreAlertManifestIndicatorComponent_ng_template_118_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(120, "p", 7);
    \u0275\u0275text(121, "Origin Details");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(122, "table", 8)(123, "thead", 9)(124, "tr")(125, "th", 10);
    \u0275\u0275text(126, "S.No");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(127, "th", 10);
    \u0275\u0275text(128, "Fields");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(129, "th", 10);
    \u0275\u0275text(130, "Value");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(131, "tbody", 11)(132, "tr")(133, "th", 12);
    \u0275\u0275text(134, "1");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(138, PreAlertManifestIndicatorComponent_ng_container_138_Template, 2, 1, "ng-container", 13)(139, PreAlertManifestIndicatorComponent_ng_template_139_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275template(147, PreAlertManifestIndicatorComponent_ng_container_147_Template, 2, 1, "ng-container", 13)(148, PreAlertManifestIndicatorComponent_ng_template_148_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(150, "tr")(151, "th", 12);
    \u0275\u0275text(152, "3");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(153, "td");
    \u0275\u0275text(154, "Address Line 1");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(155, "td");
    \u0275\u0275template(156, PreAlertManifestIndicatorComponent_ng_container_156_Template, 2, 1, "ng-container", 13)(157, PreAlertManifestIndicatorComponent_ng_template_157_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(159, "tr")(160, "th", 12);
    \u0275\u0275text(161, "4");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(162, "td");
    \u0275\u0275text(163, "Address Line 2");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(164, "td");
    \u0275\u0275template(165, PreAlertManifestIndicatorComponent_ng_container_165_Template, 2, 1, "ng-container", 13)(166, PreAlertManifestIndicatorComponent_ng_template_166_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(168, "tr")(169, "th", 12);
    \u0275\u0275text(170, "5");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(174, PreAlertManifestIndicatorComponent_ng_container_174_Template, 2, 1, "ng-container", 13)(175, PreAlertManifestIndicatorComponent_ng_template_175_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(177, "tr")(178, "th", 12);
    \u0275\u0275text(179, "6");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(183, PreAlertManifestIndicatorComponent_ng_container_183_Template, 2, 1, "ng-container", 13)(184, PreAlertManifestIndicatorComponent_ng_template_184_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(186, "p", 7);
    \u0275\u0275text(187, "Destination Details");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(188, "table", 8)(189, "thead", 9)(190, "tr")(191, "th", 10);
    \u0275\u0275text(192, "S.No");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(193, "th", 10);
    \u0275\u0275text(194, "Fields");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(195, "th", 10);
    \u0275\u0275text(196, "Value");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(197, "tbody", 11)(198, "tr")(199, "th", 12);
    \u0275\u0275text(200, "1");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(204, PreAlertManifestIndicatorComponent_ng_container_204_Template, 2, 1, "ng-container", 13)(205, PreAlertManifestIndicatorComponent_ng_template_205_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(207, "tr")(208, "th", 12);
    \u0275\u0275text(209, "2");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(213, PreAlertManifestIndicatorComponent_ng_container_213_Template, 2, 1, "ng-container", 13)(214, PreAlertManifestIndicatorComponent_ng_template_214_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(216, "tr")(217, "th", 12);
    \u0275\u0275text(218, "3");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(219, "td");
    \u0275\u0275text(220, "Address Line 1");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(221, "td");
    \u0275\u0275template(222, PreAlertManifestIndicatorComponent_ng_container_222_Template, 2, 1, "ng-container", 13)(223, PreAlertManifestIndicatorComponent_ng_template_223_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(225, "tr")(226, "th", 12);
    \u0275\u0275text(227, "4");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(228, "td");
    \u0275\u0275text(229, "Address Line 2");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(230, "td");
    \u0275\u0275template(231, PreAlertManifestIndicatorComponent_ng_container_231_Template, 2, 1, "ng-container", 13)(232, PreAlertManifestIndicatorComponent_ng_template_232_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(234, "tr")(235, "th", 12);
    \u0275\u0275text(236, "5");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(240, PreAlertManifestIndicatorComponent_ng_container_240_Template, 2, 1, "ng-container", 13)(241, PreAlertManifestIndicatorComponent_ng_template_241_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(243, "tr")(244, "th", 12);
    \u0275\u0275text(245, "6");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(249, PreAlertManifestIndicatorComponent_ng_container_249_Template, 2, 1, "ng-container", 13)(250, PreAlertManifestIndicatorComponent_ng_template_250_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(252, "p", 7);
    \u0275\u0275text(253, "Piece Details");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(254, "table", 8)(255, "thead", 9)(256, "tr")(257, "th", 10);
    \u0275\u0275text(258, "ID");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(259, "th", 10);
    \u0275\u0275text(260, "Fields");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(261, "th", 10);
    \u0275\u0275text(262, "Value");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(263, "tbody", 11);
    \u0275\u0275template(264, PreAlertManifestIndicatorComponent_tr_264_Template, 9, 3, "tr", 14)(265, PreAlertManifestIndicatorComponent_tr_265_Template, 9, 3, "tr", 14)(266, PreAlertManifestIndicatorComponent_tr_266_Template, 9, 3, "tr", 14)(267, PreAlertManifestIndicatorComponent_tr_267_Template, 9, 3, "tr", 14)(268, PreAlertManifestIndicatorComponent_tr_268_Template, 9, 3, "tr", 14);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(269, "div", 15)(270, "button", 16);
    \u0275\u0275text(271, "Cancel");
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    const nullOrUndefined_r17 = \u0275\u0275reference(29);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("Pre Alert Manifest - ", ctx.pageToken.pageflow, "");
    \u0275\u0275advance(24);
    \u0275\u0275property("ngIf", ctx.preAlertManifestIndicatorTable[0].consignmentCurrency !== null && ctx.preAlertManifestIndicatorTable[0].consignmentCurrency !== void 0)("ngIfElse", nullOrUndefined_r17);
    \u0275\u0275advance(9);
    \u0275\u0275property("ngIf", ctx.preAlertManifestIndicatorTable[0].consignmentId !== null && ctx.preAlertManifestIndicatorTable[0].consignmentId !== void 0)("ngIfElse", nullOrUndefined_r17);
    \u0275\u0275advance(9);
    \u0275\u0275property("ngIf", ctx.preAlertManifestIndicatorTable[0].countryOfOrigin !== null && ctx.preAlertManifestIndicatorTable[0].countryOfOrigin !== void 0)("ngIfElse", nullOrUndefined_r17);
    \u0275\u0275advance(9);
    \u0275\u0275property("ngIf", ctx.preAlertManifestIndicatorTable[0].createdOn !== null && ctx.preAlertManifestIndicatorTable[0].createdOn !== void 0)("ngIfElse", nullOrUndefined_r17);
    \u0275\u0275advance(9);
    ...
    \u0275\u0275advance(9);
    \u0275\u0275property("ngIf", ctx.preAlertManifestIndicatorTable[0].grossWeight !== null && ctx.preAlertManifestIndicatorTable[0].grossWeight !== void 0)("ngIfElse", nullOrUndefined_r17);
    \u0275\u0275advance(9);
    \u0275\u0275property("ngIf", ctx.preAlertManifestIndicatorTable[0].incoTerms !== null && ctx.preAlertManifestIndicatorTable[0].incoTerms !== void 0)("ngIfElse", nullOrUndefined_r17);
    \u0275\u0275advance(9);
    \u0275\u0275property("ngIf", ctx.preAlertManifestIndicatorTable[0].noOfPackageHawb !== null && ctx.preAlertManifestIndicatorTable[0].noOfPackageHawb !== void 0)("ngIfElse", nullOrUndefined_r17);
    \u0275\u0275advance(9);
    \u0275\u0275property("ngIf", ctx.preAlertManifestIndicatorTable[0].noOfPieceHawb !== null && ctx.preAlertManifestIndicatorTable[0].noOfPieceHawb !== void 0)("ngIfElse", nullOrUndefined_r17);
    \u0275\u0275advance(9);
    \u0275\u0275property("ngIf", ctx.preAlertManifestIndicatorTable[0].partnerHouseAirwayBill !== null && ctx.preAlertManifestIndicatorTable[0].partnerHouseAirwayBill !== void 0)("ngIfElse", nullOrUndefined_r17);
    \u0275\u0275advance(9);
    \u0275\u0275property("ngIf", ctx.preAlertManifestIndicatorTable[0].paymentType !== null && ctx.preAlertManifestIndicatorTable[0].paymentType !== void 0)("ngIfElse", nullOrUndefined_r17);
    \u0275\u0275advance(21);
    \u0275\u0275property("ngIf", ctx.preAlertManifestIndicatorTable[0].originDetails.name !== null && ctx.preAlertManifestIndicatorTable[0].originDetails.name !== void 0)("ngIfElse", nullOrUndefined_r17);
    \u0275\u0275advance(9);
    \u0275\u0275property("ngIf", ctx.preAlertManifestIndicatorTable[0].originDetails.phone !== null && ctx.preAlertManifestIndicatorTable[0].originDetails.phone !== void 0)("ngIfElse", nullOrUndefined_r17);
    \u0275\u0275advance(9);
    \u0275\u0275property("ngIf", ctx.preAlertManifestIndicatorTable[0].originDetails.addressLine1 !== null && ctx.preAlertManifestIndicatorTable[0].originDetails.addressLine1 !== void 0)("ngIfElse", nullOrUndefined_r17);
    \u0275\u0275advance(9);
    \u0275\u0275property("ngIf", ctx.preAlertManifestIndicatorTable[0].originDetails.addressLine2 !== null && ctx.preAlertManifestIndicatorTable[0].originDetails.addressLine2 !== void 0)("ngIfElse", nullOrUndefined_r17);
    \u0275\u0275advance(9);
    \u0275\u0275property("ngIf", ctx.preAlertManifestIndicatorTable[0].originDetails.city !== null && ctx.preAlertManifestIndicatorTable[0].originDetails.city !== void 0)("ngIfElse", nullOrUndefined_r17);
    \u0275\u0275advance(9);
    \u0275\u0275property("ngIf", ctx.preAlertManifestIndicatorTable[0].originDetails.country !== null && ctx.preAlertManifestIndicatorTable[0].originDetails.country !== void 0)("ngIfElse", nullOrUndefined_r17);
    \u0275\u0275advance(21);
    \u0275\u0275property("ngIf", ctx.preAlertManifestIndicatorTable[0].destinationDetails.name !== null && ctx.preAlertManifestIndicatorTable[0].destinationDetails.name !== void 0)("ngIfElse", nullOrUndefined_r17);
    \u0275\u0275advance(9);
    \u0275\u0275property("ngIf", ctx.preAlertManifestIndicatorTable[0].destinationDetails.phone !== null && ctx.preAlertManifestIndicatorTable[0].destinationDetails.phone !== void 0)("ngIfElse", nullOrUndefined_r17);
    \u0275\u0275advance(9);
    \u0275\u0275property("ngIf", ctx.preAlertManifestIndicatorTable[0].destinationDetails.addressLine1 !== null && ctx.preAlertManifestIndicatorTable[0].destinationDetails.addressLine1 !== void 0)("ngIfElse", nullOrUndefined_r17);
    \u0275\u0275advance(9);
    \u0275\u0275property("ngIf", ctx.preAlertManifestIndicatorTable[0].destinationDetails.addressLine2 !== null && ctx.preAlertManifestIndicatorTable[0].destinationDetails.addressLine2 !== void 0)("ngIfElse", nullOrUndefined_r17);
    \u0275\u0275advance(9);
    \u0275\u0275property("ngIf", ctx.preAlertManifestIndicatorTable[0].destinationDetails.city !== null && ctx.preAlertManifestIndicatorTable[0].destinationDetails.city !== void 0)("ngIfElse", nullOrUndefined_r17);
    \u0275\u0275advance(9);
    \u0275\u0275property("ngIf", ctx.preAlertManifestIndicatorTable[0].destinationDetails.country !== null && ctx.preAlertManifestIndicatorTable[0].destinationDetails.country !== void 0)("ngIfElse", nullOrUndefined_r17);
    \u0275\u0275advance(15);
...
// src/app/main/airport/pre-alert-manifest/pre-alert-editpopup/pre-alert-editpopup.component.ts
var _c017 = () => ({ "width": "100%" });
function PreAlertEditpopupComponent_mat_error_15_Template(rf, ctx) {
  if (rf & 1) {
...
function PreAlertEditpopupComponent_mat_error_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 60)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function PreAlertEditpopupComponent_mat_error_25_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 60)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function PreAlertEditpopupComponent_mat_error_30_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 60)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function PreAlertEditpopupComponent_mat_error_35_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 60)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function PreAlertEditpopupComponent_mat_error_40_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 60)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function PreAlertEditpopupComponent_mat_error_45_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 60)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function PreAlertEditpopupComponent_mat_error_50_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 60)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function PreAlertEditpopupComponent_mat_error_55_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 60)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function PreAlertEditpopupComponent_mat_error_60_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 60)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function PreAlertEditpopupComponent_mat_error_65_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 60)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function PreAlertEditpopupComponent_mat_error_70_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 60)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function PreAlertEditpopupComponent_mat_error_75_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 60)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function PreAlertEditpopupComponent_mat_error_80_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 60)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function PreAlertEditpopupComponent_mat_error_85_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 60)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function PreAlertEditpopupComponent_mat_error_90_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 60)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function PreAlertEditpopupComponent_mat_error_95_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 60)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function PreAlertEditpopupComponent_mat_error_100_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 60)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function PreAlertEditpopupComponent_mat_error_105_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 60)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function PreAlertEditpopupComponent_mat_error_110_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 60)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function PreAlertEditpopupComponent_mat_error_115_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 60)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function PreAlertEditpopupComponent_mat_error_120_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 60)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function PreAlertEditpopupComponent_mat_error_125_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 60)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function PreAlertEditpopupComponent_mat_error_130_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 60)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
var _PreAlertEditpopupComponent = class _PreAlertEditpopupComponent {
  constructor(dialogRef, data, cs, spin, route, router, path, fb, service, customerService, consignorService, messageService, cas, auth, el) {
    this.dialogRef = dialogRef;
    this.data = data;
    this.cs = cs;
    this.spin = spin;
    ...
    this.form = this.fb.group({
      ...
      countryOfDestination: [],
      estimatedTimeOfArrival: [""],
      estimatedTimeOfArrivalFE: [/* @__PURE__ */ new Date()],
      estimatedDepartureTime: [""],
      estimatedDepartureTimeFE: [/* @__PURE__ */ new Date()],
      noOfPackageMawb: [],
      noOfCrt: [],
...
_PreAlertEditpopupComponent.\u0275fac = function PreAlertEditpopupComponent_Factory(t) {
  return new (t || _PreAlertEditpopupComponent)(\u0275\u0275directiveInject(MatDialogRef), \u0275\u0275directiveInject(MAT_DIALOG_DATA), \u0275\u0275directiveInject(CommonServiceService), \u0275\u0275directiveInject(NgxSpinnerService), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(PathNameService), \u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(ConsignmentService), \u0275\u0275directiveInject(CustomerService), \u0275\u0275directiveInject(ConsignorService), \u0275\u0275directiveInject(MessageService), \u0275\u0275directiveInject(CommonAPIService), \u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(ElementRef));
};
_PreAlertEditpopupComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PreAlertEditpopupComponent, selectors: [["app-pre-alert-editpopup"]], decls: 136, vars: 100, consts: [[1, "bgWhite", "text-black", "w-93", "h-100", "m-4", "mt-4"], [1, "d-flex", "justify-content-between", "align-items-center"], [1, "componentHeader", "f600", "mb-0"], ["type", "button", 1, "invisible", "buttom1", "bgBlack", "text-white", "ml-2"], [1, "mt-4", "pt-2"], [3, "formGroup"], [1, "d-flex-row"], [1, "row", "scrollNew"], [1, "col-6", "marginFieldNew", "borderRadius12"], [1, "formControlLabel", "f600", "textBlack", "mb-0"], ["formControlName", "companyId", "appendTo", "body", 3, "options", "disabled", "panelStyle"], ["class", "text-danger", 4, "ngIf"], ["formControlName", "languageId", "appendTo", "body", 3, "options", "disabled", "panelStyle"], [1, "formControlLabel", "f600", "textBlack", "mb-0", "required"], ["placeholder", "Select", "filter", "true", "formControlName", "partnerType", "appendTo", "body", 3, "onChange", "options", "panelStyle"], ["id", "partnerId", 1, "col-6", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "partnerId", "appendTo", "body", 3, "options", "ngClass", "panelStyle"], ["id", "bayanHv", 1, "col-6", "marginFieldNew", "borderRadius12"], ["maxlength", "100", "pInputText", "", "pKeyFilter", "num", "formControlName", "bayanHv", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "partnerMasterAirwayBill", 1, "col-6", "marginFieldNew", "borderRadius12"], ["maxlength", "100", "pInputText", "", "formControlName", "partnerMasterAirwayBill", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "partnerHouseAirwayBill", 1, "col-6", "marginFieldNew", "borderRadius12"], ["maxlength", "100", "pInputText", "", "formControlName", "partnerHouseAirwayBill", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "shipper", 1, "col-6", "marginFieldNew", "borderRadius12"], ["maxlength", "100", "pInputText", "", "formControlName", "shipper", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "consigneeName", 1, "col-6", "marginFieldNew", "borderRadius12"], ["maxlength", "100", "pInputText", "", "formControlName", "consigneeName", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "incoTerm", 1, "col-6", "marginFieldNew", "borderRadius12"], ["maxlength", "100", "pInputText", "", "formControlName", "incoTerm", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "origin", 1, "col-6", "marginFieldNew", "borderRadius12"], ["maxlength", "100", "pInputText", "", "formControlName", "origin", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "description", 1, "col-6", "marginFieldNew", "borderRadius12"], ["maxlength", "100", "pInputText", "", "formControlName", "description", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "hsCode", 1, "col-6", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "hsCode", "appendTo", "body", 3, "options", "ngClass", "panelStyle"], ["id", "iata", 1, "col-6", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "iata", "appendTo", "body", 3, "options", "ngClass", "panelStyle"], ["id", "flightNo", 1, "col-6", "marginFieldNew", "borderRadius12"], ["maxlength", "100", "pInputText", "", "formControlName", "flightNo", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "flightName", 1, "col-6", "marginFieldNew", "borderRadius12"], ["maxlength", "100", "pInputText", "", "formControlName", "flightName", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "originCode", 1, "col-6", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "originCode", "appendTo", "body", 3, "options", "ngClass", "panelStyle"], ["id", "noOfPieces", 1, "col-6", "marginFieldNew", "borderRadius12"], ["maxlength", "100", "pInputText", "", "formControlName", "noOfPieces", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "estimatedDepartureTimeFE", 1, "col-6", "marginFieldNew", "borderRadius12"], ["formControlName", "estimatedDepartureTimeFE", "appendTo", "body", "placeholder", "Filter by Date", 1, "w-100", "small-calendar", 3, "ngClass", "iconDisplay", "showIcon"], ["id", "estimatedTimeOfArrivalFE", 1, "col-6", "marginFieldNew", "borderRadius12"], ["formControlName", "estimatedTimeOfArrivalFE", "appendTo", "body", "placeholder", "Filter by Date", 1, "w-100", "small-calendar", 3, "ngClass", "iconDisplay", "showIcon"], ["id", "totalWeight", 1, "col-6", "marginFieldNew", "borderRadius12"], ["maxlength", "100", "pInputText", "", "formControlName", "totalWeight", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "consignmentValue", 1, "col-6", "marginFieldNew", "borderRadius12"], ["maxlength", "100", "pInputText", "", "formControlName", "consignmentValue", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "consignmentValueLocal", 1, "col-6", "marginFieldNew", "borderRadius12"], ["maxlength", "100", "pInputText", "", "formControlName", "consignmentValueLocal", "pInputText", "", "placeholder", "Enter", 1, "w-100", 3, "ngClass"], ["id", "currency", 1, "col-6", "marginFieldNew", "borderRadius12"], ["placeholder", "Select", "filter", "true", "formControlName", "currency", "appendTo", "body", 3, "options", "ngClass", "panelStyle"], [1, "d-flex", "float-right", "py-2"], ["mat-dialog-close", "", 1, "buttom1", "textBlack", "mx-1"], ["type", "button", 1, "buttom1", "bgBlack", "text-white", "mx-1", 3, "click"], [1, "text-danger"]], template: function PreAlertEditpopupComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "p", 2);
    \u0275\u0275text(3, " Pre Alert Manifest - Edit");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 1)(5, "button", 3);
    \u0275\u0275text(6, "Transfer");
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(14, "p-dropdown", 10);
    \u0275\u0275template(15, PreAlertEditpopupComponent_mat_error_15_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "div", 8)(17, "p", 9);
    \u0275\u0275text(18, "Language");
    \u0275\u0275elementEnd();
    \u0275\u0275element(19, "p-dropdown", 12);
    \u0275\u0275template(20, PreAlertEditpopupComponent_mat_error_20_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "div", 8)(22, "p", 13);
    \u0275\u0275text(23, "Partner Type");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "p-dropdown", 14);
    \u0275\u0275listener("onChange", function PreAlertEditpopupComponent_Template_p_dropdown_onChange_24_listener() {
      return ctx.partnerTypeChanged();
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(25, PreAlertEditpopupComponent_mat_error_25_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "div", 15)(27, "p", 13);
    \u0275\u0275text(28, "Partner ID");
    \u0275\u0275elementEnd();
    \u0275\u0275element(29, "p-dropdown", 16);
    \u0275\u0275template(30, PreAlertEditpopupComponent_mat_error_30_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "div", 17)(32, "p", 9);
    \u0275\u0275text(33, "Bayan HV");
    \u0275\u0275elementEnd();
    \u0275\u0275element(34, "input", 18);
    \u0275\u0275template(35, PreAlertEditpopupComponent_mat_error_35_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "div", 19)(37, "p", 9);
    \u0275\u0275text(38, "Partner MAWB");
    \u0275\u0275elementEnd();
    \u0275\u0275element(39, "input", 20);
    \u0275\u0275template(40, PreAlertEditpopupComponent_mat_error_40_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "div", 21)(42, "p", 9);
    \u0275\u0275text(43, "Partner HAWB");
    \u0275\u0275elementEnd();
    \u0275\u0275element(44, "input", 22);
    \u0275\u0275template(45, PreAlertEditpopupComponent_mat_error_45_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "div", 23)(47, "p", 9);
    \u0275\u0275text(48, "Shipper Name");
    \u0275\u0275elementEnd();
    \u0275\u0275element(49, "input", 24);
    \u0275\u0275template(50, PreAlertEditpopupComponent_mat_error_50_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(51, "div", 25)(52, "p", 9);
    \u0275\u0275text(53, "Consignee Name");
    \u0275\u0275elementEnd();
    \u0275\u0275element(54, "input", 26);
    \u0275\u0275template(55, PreAlertEditpopupComponent_mat_error_55_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(56, "div", 27)(57, "p", 9);
    \u0275\u0275text(58, "Inco Terms");
    \u0275\u0275elementEnd();
    \u0275\u0275element(59, "input", 28);
    \u0275\u0275template(60, PreAlertEditpopupComponent_mat_error_60_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(61, "div", 29)(62, "p", 9);
    \u0275\u0275text(63, "Origin");
    \u0275\u0275elementEnd();
    \u0275\u0275element(64, "input", 30);
    \u0275\u0275template(65, PreAlertEditpopupComponent_mat_error_65_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(66, "div", 31)(67, "p", 9);
    \u0275\u0275text(68, "Description");
    \u0275\u0275elementEnd();
    \u0275\u0275element(69, "input", 32);
    \u0275\u0275template(70, PreAlertEditpopupComponent_mat_error_70_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(71, "div", 33)(72, "p", 9);
    \u0275\u0275text(73, "HS Code");
    \u0275\u0275elementEnd();
    \u0275\u0275element(74, "p-dropdown", 34);
    \u0275\u0275template(75, PreAlertEditpopupComponent_mat_error_75_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(76, "div", 35)(77, "p", 9);
    \u0275\u0275text(78, "IATA");
    \u0275\u0275elementEnd();
    \u0275\u0275element(79, "p-dropdown", 36);
    \u0275\u0275template(80, PreAlertEditpopupComponent_mat_error_80_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(81, "div", 37)(82, "p", 9);
    \u0275\u0275text(83, "Flight Number");
    \u0275\u0275elementEnd();
    \u0275\u0275element(84, "input", 38);
    \u0275\u0275template(85, PreAlertEditpopupComponent_mat_error_85_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(86, "div", 39)(87, "p", 9);
    \u0275\u0275text(88, "Flight Name");
    \u0275\u0275elementEnd();
    \u0275\u0275element(89, "input", 40);
    \u0275\u0275template(90, PreAlertEditpopupComponent_mat_error_90_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(91, "div", 41)(92, "p", 9);
    \u0275\u0275text(93, "Origin Port");
    \u0275\u0275elementEnd();
    \u0275\u0275element(94, "p-dropdown", 42);
    \u0275\u0275template(95, PreAlertEditpopupComponent_mat_error_95_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(96, "div", 43)(97, "p", 9);
    \u0275\u0275text(98, "Number of pieces");
    \u0275\u0275elementEnd();
    \u0275\u0275element(99, "input", 44);
    \u0275\u0275template(100, PreAlertEditpopupComponent_mat_error_100_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(101, "div", 45)(102, "p", 9);
    \u0275\u0275text(103, "Estimated Time Of Departure");
    \u0275\u0275elementEnd();
    \u0275\u0275element(104, "p-calendar", 46);
    \u0275\u0275template(105, PreAlertEditpopupComponent_mat_error_105_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(106, "div", 47)(107, "p", 9);
    \u0275\u0275text(108, "Estimated Time Of Arrival");
    \u0275\u0275elementEnd();
    \u0275\u0275element(109, "p-calendar", 48);
    \u0275\u0275template(110, PreAlertEditpopupComponent_mat_error_110_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(111, "div", 49)(112, "p", 9);
    \u0275\u0275text(113, "Total Weight");
    \u0275\u0275elementEnd();
    \u0275\u0275element(114, "input", 50);
    \u0275\u0275template(115, PreAlertEditpopupComponent_mat_error_115_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(116, "div", 51)(117, "p", 9);
    \u0275\u0275text(118, "Total Value");
    \u0275\u0275elementEnd();
    \u0275\u0275element(119, "input", 52);
    \u0275\u0275template(120, PreAlertEditpopupComponent_mat_error_120_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(121, "div", 53)(122, "p", 9);
    \u0275\u0275text(123, "ConsignmentValueLocal");
    \u0275\u0275elementEnd();
    \u0275\u0275element(124, "input", 54);
    \u0275\u0275template(125, PreAlertEditpopupComponent_mat_error_125_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(126, "div", 55)(127, "p", 9);
    \u0275\u0275text(128, "Currency");
    \u0275\u0275elementEnd();
    \u0275\u0275element(129, "p-dropdown", 56);
    \u0275\u0275template(130, PreAlertEditpopupComponent_mat_error_130_Template, 3, 1, "mat-error", 11);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(131, "div", 57)(132, "button", 58);
    \u0275\u0275text(133, "Cancel");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(134, "button", 59);
    \u0275\u0275listener("click", function PreAlertEditpopupComponent_Template_button_click_134_listener() {
      return ctx.save();
    });
    \u0275\u0275text(135, "Update");
    \u0275\u0275elementEnd()()()()()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("formGroup", ctx.form);
    \u0275\u0275advance(6);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(84, _c017));
    \u0275\u0275property("options", ctx.companyIdList)("disabled", true)("panelStyle", \u0275\u0275pureFunction0(85, _c017));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandling("companyId"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(86, _c017));
    \u0275\u0275property("options", ctx.languageIdList)("disabled", true)("panelStyle", \u0275\u0275pureFunction0(87, _c017));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandling("languageId"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(88, _c017));
    \u0275\u0275property("options", ctx.partnerType)("panelStyle", \u0275\u0275pureFunction0(89, _c017));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandling("partnerType"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(90, _c017));
    \u0275\u0275property("options", ctx.customerIdList)("ngClass", ((tmp_17_0 = ctx.form.get("partnerId")) == null ? null : tmp_17_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(91, _c017));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandling("partnerId"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_20_0 = ctx.form.get("bayanHv")) == null ? null : tmp_20_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandling("bayanHv"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_22_0 = ctx.form.get("partnerMasterAirwayBill")) == null ? null : tmp_22_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandling("partnerMasterAirwayBill"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_24_0 = ctx.form.get("partnerHouseAirwayBill")) == null ? null : tmp_24_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandling("partnerHouseAirwayBill"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_26_0 = ctx.form.get("shipper")) == null ? null : tmp_26_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandling("shipper"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_28_0 = ctx.form.get("consigneeName")) == null ? null : tmp_28_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandling("consigneeName"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_30_0 = ctx.form.get("incoTerm")) == null ? null : tmp_30_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandling("incoTerm"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_32_0 = ctx.form.get("origin")) == null ? null : tmp_32_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandling("origin"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_34_0 = ctx.form.get("description")) == null ? null : tmp_34_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandling("description"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(92, _c017));
    \u0275\u0275property("options", ctx.hsCodeList)("ngClass", ((tmp_38_0 = ctx.form.get("hsCode")) == null ? null : tmp_38_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(93, _c017));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandling("hsCode"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(94, _c017));
    \u0275\u0275property("options", ctx.iataIdList)("ngClass", ((tmp_43_0 = ctx.form.get("iata")) == null ? null : tmp_43_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(95, _c017));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandling("iata"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_46_0 = ctx.form.get("flightNo")) == null ? null : tmp_46_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandling("flightNo"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_48_0 = ctx.form.get("flightName")) == null ? null : tmp_48_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandling("flightName"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(96, _c017));
    \u0275\u0275property("options", ctx.countryIdList)("ngClass", ((tmp_52_0 = ctx.form.get("originCode")) == null ? null : tmp_52_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(97, _c017));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandling("originCode"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_55_0 = ctx.form.get("noOfPieces")) == null ? null : tmp_55_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandling("noOfPieces"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_57_0 = ctx.form.get("estimatedDepartureTimeFE")) == null ? null : tmp_57_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("iconDisplay", "input")("showIcon", true);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandling("estimatedDepartureTime"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_61_0 = ctx.form.get("estimatedTimeOfArrivalFE")) == null ? null : tmp_61_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("iconDisplay", "input")("showIcon", true);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandling("estimatedDepartureTime"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_65_0 = ctx.form.get("totalWeight")) == null ? null : tmp_65_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandling("totalWeight"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_67_0 = ctx.form.get("consignmentValue")) == null ? null : tmp_67_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandling("consignmentValue"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ((tmp_69_0 = ctx.form.get("consignmentValueLocal")) == null ? null : tmp_69_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandling("consignmentValueLocal"));
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(98, _c017));
    \u0275\u0275property("options", ctx.currencyIdList)("ngClass", ((tmp_73_0 = ctx.form.get("currency")) == null ? null : tmp_73_0.invalid) && ctx.submitted ? "ng-invalid ng-dirty" : "")("panelStyle", \u0275\u0275pureFunction0(99, _c017));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.errorHandling("currency"));
  }
}, dependencies: [NgClass, NgIf, Dropdown, InputText, Calendar, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, MaxLengthValidator, KeyFilter, MatError, MatDialogClose, FormGroupDirective, FormControlName], styles: ["\n\n.deleteBody[_ngcontent-%COMP%] {\n  font-family: Nunito;\n  font-size: 14px;\n  font-weight: 400;\n  line-height: 20.8px;\n  text-align: center;\n  color: rgba(255, 255, 255, 0.8);\n  padding-bottom: 1rem;\n}\n.deleteHeader[_ngcontent-%COMP%] {\n  font-family: Nunito;\n  font-size: 22px;\n  font-weight: 700;\n  line-height: 31.2px;\n  text-align: left;\n  padding-bottom: 1rem;\n}\n.cancelButton[_ngcontent-%COMP%] {\n  padding: 7px 25px 7px 25px;\n  gap: 10px;\n  border-radius: 6px;\n  border: 1px 0px 0px 0px;\n  opacity: 0px;\n  background-color: var(--white);\n  color: var(--black);\n}\n.saveButton[_ngcontent-%COMP%] {\n  padding: 7px 35px 7px 35px;\n  gap: 10px;\n  border-radius: 6px;\n  opacity: 0px;\n  background-color: var(--overcOrange);\n  color: var(--black);\n}\n  .mat-mdc-dialog-container .mdc-dialog__surface {\n  border-radius: 12px !important;\n}\n.marginFieldNew[_ngcontent-%COMP%] {\n  margin-bottom: 1.5rem;\n}\n.deleteDialog[_ngcontent-%COMP%] {\n  padding: 2rem 1rem;\n}\n.scrollNew[_ngcontent-%COMP%] {\n  height: calc(100vh - 20rem);\n  overflow-y: scroll !important;\n}\n/*# sourceMappingURL=pre-alert-editpopup.component.css.map */"] });
var PreAlertEditpopupComponent = _PreAlertEditpopupComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PreAlertEditpopupComponent, { className: "PreAlertEditpopupComponent", filePath: "src\\app\\main\\airport\\pre-alert-manifest\\pre-alert-editpopup\\pre-alert-editpopup.component.ts", lineNumber: 21 });
})();

// src/app/main/airport/pre-alert-manifest/pre-alert-update/pre-alert-update.component.ts
var _c018 = () => ({ width: "180" });
var _c17 = () => ({ "width": "250rem" });
function PreAlertUpdateComponent_button_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 27);
    \u0275\u0275listener("click", function PreAlertUpdateComponent_button_12_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
...
function PreAlertUpdateComponent_ng_template_28_th_3_Template(rf, ctx) {
  if (rf & 1) {
...
function PreAlertUpdateComponent_ng_template_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "th", 28);
    \u0275\u0275element(2, "p-tableHeaderCheckbox", 29);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, PreAlertUpdateComponent_ng_template_28_th_3_Template, 3, 3, "th", 30);
...
function PreAlertUpdateComponent_ng_template_29_td_3_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
...
function PreAlertUpdateComponent_ng_template_29_td_3_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
    \u0275\u0275pipe(1, "date");
  }
...
function PreAlertUpdateComponent_ng_template_29_td_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td");
    \u0275\u0275template(1, PreAlertUpdateComponent_ng_template_29_td_3_ng_container_1_Template, 2, 1, "ng-container", 40)(2, PreAlertUpdateComponent_ng_template_29_td_3_ng_template_2_Template, 2, 4, "ng-template", null, 3, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const col_r8 = ctx.$implicit;
...
function PreAlertUpdateComponent_ng_template_29_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr")(1, "td", 34);
    \u0275\u0275element(2, "p-tableCheckbox", 35);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, PreAlertUpdateComponent_ng_template_29_td_3_Template, 4, 2, "td", 36);
    \u0275\u0275elementStart(4, "td", 37)(5, "img", 38);
    \u0275\u0275listener("click", function PreAlertUpdateComponent_ng_template_29_Template_img_click_5_listener($event) {
      \u0275\u0275restoreView(_r7);
      const op_r11 = \u0275\u0275reference(7);
      return \u0275\u0275resetView(op_r11.toggle($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p-overlayPanel", null, 2)(8, "div", 8)(9, "button", 9);
    \u0275\u0275listener("click", function PreAlertUpdateComponent_ng_template_29_Template_button_click_9_listener() {
      const rowData_r9 = \u0275\u0275restoreView(_r7).$implicit;
      const op_r11 = \u0275\u0275reference(7);
      const ctx_r3 = \u0275\u0275nextContext();
      ctx_r3.editItem("Edit", rowData_r9);
      return \u0275\u0275resetView(op_r11.hide());
    });
    \u0275\u0275element(10, "img", 39);
    \u0275\u0275text(11, "Edit");
    \u0275\u0275elementEnd()()()()();
  ...
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275classProp("selectedRow", ctx_r3.selectedPreAlertManifest[0] === rowData_r9);
    \u0275\u0275advance(2);
    \u0275\u0275property("value", rowData_r9);
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", columns_r12);
    \u0275\u0275advance(3);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(6, _c018));
  }
}
function PreAlertUpdateComponent_ng_template_30_Template(rf, ctx) {
  if (rf & 1) {
...
var _PreAlertUpdateComponent = class _PreAlertUpdateComponent {
  constructor(cs, spin, route, router, path, fb, service, customerService, consignorService, messageService, cas, auth, el, dialog, datePipe) {
    this.cs = cs;
    this.spin = spin;
    this.route = route;
    this.router = router;
    ...
    this.cols = [];
    this.target = [];
    this.preAlertManifestTableArray = [];
    this.selectedPreAlertManifest = [];
  }
  ngOnInit() {
    let code = this.route.snapshot.params["code"];
...
_PreAlertUpdateComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PreAlertUpdateComponent, selectors: [["app-pre-alert-update"]], decls: 34, vars: 14, consts: [["bulkUpdate", ""], ["preAlertEditTag", ""], ["op", ""], ["dateTemplate", ""], [1, "componentBody"], [1, "d-flex", "justify-content-between", "align-items-center"], [1, "componentHeader", "f600", "mb-0"], ["type", "button", "src", "./assets/common/settings.png", "alt", "", "srcset", "", 2, "margin-left", "19px", "margin-right", "28px", "height", "1.5rem", 3, "click"], [1, "d-flex", "flex-column"], ["mat-menu-item", "", 1, "w-100", 2, "width", "8rem", 3, "click"], ["src", "./assets/common/upload.png", "srcset", "", 2, "padding-right", "10px", "width", "2rem"], ["type", "button", "class", "buttom1 bgBlack text-white ml-2", 3, "click", 4, "ngIf"], [1, "mx-auto", "mt-4"], [3, "formGroup"], [1, "d-flex-row"], [1, "row"], [1, "col-3", "marginFieldNew", "borderRadius12"], [1, "formControlLabel", "f600", "textBlack", "mb-0"], ["maxlength", "50", "pInputText", "", "formControlName", "companyId", "pInputText", "", "placeholder", "Enter", 1, "w-100"], ["maxlength", "50", "pInputText", "", "formControlName", "partnerMasterAirwayBill", "pInputText", "", "placeholder", "Enter", 1, "w-100"], [1, "tableProperties"], ["selectionMode", "multiple", "sortField", "createdOn", "scrollHeight", "calc(100vh - 25rem)", "sortField", "createdOn", "styleClass", "p-datatable-sm", 1, "custom-table", 3, "selectionChange", "columns", "value", "scrollable", "sortOrder", "selection", "tableStyle"], ["pTemplate", "header"], ["pTemplate", "body"], ["pTemplate", "emptymessage"], [1, "d-flex", "mt-1", "justify-content-end", 2, "position", "absolute", "right", "3.5%", "bottom", "7%"], ["routerLink", "/main/airport/preAlertManifest", 1, "buttom1", "textBlack", "mx-1"], ["type", "button", 1, "buttom1", "bgBlack", "text-white", "ml-2", 3, "click"], ["pFrozenColumn", "", 2, "width", "5rem"], [1, "pl-3"], [3, "pSortableColumn", 4, "ngFor", "ngForOf"], ["pFrozenColumn", "", "alignFrozen", "right", 2, "width", "5rem"], [3, "pSortableColumn"], [3, "field"], ["pFrozenColumn", "", 2, "width", "5rem", "justify-content", "center"], [1, "pl-3", 3, "value"], [4, "ngFor", "ngForOf"], ["pFrozenColumn", "", "alignFrozen", "right", 2, "padding-left", "1.5rem !important"], ["type", "button", "src", "./assets/common/actions.png", "alt", "", "srcset", "", 2, "height", "1.4rem", 3, "click"], ["src", "./assets/common/edit.png", "srcset", "", 2, "padding-right", "10px", "width", "2rem"], [4, "ngIf", "ngIfElse"], [1, "my-2", "w-100", "pl-3"]], template: function PreAlertUpdateComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 4)(1, "div", 5)(2, "p", 6);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 5)(5, "img", 7);
    \u0275\u0275listener("click", function PreAlertUpdateComponent_Template_img_click_5_listener($event) {
      \u0275\u0275restoreView(_r1);
      const bulkUpdate_r2 = \u0275\u0275reference(7);
      return \u0275\u0275resetView(bulkUpdate_r2.toggle($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p-overlayPanel", null, 0)(8, "div", 8)(9, "button", 9);
    \u0275\u0275listener("click", function PreAlertUpdateComponent_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.updateBulk());
    });
    \u0275\u0275element(10, "img", 10);
    \u0275\u0275text(11, "Bulk Update");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(12, PreAlertUpdateComponent_button_12_Template, 2, 0, "button", 11);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "div", 12)(14, "form", 13)(15, "div", 14)(16, "div", 15)(17, "div", 16)(18, "p", 17);
    \u0275\u0275text(19, "Company");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(25, "div", 20)(26, "p-table", 21, 1);
    \u0275\u0275twoWayListener("selectionChange", function PreAlertUpdateComponent_Template_p_table_selectionChange_26_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.selectedPreAlertManifest, $event) || (ctx.selectedPreAlertManifest = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275template(28, PreAlertUpdateComponent_ng_template_28_Template, 6, 1, "ng-template", 22)(29, PreAlertUpdateComponent_ng_template_29_Template, 12, 7, "ng-template", 23)(30, PreAlertUpdateComponent_ng_template_30_Template, 4, 1, "ng-template", 24);
    \u0275\u0275elementEnd()()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate1("Pre Alert Manifest - ", ctx.pageToken.pageflow, "");
    \u0275\u0275advance(3);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(12, _c018));
    \u0275\u0275advance(6);
    \u0275\u0275property("ngIf", ctx.pageToken.pageflow == "Edit");
    \u0275\u0275advance(2);
    \u0275\u0275property("formGroup", ctx.form);
    \u0275\u0275advance(12);
    \u0275\u0275property("columns", ctx.cols)("value", ctx.preAlertManifestTableArray)("scrollable", true)("sortOrder", -1);
    \u0275\u0275twoWayProperty("selection", ctx.selectedPreAlertManifest);
    \u0275\u0275property("sortOrder", -1)("tableStyle", \u0275\u0275pureFunction0(13, _c17));
  }
}, dependencies: [NgForOf, NgIf, RouterLink, PrimeTemplate, Table, SortableColumn, FrozenColumn, SortIcon, TableCheckbox, TableHeaderCheckbox, InputText, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, MaxLengthValidator, OverlayPanel, MatMenuItem, FormGroupDirective, FormControlName, DatePipe], styles: ["\n\n.circle[_ngcontent-%COMP%] {\n  width: 44px;\n  height: 44px;\n  flex-grow: 0;\n  margin: 0 6px 12px;\n  border-radius: 100%;\n  padding: 12px 17px 11px;\n  background-color: var(--white);\n}\n.borderCircle[_ngcontent-%COMP%] {\n  border: solid 1.5px var(--black);\n}\n.marginFieldNew[_ngcontent-%COMP%] {\n  margin-bottom: 2.5rem;\n}\n.scrollNew[_ngcontent-%COMP%] {\n  height: calc(100vh - 40rem);\n  overflow-y: scroll;\n}\n/*# sourceMappingURL=pre-alert-update.component.css.map */"] });
var PreAlertUpdateComponent = _PreAlertUpdateComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PreAlertUpdateComponent, { className: "PreAlertUpdateComponent", filePath: "src\\app\\main\\airport\\pre-alert-manifest\\pre-alert-update\\pre-alert-update.component.ts", lineNumber: 23 });
})();
...
//# sourceMappingURL=chunk-NKM6KI75.js.map
