...
var _ImageUploadComponent = class _ImageUploadComponent {
  ...
  download(element) {
    return __async(this, null, function* () {
      ...
      const blob = yield this.service.download(obj).catch((err) => {
        this.cs.commonerrorNew(err);
      });
      this.spin.hide();
      if (blob) {
...
function ItemDetailsComponent_ng_template_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ItemDetailsComponent_ng_template_11_Template_button_click_21_listener() {
      const ctx_r4 = \u0275\u0275restoreView(_r1);
      const i_r3 = ctx_r4.rowIndex;
      const rowData_r6 = ctx_r4.$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.removeItem(i_r3, rowData_r6));
    });
    \u0275\u0275element(22, "img", 25);
    \u0275\u0275text(23, "Delete");
    \u0275\u0275elementEnd();
...
var _ItemDetailsComponent = class _ItemDetailsComponent {
  ...
  imageupload(type = "New", index) {
    const dialogRef = this.dialog.open(ImageUploadComponent, {
      ...
      maxWidth: "82%",
      position: { top: "6.5%", left: "25%" },
      data: { pageflow: type, line: this.itemForm.controls.itemDetails.at(index).get("referenceImageList"), lineDetails: this.itemForm.controls.itemDetails.at(index) }
    });
    dialogRef.afterClosed().subscribe((result) => {
      if (result) {
...
var _ConsignmentNewComponent = class _ConsignmentNewComponent {
  ...
  imageupload(type = "New", index) {
    const dialogRef = this.dialog.open(ImageUploadComponent, {
      ...
      maxWidth: "82%",
      position: { top: "6.5%", left: "25%" },
      data: { pageflow: type, line: this.piece.controls.pieceDetails.at(index).get("referenceImageList"), lineDetails: this.piece.controls.pieceDetails.at(index) }
    });
    dialogRef.afterClosed().subscribe((result) => {
      if (result) {
...
//# sourceMappingURL=chunk-HVUCNHHZ.js.map
