...
var _PreAlertManifestIndicatorComponent = class _PreAlertManifestIndicatorComponent {
  constructor(dialogRef, data, cs, spin, route, router, path, fb, consignmentService, customerService, consignorService, messageService, cas, auth, el, dialog) {
  ...
  preAlertValidation() {
    ...
    this.consignmentService.findConsignmentPreAlertIndicator(obj).subscribe({
      next: (res) => {
        ...
        this.preAlertManifestIndicatorTable = res.map((item) => this.reorderFields(item));
...
_PreAlertManifestIndicatorComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PreAlertManifestIndicatorComponent, selectors: [["app-pre-alert-manifest-indicator"]], decls: 16, vars: 3, consts: [[1, "componentBody"], [1, "d-flex", "justify-content-between", "align-items-center"], [1, "componentHeader", "f600", "mb-0"], ["type", "button", 1, "invisible", "buttom1", "bgBlack", "text-white", "ml-2"], [1, "mx-auto", "mt-4"], [1, "d-flex-row"], [1, "scrollNew"], [1, "marginFieldNew", "borderRadius12"], [1, "d-flex", "float-right", "py-2", 2, "position", "absolute", "right", "3.5%", "bottom", "7%"], ["mat-dialog-close", "", 1, "buttom1", "textBlack", "mx-1"]], template: function PreAlertManifestIndicatorComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "p", 2);
    \u0275\u0275text(3, "Pre Alert Manifest - Indicator");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    \u0275\u0275advance(11);
    \u0275\u0275textInterpolate1("                    ", \u0275\u0275pipeBind1(12, 1, ctx.preAlertManifestIndicatorTable), "\n                ");
  }
...
//# sourceMappingURL=chunk-P2AGSB57.js.map
