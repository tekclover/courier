import {
  CurrencyService
} from "./chunk-5C7ZNXTW.js";
import {
  IataService
} from "./chunk-WNBCFC2P.js";
import {
  NumberrangeService
} from "./chunk-QPOTNOYX.js";
import {
  CcrService,
  ConsignmentLabelComponent,
  ConsignmentService,
  ConsignmentUpdatebulkComponent
} from "./chunk-A6FSADQS.js";
import "./chunk-K263DNE5.js";
import {
  ConsignorService,
  CustomerService
} from "./chunk-PFNMJUBM.js";
import {
  CommonAPIService
} from "./chunk-XR2HHQNN.js";
import {
  CustomTableComponent,
  DeleteComponent
} from "./chunk-VP3OO7LU.js";
import {
  PathNameService
} from "./chunk-YCM2HLCB.js";
import {
  ActivatedRoute,
  AuthService,
  ButtonDirective,
...
function ConsoleEditComponent_mat_error_30_Template(rf, ctx) {
  if (rf & 1) {
...
function ConsoleEditComponent_mat_error_35_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error", 30)(1, "small");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function ConsoleEditComponent_ng_template_43_th_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 35);
    \u0275\u0275text(1);
    \u0275\u0275element(2, "p-sortIcon", 36);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ConsoleEditComponent_ng_template_43_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "th", 31);
    \u0275\u0275element(2, "p-tableHeaderCheckbox", 32);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, ConsoleEditComponent_ng_template_43_th_3_Template, 3, 3, "th", 33);
...
function ConsoleEditComponent_ng_template_44_td_3_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275elementContainerEnd();
...
function ConsoleEditComponent_ng_template_44_td_3_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
    \u0275\u0275pipe(1, "date");
  }
...
function ConsoleEditComponent_ng_template_44_td_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td");
    \u0275\u0275template(1, ConsoleEditComponent_ng_template_44_td_3_ng_container_1_Template, 2, 1, "ng-container", 44)(2, ConsoleEditComponent_ng_template_44_td_3_ng_template_2_Template, 2, 4, "ng-template", null, 2, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const col_r7 = ctx.$implicit;
...
function ConsoleEditComponent_ng_template_44_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr")(1, "td", 37);
    \u0275\u0275element(2, "p-tableCheckbox", 38);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, ConsoleEditComponent_ng_template_44_td_3_Template, 4, 2, "td", 39);
    \u0275\u0275elementStart(4, "td", 40)(5, "img", 41);
    \u0275\u0275listener("click", function ConsoleEditComponent_ng_template_44_Template_img_click_5_listener($event) {
      \u0275\u0275restoreView(_r6);
      const op_r10 = \u0275\u0275reference(7);
      return \u0275\u0275resetView(op_r10.toggle($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p-overlayPanel", null, 0)(8, "div", 7)(9, "button", 10);
    \u0275\u0275listener("click", function ConsoleEditComponent_ng_template_44_Template_button_click_9_listener() {
    ...
    \u0275\u0275listener("click", function ConsoleEditComponent_ng_template_44_Template_button_click_12_listener() {
      const rowData_r8 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
...
function ConsoleEditComponent_ng_template_45_Template(rf, ctx) {
  if (rf & 1) {
...
var _ConsoleEditComponent = class _ConsoleEditComponent {
  ...
  downloadExcelWB(res) {
    ...
    for (const consoleId in groupedByConsoleId) {
      if (groupedByConsoleId.hasOwnProperty(consoleId)) {
        const consoleData = groupedByConsoleId[consoleId];
        const consoleSheetData = Object.values(consoleData).map((item) => {
          const exportItem = {};
        ...
        const consoleSheet = utils.json_to_sheet(consoleSheetData);
        utils.book_append_sheet(wb, consoleSheet, `CONSOLE-${consoleId}`);
...
_ConsoleEditComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConsoleEditComponent, selectors: [["app-console-edit"]], decls: 49, vars: 29, consts: [["op", ""], ["ccrTag", ""], ["dateTemplate", ""], [1, "componentBody"], [1, "d-flex", "justify-content-between", "align-items-center"], [1, "componentHeader", "f600", "mb-0"], ["type", "button", "src", "./assets/common/settings.png", "alt", "", "srcset", "", 2, "margin-left", "19px", "margin-right", "28px", "height", "1.5rem", 3, "click"], [1, "d-flex", "flex-column"], ["mat-menu-item", "", 1, "w-100", 2, "width", "8rem"], ["src", "./assets/common/document.png", "srcset", "", 2, "padding-right", "10px", "width", "2rem"], ["mat-menu-item", "", 1, "w-100", 2, "width", "8rem", 3, "click"], ["src", "./assets/common2x/document.png", "srcset", "", 2, "padding-right", "10px", "width", "2rem"], ["type", "button", 1, "btn", "ml-2", "addNewbuttom", "bgBlack", "text-white", 3, "click"], [1, "mx-auto", "mt-4"], [3, "formGroup"], [1, "d-flex-row"], [1, "row", "scrollNew"], [1, "col-3", "marginFieldNew", "borderRadius12"], [1, "formControlLabel", "f600", "textBlack", "mb-0"], ["formControlName", "languageId", "appendTo", "body", 3, "options", "disabled", "panelStyle"], ["class", "text-danger", 4, "ngIf"], ["formControlName", "companyId", "appendTo", "body", 3, "options", "disabled", "panelStyle"], ["maxlength", "50", "pInputText", "", "formControlName", "partnerMasterAirwayBill", "pInputText", "", "placeholder", "Enter", 1, "w-100"], [1, "tableProperties"], ["selectionMode", "multiple", "sortField", "createdOn", "scrollHeight", "calc(100vh - 23rem)", "sortField", "createdOn", "styleClass", "p-datatable-sm", 1, "custom-table", 3, "selectionChange", "columns", "value", "scrollable", "sortOrder", "selection", "tableStyle"], ["pTemplate", "header"], ["pTemplate", "body"], ["pTemplate", "emptymessage"], [1, "d-flex", "mt-1", "justify-content-end", 2, "position", "absolute", "right", "3.5%", "bottom", "7%"], ["routerLink", "/main/airport/console", 1, "buttom1", "textBlack", "mx-1"], [1, "text-danger"], ["pFrozenColumn", "", 2, "width", "5rem"], [1, "pl-3"], [3, "pSortableColumn", 4, "ngFor", "ngForOf"], ["pFrozenColumn", "", "alignFrozen", "right", 2, "width", "5rem"], [3, "pSortableColumn"], [3, "field"], ["pFrozenColumn", "", 2, "width", "5rem", "justify-content", "center"], [1, "pl-3", 3, "value"], [4, "ngFor", "ngForOf"], ["pFrozenColumn", "", "alignFrozen", "right", 2, "padding-left", "1.5rem !important"], ["type", "button", "src", "./assets/common/actions.png", "alt", "", "srcset", "", 2, "height", "1.4rem", 3, "click"], ["src", "./assets/common/edit.png", "srcset", "", 2, "padding-right", "10px", "width", "2rem"], ["src", "./assets/common/deletetool.png", "srcset", "", 2, "padding-right", "10px", "width", "2rem"], [4, "ngIf", "ngIfElse"], [1, "my-2", "w-100", "pl-3"]], template: function ConsoleEditComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ConsoleEditComponent_Template_img_click_5_listener($event) {
      \u0275\u0275restoreView(_r1);
      const op_r2 = \u0275\u0275reference(7);
      return \u0275\u0275resetView(op_r2.toggle($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p-overlayPanel", null, 0)(8, "div", 7)(9, "button", 8);
    \u0275\u0275element(10, "img", 9);
    \u0275\u0275text(11, "Customs Cleared");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "div", 7)(13, "button", 8);
    \u0275\u0275element(14, "img", 9);
    \u0275\u0275text(15, "Self Clearance ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "div", 7)(17, "button", 10);
    \u0275\u0275listener("click", function ConsoleEditComponent_Template_button_click_17_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.callHubCode());
    });
    \u0275\u0275element(18, "img", 11);
    \u0275\u0275text(19, "Outscan ");
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275text(21, "CCR");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(22, "div", 13)(23, "form", 14)(24, "div", 15)(25, "div", 16)(26, "div", 17)(27, "p", 18);
    \u0275\u0275text(28, "Language");
    \u0275\u0275elementEnd();
    \u0275\u0275element(29, "p-dropdown", 19);
    \u0275\u0275template(30, ConsoleEditComponent_mat_error_30_Template, 3, 1, "mat-error", 20);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "div", 17)(32, "p", 18);
    \u0275\u0275text(33, "Company");
    \u0275\u0275elementEnd();
    \u0275\u0275element(34, "p-dropdown", 21);
    \u0275\u0275template(35, ConsoleEditComponent_mat_error_35_Template, 3, 1, "mat-error", 20);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(40, "div", 23)(41, "p-table", 24, 1);
    \u0275\u0275twoWayListener("selectionChange", function ConsoleEditComponent_Template_p_table_selectionChange_41_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.selectedConsole, $event) || (ctx.selectedConsole = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275template(43, ConsoleEditComponent_ng_template_43_Template, 6, 1, "ng-template", 25)(44, ConsoleEditComponent_ng_template_44_Template, 15, 7, "ng-template", 26)(45, ConsoleEditComponent_ng_template_45_Template, 4, 1, "ng-template", 27);
    \u0275\u0275elementEnd()()();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConsoleEditComponent, { className: "ConsoleEditComponent", filePath: "src\\app\\main\\airport\\console\\console-edit\\console-edit.component.ts", lineNumber: 26 });
})();
...
//# sourceMappingURL=chunk-NHP57ANB.js.map
